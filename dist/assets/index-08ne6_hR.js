...
`)}const Hg={[lh]:"Linear",[ch]:"Reinhard",[hh]:"Cineon",[uh]:"ACESFilmic",[fh]:"AgX",[ph]:"Neutral",[dh]:"Custom"};function Gg(i,t){const e=Hg[t];return e===void 0?(Ft("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Or=new D;function Vg(){ee.getLuminanceCoefficients(Or);const i=Or.x.toFixed(4),t=Or.y.toFixed(4),e=Or.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const b=w+m+a,M=w+p+o,y=Vc(s,s.VERTEX_SHADER,b),T=Vc(s,s.FRAGMENT_SHADER,M);s.attachShader(x,y),s.attachShader(x,T),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(P){if(i.debug.checkShaderErrors){const I=s.getProgramInfoLog(x)||"",F=s.getShaderInfoLog(y)||"",B=s.getShaderInfoLog(T)||"",N=I.trim(),H=F.trim(),z=B.trim();let q=!0,ot=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,y,T);else{const et=Xc(s,y,"vertex"),it=Xc(s,T,"fragment");Qt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,wx=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],bx=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],Qc=new jt,ks=new D,to=new D;function Ex(i,t,e){let n=new Al;const s=new ut,r=new ut,a=new Ee,o=new Pf,l=new If,c={},h=e.maxTextureSize,u={[wi]:rn,[rn]:wi,[ke]:ke},d=new En({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ut},radius:{value:4}},vertexShader:yx,fragmentShader:Sx}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new an;g.setAttribute("position",new wn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new nt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Hr;let p=this.type;this.render=function(T,C,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;T.type===wu&&(Ft("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),T.type=Hr);const v=i.getRenderTarget(),S=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),I=i.state;I.setBlending(si),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const F=p!==this.type;F&&C.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(N=>N.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,N=T.length;B<N;B++){const H=T[B],z=H.shadow;if(z===void 0){Ft("WebGLShadowMap:",H,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const q=z.getFrameExtents();if(s.multiply(q),r.copy(z.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/q.x),s.x=r.x*q.x,z.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/q.y),s.y=r.y*q.y,z.mapSize.y=r.y)),z.map===null||F===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Vs){if(H.isPointLight){Ft("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Xn(s.x,s.y,{format:Ms,type:oi,minFilter:He,magFilter:He,generateMipmaps:!1}),z.map.texture.name=H.name+".shadowMap",z.map.depthTexture=new er(s.x,s.y,Fn),z.map.depthTexture.name=H.name+".shadowMapDepth",z.map.depthTexture.format=li,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ve,z.map.depthTexture.magFilter=Ve}else{H.isPointLight?(z.map=new Ih(s.x),z.map.depthTexture=new qd(s.x,Yn)):(z.map=new Xn(s.x,s.y),z.map.depthTexture=new er(s.x,s.y,Yn)),z.map.depthTexture.name=H.name+".shadowMap",z.map.depthTexture.format=li;const et=i.state.buffers.depth.getReversed();this.type===Hr?(z.map.depthTexture.compareFunction=et?El:bl,z.map.depthTexture.minFilter=He,z.map.depthTexture.magFilter=He):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ve,z.map.depthTexture.magFilter=Ve)}z.camera.updateProjectionMatrix()}const ot=z.map.isWebGLCubeRenderTarget?6:1;for(let et=0;et<ot;et++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,et),i.clear();else{et===0&&(i.setRenderTarget(z.map),i.clear());const it=z.getViewport(et);a.set(r.x*it.x,r.y*it.y,r.x*it.z,r.y*it.w),I.viewport(a)}if(H.isPointLight){const it=z.camera,Ot=z.matrix,zt=H.distance||it.far;zt!==it.far&&(it.far=zt,it.updateProjectionMatrix()),ks.setFromMatrixPosition(H.matrixWorld),it.position.copy(ks),to.copy(it.position),to.add(wx[et]),it.up.copy(bx[et]),it.lookAt(to),it.updateMatrixWorld(),Ot.makeTranslation(-ks.x,-ks.y,-ks.z),Qc.multiplyMatrices(it.projectionMatrix,it.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Qc,it.coordinateSystem,it.reversedDepth)}else z.updateMatrices(H);n=z.getFrustum(),M(C,L,z.camera,H,this.type)}z.isPointLightShadow!==!0&&this.type===Vs&&w(z,L),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(v,S,P)};function w(T,C){const L=t.update(x);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Xn(s.x,s.y,{format:Ms,type:oi})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(C,null,L,d,x,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(C,null,L,f,x,null)}function b(T,C,L,v){let S=null;const P=L.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)S=P;else if(S=L.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const I=S.uuid,F=C.uuid;let B=c[I];B===void 0&&(B={},c[I]=B);let N=B[F];N===void 0&&(N=S.clone(),B[F]=N,C.addEventListener("dispose",y)),S=N}if(S.visible=C.visible,S.wireframe=C.wireframe,v===Vs?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:u[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const I=i.properties.get(S);I.light=L}return S}function M(T,C,L,v,S){if(T.visible===!1)return;if(T.layers.test(C.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&S===Vs)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,T.matrixWorld);const F=t.update(T),B=T.material;if(Array.isArray(B)){const N=F.groups;for(let H=0,z=N.length;H<z;H++){const q=N[H],ot=B[q.materialIndex];if(ot&&ot.visible){const et=b(T,ot,v,S);T.onBeforeShadow(i,T,C,L,F,et,q),i.renderBufferDirect(L,null,F,et,T,q),T.onAfterShadow(i,T,C,L,F,et,q)}}}else if(B.visible){const N=b(T,B,v,S);T.onBeforeShadow(i,T,C,L,F,N,null),i.renderBufferDirect(L,null,F,N,T,null),T.onAfterShadow(i,T,C,L,F,N,null)}}const I=T.children;for(let F=0,B=I.length;F<B;F++)M(I[F],C,L,v,S)}function y(T){T.target.removeEventListener("dispose",y);for(const L in c){const v=c[L],S=T.target.uuid;S in v&&(v[S].dispose(),delete v[S])}}}const Tx={[co]:ho,[uo]:mo,[fo]:go,[_s]:po,[ho]:co,[mo]:uo,[go]:fo,[po]:_s};function Cx(i,t){function e(){let U=!1;const Mt=new Ee;let ct=null;const wt=new Ee(0,0,0,0);return{setMask:function(lt){ct!==lt&&!U&&(i.colorMask(lt,lt,lt,lt),ct=lt)},setLocked:function(lt){U=lt},setClear:function(lt,Q,ft,Xt,ge){ge===!0&&(lt*=Xt,Q*=Xt,ft*=Xt),Mt.set(lt,Q,ft,Xt),wt.equals(Mt)===!1&&(i.clearColor(lt,Q,ft,Xt),wt.copy(Mt))},reset:function(){U=!1,ct=null,wt.set(-1,0,0,0)}}}function n(){let U=!1,Mt=!1,ct=null,wt=null,lt=null;return{setReversed:function(Q){if(Mt!==Q){const ft=t.get("EXT_clip_control");Q?ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.ZERO_TO_ONE_EXT):ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.NEGATIVE_ONE_TO_ONE_EXT),Mt=Q;const Xt=lt;lt=null,this.setClear(Xt)}},getReversed:function(){return Mt},setTest:function(Q){Q?tt(i.DEPTH_TEST):yt(i.DEPTH_TEST)},setMask:function(Q){ct!==Q&&!U&&(i.depthMask(Q),ct=Q)},setFunc:function(Q){if(Mt&&(Q=Tx[Q]),wt!==Q){switch(Q){case co:i.depthFunc(i.NEVER);break;case ho:i.depthFunc(i.ALWAYS);break;case uo:i.depthFunc(i.LESS);break;case _s:i.depthFunc(i.LEQUAL);break;case fo:i.depthFunc(i.EQUAL);break;case po:i.depthFunc(i.GEQUAL);break;case mo:i.depthFunc(i.GREATER);break;case go:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}wt=Q}},setLocked:function(Q){U=Q},setClear:function(Q){lt!==Q&&(Mt&&(Q=1-Q),i.clearDepth(Q),lt=Q)},reset:function(){U=!1,ct=null,wt=null,lt=null,Mt=!1}}}function s(){let U=!1,Mt=null,ct=null,wt=null,lt=null,Q=null,ft=null,Xt=null,ge=null;return{setTest:function(ce){U||(ce?tt(i.STENCIL_TEST):yt(i.STENCIL_TEST))},setMask:function(ce){Mt!==ce&&!U&&(i.stencilMask(ce),Mt=ce)},setFunc:function(ce,Un,Zn){(ct!==ce||wt!==Un||lt!==Zn)&&(i.stencilFunc(ce,Un,Zn),ct=ce,wt=Un,lt=Zn)},setOp:function(ce,Un,Zn){(Q!==ce||ft!==Un||Xt!==Zn)&&(i.stencilOp(ce,Un,Zn),Q=ce,ft=Un,Xt=Zn)},setLocked:function(ce){U=ce},setClear:function(ce){ge!==ce&&(i.clearStencil(ce),ge=ce)},reset:function(){U=!1,Mt=null,ct=null,wt=null,lt=null,Q=null,ft=null,Xt=null,ge=null}}}const r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,b=null,M=null,y=null,T=null,C=new Ut(0,0,0),L=0,v=!1,S=null,P=null,I=null,F=null,B=null;const N=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,z=0;const q=i.getParameter(i.VERSION);q.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(q)[1]),H=z>=1):q.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),H=z>=2);let ot=null,et={};const it=i.getParameter(i.SCISSOR_BOX),Ot=i.getParameter(i.VIEWPORT),zt=new Ee().fromArray(it),re=new Ee().fromArray(Ot);function ne(U,Mt,ct,wt){const lt=new Uint8Array(4),Q=i.createTexture();i.bindTexture(U,Q),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ft=0;ft<ct;ft++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(Mt,0,i.RGBA,1,1,wt,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(Mt+ft,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return Q}const Z={};Z[i.TEXTURE_2D]=ne(i.TEXTURE_2D,i.TEXTURE_2D,1),Z[i.TEXTURE_CUBE_MAP]=ne(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[i.TEXTURE_2D_ARRAY]=ne(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Z[i.TEXTURE_3D]=ne(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),tt(i.DEPTH_TEST),a.setFunc(_s),J(!1),rt(ql),tt(i.CULL_FACE),$(si);function tt(U){h[U]!==!0&&(i.enable(U),h[U]=!0)}function yt(U){h[U]!==!1&&(i.disable(U),h[U]=!1)}function Nt(U,Mt){return u[U]!==Mt?(i.bindFramebuffer(U,Mt),u[U]=Mt,U===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=Mt),U===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=Mt),!0):!1}function St(U,Mt){let ct=f,wt=!1;if(U){ct=d.get(Mt),ct===void 0&&(ct=[],d.set(Mt,ct));const lt=U.textures;if(ct.length!==lt.length||ct[0]!==i.COLOR_ATTACHMENT0){for(let Q=0,ft=lt.length;Q<ft;Q++)ct[Q]=i.COLOR_ATTACHMENT0+Q;ct.length=lt.length,wt=!0}}else ct[0]!==i.BACK&&(ct[0]=i.BACK,wt=!0);wt&&i.drawBuffers(ct)}function Jt(U){return g!==U?(i.useProgram(U),g=U,!0):!1}const ae={[Oi]:i.FUNC_ADD,[Eu]:i.FUNC_SUBTRACT,[Tu]:i.FUNC_REVERSE_SUBTRACT};ae[Cu]=i.MIN,ae[Au]=i.MAX;const Wt={[Ru]:i.ZERO,[Pu]:i.ONE,[Iu]:i.SRC_COLOR,[oo]:i.SRC_ALPHA,[Ou]:i.SRC_ALPHA_SATURATE,[Nu]:i.DST_COLOR,[Du]:i.DST_ALPHA,[Lu]:i.ONE_MINUS_SRC_COLOR,[lo]:i.ONE_MINUS_SRC_ALPHA,[Uu]:i.ONE_MINUS_DST_COLOR,[Fu]:i.ONE_MINUS_DST_ALPHA,[Bu]:i.CONSTANT_COLOR,[ku]:i.ONE_MINUS_CONSTANT_COLOR,[zu]:i.CONSTANT_ALPHA,[Hu]:i.ONE_MINUS_CONSTANT_ALPHA};function $(U,Mt,ct,wt,lt,Q,ft,Xt,ge,ce){if(U===si){x===!0&&(yt(i.BLEND),x=!1);return}if(x===!1&&(tt(i.BLEND),x=!0),U!==bu){if(U!==m||ce!==v){if((p!==Oi||M!==Oi)&&(i.blendEquation(i.FUNC_ADD),p=Oi,M=Oi),ce)switch(U){case gs:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Sn:i.blendFunc(i.ONE,i.ONE);break;case Zl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case $l:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Qt("WebGLState: Invalid blending: ",U);break}else switch(U){case gs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Sn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Zl:Qt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case $l:Qt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qt("WebGLState: Invalid blending: ",U);break}w=null,b=null,y=null,T=null,C.set(0,0,0),L=0,m=U,v=ce}return}lt=lt||Mt,Q=Q||ct,ft=ft||wt,(Mt!==p||lt!==M)&&(i.blendEquationSeparate(ae[Mt],ae[lt]),p=Mt,M=lt),(ct!==w||wt!==b||Q!==y||ft!==T)&&(i.blendFuncSeparate(Wt[ct],Wt[wt],Wt[Q],Wt[ft]),w=ct,b=wt,y=Q,T=ft),(Xt.equals(C)===!1||ge!==L)&&(i.blendColor(Xt.r,Xt.g,Xt.b,ge),C.copy(Xt),L=ge),m=U,v=!1}function st(U,Mt){U.side===ke?yt(i.CULL_FACE):tt(i.CULL_FACE);let ct=U.side===rn;Mt&&(ct=!ct),J(ct),U.blending===gs&&U.transparent===!1?$(si):$(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);const wt=U.stencilWrite;o.setTest(wt),wt&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),bt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?tt(i.SAMPLE_ALPHA_TO_COVERAGE):yt(i.SAMPLE_ALPHA_TO_COVERAGE)}function J(U){S!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),S=U)}function rt(U){U!==yu?(tt(i.CULL_FACE),U!==P&&(U===ql?i.cullFace(i.BACK):U===Su?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):yt(i.CULL_FACE),P=U}function R(U){U!==I&&(H&&i.lineWidth(U),I=U)}function bt(U,Mt,ct){U?(tt(i.POLYGON_OFFSET_FILL),(F!==Mt||B!==ct)&&(i.polygonOffset(Mt,ct),F=Mt,B=ct)):yt(i.POLYGON_OFFSET_FILL)}function xt(U){U?tt(i.SCISSOR_TEST):yt(i.SCISSOR_TEST)}function Dt(U){U===void 0&&(U=i.TEXTURE0+N-1),ot!==U&&(i.activeTexture(U),ot=U)}function ht(U,Mt,ct){ct===void 0&&(ot===null?ct=i.TEXTURE0+N-1:ct=ot);let wt=et[ct];wt===void 0&&(wt={type:void 0,texture:void 0},et[ct]=wt),(wt.type!==U||wt.texture!==Mt)&&(ot!==ct&&(i.activeTexture(ct),ot=ct),i.bindTexture(U,Mt||Z[U]),wt.type=U,wt.texture=Mt)}function A(){const U=et[ot];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(U){Qt("WebGLState:",U)}}function O(){try{i.compressedTexImage3D(...arguments)}catch(U){Qt("WebGLState:",U)}}function X(){try{i.texSubImage2D(...arguments)}catch(U){Qt("WebGLState:",U)}}function j(){try{i.texSubImage3D(...arguments)}catch(U){Qt("WebGLState:",U)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(U){Qt("WebGLState:",U)}}function Pt(){try{i.compressedTexSubImage3D(...arguments)}catch(U){Qt("WebGLState:",U)}}function dt(){try{i.texStorage2D(...arguments)}catch(U){Qt("WebGLState:",U)}}function At(){try{i.texStorage3D(...arguments)}catch(U){Qt("WebGLState:",U)}}function Ht(){try{i.texImage2D(...arguments)}catch(U){Qt("WebGLState:",U)}}function at(){try{i.texImage3D(...arguments)}catch(U){Qt("WebGLState:",U)}}function mt(U){zt.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),zt.copy(U))}function Rt(U){re.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),re.copy(U))}function It(U,Mt){let ct=c.get(Mt);ct===void 0&&(ct=new WeakMap,c.set(Mt,ct));let wt=ct.get(U);wt===void 0&&(wt=i.getUniformBlockIndex(Mt,U.name),ct.set(U,wt))}function pt(U,Mt){const wt=c.get(Mt).get(U);l.get(Mt)!==wt&&(i.uniformBlockBinding(Mt,wt,U.__bindingPointIndex),l.set(Mt,wt))}function Zt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},ot=null,et={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,b=null,M=null,y=null,T=null,C=new Ut(0,0,0),L=0,v=!1,S=null,P=null,I=null,F=null,B=null,zt.set(0,0,i.canvas.width,i.canvas.height),re.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:tt,disable:yt,bindFramebuffer:Nt,drawBuffers:St,useProgram:Jt,setBlending:$,setMaterial:st,setFlipSided:J,setCullFace:rt,setLineWidth:R,setPolygonOffset:bt,setScissorTest:xt,activeTexture:Dt,bindTexture:ht,unbindTexture:A,compressedTexImage2D:_,compressedTexImage3D:O,texImage2D:Ht,texImage3D:at,updateUBOMapping:It,uniformBlockBinding:pt,texStorage2D:dt,texStorage3D:At,texSubImage2D:X,texSubImage3D:j,compressedTexSubImage2D:Y,compressedTexSubImage3D:Pt,scissor:mt,viewport:Rt,reset:Zt}}function Ax(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ut,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,_){return f?new OffscreenCanvas(A,_):Jr("canvas")}function x(A,_,O){let X=1;const j=ht(A);if((j.width>O||j.height>O)&&(X=O/Math.max(j.width,j.height)),X<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const Y=Math.floor(X*j.width),Pt=Math.floor(X*j.height);u===void 0&&(u=g(Y,Pt));const dt=_?g(Y,Pt):u;return dt.width=Y,dt.height=Pt,dt.getContext("2d").drawImage(A,0,0,Y,Pt),Ft("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+Y+"x"+Pt+")."),dt}else return"data"in A&&Ft("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),A;return A}function m(A){return A.generateMipmaps}function p(A){i.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(A,_,O,X,j=!1){if(A!==null){if(i[A]!==void 0)return i[A];Ft("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let Y=_;if(_===i.RED&&(O===i.FLOAT&&(Y=i.R32F),O===i.HALF_FLOAT&&(Y=i.R16F),O===i.UNSIGNED_BYTE&&(Y=i.R8)),_===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.R8UI),O===i.UNSIGNED_SHORT&&(Y=i.R16UI),O===i.UNSIGNED_INT&&(Y=i.R32UI),O===i.BYTE&&(Y=i.R8I),O===i.SHORT&&(Y=i.R16I),O===i.INT&&(Y=i.R32I)),_===i.RG&&(O===i.FLOAT&&(Y=i.RG32F),O===i.HALF_FLOAT&&(Y=i.RG16F),O===i.UNSIGNED_BYTE&&(Y=i.RG8)),_===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RG8UI),O===i.UNSIGNED_SHORT&&(Y=i.RG16UI),O===i.UNSIGNED_INT&&(Y=i.RG32UI),O===i.BYTE&&(Y=i.RG8I),O===i.SHORT&&(Y=i.RG16I),O===i.INT&&(Y=i.RG32I)),_===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),O===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),O===i.UNSIGNED_INT&&(Y=i.RGB32UI),O===i.BYTE&&(Y=i.RGB8I),O===i.SHORT&&(Y=i.RGB16I),O===i.INT&&(Y=i.RGB32I)),_===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),O===i.UNSIGNED_INT&&(Y=i.RGBA32UI),O===i.BYTE&&(Y=i.RGBA8I),O===i.SHORT&&(Y=i.RGBA16I),O===i.INT&&(Y=i.RGBA32I)),_===i.RGB&&(O===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),_===i.RGBA){const Pt=j?$r:ee.getTransfer(X);O===i.FLOAT&&(Y=i.RGBA32F),O===i.HALF_FLOAT&&(Y=i.RGBA16F),O===i.UNSIGNED_BYTE&&(Y=Pt===ue?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function M(A,_){let O;return A?_===null||_===Yn||_===js?O=i.DEPTH24_STENCIL8:_===Fn?O=i.DEPTH32F_STENCIL8:_===Js&&(O=i.DEPTH24_STENCIL8,Ft("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Yn||_===js?O=i.DEPTH_COMPONENT24:_===Fn?O=i.DEPTH_COMPONENT32F:_===Js&&(O=i.DEPTH_COMPONENT16),O}function y(A,_){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ve&&A.minFilter!==He?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function T(A){const _=A.target;_.removeEventListener("dispose",T),L(_),_.isVideoTexture&&h.delete(_)}function C(A){const _=A.target;_.removeEventListener("dispose",C),S(_)}function L(A){const _=n.get(A);if(_.__webglInit===void 0)return;const O=A.source,X=d.get(O);if(X){const j=X[_.__cacheKey];j.usedTimes--,j.usedTimes===0&&v(A),Object.keys(X).length===0&&d.delete(O)}n.remove(A)}function v(A){const _=n.get(A);i.deleteTexture(_.__webglTexture);const O=A.source,X=d.get(O);delete X[_.__cacheKey],a.memory.textures--}function S(A){const _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(_.__webglFramebuffer[X]))for(let j=0;j<_.__webglFramebuffer[X].length;j++)i.deleteFramebuffer(_.__webglFramebuffer[X][j]);else i.deleteFramebuffer(_.__webglFramebuffer[X]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[X])}else{if(Array.isArray(_.__webglFramebuffer))for(let X=0;X<_.__webglFramebuffer.length;X++)i.deleteFramebuffer(_.__webglFramebuffer[X]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let X=0;X<_.__webglColorRenderbuffer.length;X++)_.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[X]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const O=A.textures;for(let X=0,j=O.length;X<j;X++){const Y=n.get(O[X]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(O[X])}n.remove(A)}let P=0;function I(){P=0}function F(){const A=P;return A>=s.maxTextures&&Ft("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),P+=1,A}function B(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function N(A,_){const O=n.get(A);if(A.isVideoTexture&&xt(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const X=A.image;if(X===null)Ft("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ft("WebGLRenderer: Texture marked for update but image is incomplete");else{Z(O,A,_);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+_)}function H(A,_){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Z(O,A,_);return}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+_)}function z(A,_){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Z(O,A,_);return}e.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+_)}function q(A,_){const O=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&O.__version!==A.version){tt(O,A,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+_)}const ot={[vo]:i.REPEAT,[ei]:i.CLAMP_TO_EDGE,[Mo]:i.MIRRORED_REPEAT},et={[Ve]:i.NEAREST,[Wu]:i.NEAREST_MIPMAP_NEAREST,[hr]:i.NEAREST_MIPMAP_LINEAR,[He]:i.LINEAR,[va]:i.LINEAR_MIPMAP_NEAREST,[ki]:i.LINEAR_MIPMAP_LINEAR},it={[qu]:i.NEVER,[ju]:i.ALWAYS,[Zu]:i.LESS,[bl]:i.LEQUAL,[$u]:i.EQUAL,[El]:i.GEQUAL,[Ku]:i.GREATER,[Ju]:i.NOTEQUAL};function Ot(A,_){if(_.type===Fn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===He||_.magFilter===va||_.magFilter===hr||_.magFilter===ki||_.minFilter===He||_.minFilter===va||_.minFilter===hr||_.minFilter===ki)&&Ft("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,ot[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,ot[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,ot[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,et[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,et[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,it[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ve||_.minFilter!==hr&&_.minFilter!==ki||_.type===Fn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const O=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function zt(A,_){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",T));const X=_.source;let j=d.get(X);j===void 0&&(j={},d.set(X,j));const Y=B(_);if(Y!==A.__cacheKey){j[Y]===void 0&&(j[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),j[Y].usedTimes++;const Pt=j[A.__cacheKey];Pt!==void 0&&(j[A.__cacheKey].usedTimes--,Pt.usedTimes===0&&v(_)),A.__cacheKey=Y,A.__webglTexture=j[Y].texture}return O}function re(A,_,O){return Math.floor(Math.floor(A/O)/_)}function ne(A,_,O,X){const Y=A.updateRanges;if(Y.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,O,X,_.data);else{Y.sort((at,mt)=>at.start-mt.start);let Pt=0;for(let at=1;at<Y.length;at++){const mt=Y[Pt],Rt=Y[at],It=mt.start+mt.count,pt=re(Rt.start,_.width,4),Zt=re(mt.start,_.width,4);Rt.start<=It+1&&pt===Zt&&re(Rt.start+Rt.count-1,_.width,4)===pt?mt.count=Math.max(mt.count,Rt.start+Rt.count-mt.start):(++Pt,Y[Pt]=Rt)}Y.length=Pt+1;const dt=i.getParameter(i.UNPACK_ROW_LENGTH),At=i.getParameter(i.UNPACK_SKIP_PIXELS),Ht=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let at=0,mt=Y.length;at<mt;at++){const Rt=Y[at],It=Math.floor(Rt.start/4),pt=Math.ceil(Rt.count/4),Zt=It%_.width,U=Math.floor(It/_.width),Mt=pt,ct=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Zt),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),e.texSubImage2D(i.TEXTURE_2D,0,Zt,U,Mt,ct,O,X,_.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,dt),i.pixelStorei(i.UNPACK_SKIP_PIXELS,At),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ht)}}function Z(A,_,O){let X=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(X=i.TEXTURE_3D);const j=zt(A,_),Y=_.source;e.bindTexture(X,A.__webglTexture,i.TEXTURE0+O);const Pt=n.get(Y);if(Y.version!==Pt.__version||j===!0){e.activeTexture(i.TEXTURE0+O);const dt=ee.getPrimaries(ee.workingColorSpace),At=_.colorSpace===_i?null:ee.getPrimaries(_.colorSpace),Ht=_.colorSpace===_i||dt===At?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ht);let at=x(_.image,!1,s.maxTextureSize);at=Dt(_,at);const mt=r.convert(_.format,_.colorSpace),Rt=r.convert(_.type);let It=b(_.internalFormat,mt,Rt,_.colorSpace,_.isVideoTexture);Ot(X,_);let pt;const Zt=_.mipmaps,U=_.isVideoTexture!==!0,Mt=Pt.__version===void 0||j===!0,ct=Y.dataReady,wt=y(_,at);if(_.isDepthTexture)It=M(_.format===zi,_.type),Mt&&(U?e.texStorage2D(i.TEXTURE_2D,1,It,at.width,at.height):e.texImage2D(i.TEXTURE_2D,0,It,at.width,at.height,0,mt,Rt,null));else if(_.isDataTexture)if(Zt.length>0){U&&Mt&&e.texStorage2D(i.TEXTURE_2D,wt,It,Zt[0].width,Zt[0].height);for(let lt=0,Q=Zt.length;lt<Q;lt++)pt=Zt[lt],U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,Rt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,It,pt.width,pt.height,0,mt,Rt,pt.data);_.generateMipmaps=!1}else U?(Mt&&e.texStorage2D(i.TEXTURE_2D,wt,It,at.width,at.height),ct&&ne(_,at,mt,Rt)):e.texImage2D(i.TEXTURE_2D,0,It,at.width,at.height,0,mt,Rt,at.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&Mt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,It,Zt[0].width,Zt[0].height,at.depth);for(let lt=0,Q=Zt.length;lt<Q;lt++)if(pt=Zt[lt],_.format!==Nn)if(mt!==null)if(U){if(ct)if(_.layerUpdates.size>0){const ft=Pc(pt.width,pt.height,_.format,_.type);for(const Xt of _.layerUpdates){const ge=pt.data.subarray(Xt*ft/pt.data.BYTES_PER_ELEMENT,(Xt+1)*ft/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,Xt,pt.width,pt.height,1,mt,ge)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,at.depth,mt,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,lt,It,pt.width,pt.height,at.depth,0,pt.data,0,0);else Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?ct&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,at.depth,mt,Rt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,lt,It,pt.width,pt.height,at.depth,0,mt,Rt,pt.data)}else{U&&Mt&&e.texStorage2D(i.TEXTURE_2D,wt,It,Zt[0].width,Zt[0].height);for(let lt=0,Q=Zt.length;lt<Q;lt++)pt=Zt[lt],_.format!==Nn?mt!==null?U?ct&&e.compressedTexSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,lt,It,pt.width,pt.height,0,pt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,Rt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,It,pt.width,pt.height,0,mt,Rt,pt.data)}else if(_.isDataArrayTexture)if(U){if(Mt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,It,at.width,at.height,at.depth),ct)if(_.layerUpdates.size>0){const lt=Pc(at.width,at.height,_.format,_.type);for(const Q of _.layerUpdates){const ft=at.data.subarray(Q*lt/at.data.BYTES_PER_ELEMENT,(Q+1)*lt/at.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,at.width,at.height,1,mt,Rt,ft)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,at.width,at.height,at.depth,mt,Rt,at.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,It,at.width,at.height,at.depth,0,mt,Rt,at.data);else if(_.isData3DTexture)U?(Mt&&e.texStorage3D(i.TEXTURE_3D,wt,It,at.width,at.height,at.depth),ct&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,at.width,at.height,at.depth,mt,Rt,at.data)):e.texImage3D(i.TEXTURE_3D,0,It,at.width,at.height,at.depth,0,mt,Rt,at.data);else if(_.isFramebufferTexture){if(Mt)if(U)e.texStorage2D(i.TEXTURE_2D,wt,It,at.width,at.height);else{let lt=at.width,Q=at.height;for(let ft=0;ft<wt;ft++)e.texImage2D(i.TEXTURE_2D,ft,It,lt,Q,0,mt,Rt,null),lt>>=1,Q>>=1}}else if(Zt.length>0){if(U&&Mt){const lt=ht(Zt[0]);e.texStorage2D(i.TEXTURE_2D,wt,It,lt.width,lt.height)}for(let lt=0,Q=Zt.length;lt<Q;lt++)pt=Zt[lt],U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,mt,Rt,pt):e.texImage2D(i.TEXTURE_2D,lt,It,mt,Rt,pt);_.generateMipmaps=!1}else if(U){if(Mt){const lt=ht(at);e.texStorage2D(i.TEXTURE_2D,wt,It,lt.width,lt.height)}ct&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,mt,Rt,at)}else e.texImage2D(i.TEXTURE_2D,0,It,mt,Rt,at);m(_)&&p(X),Pt.__version=Y.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function tt(A,_,O){if(_.image.length!==6)return;const X=zt(A,_),j=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+O);const Y=n.get(j);if(j.version!==Y.__version||X===!0){e.activeTexture(i.TEXTURE0+O);const Pt=ee.getPrimaries(ee.workingColorSpace),dt=_.colorSpace===_i?null:ee.getPrimaries(_.colorSpace),At=_.colorSpace===_i||Pt===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,At);const Ht=_.isCompressedTexture||_.image[0].isCompressedTexture,at=_.image[0]&&_.image[0].isDataTexture,mt=[];for(let Q=0;Q<6;Q++)!Ht&&!at?mt[Q]=x(_.image[Q],!0,s.maxCubemapSize):mt[Q]=at?_.image[Q].image:_.image[Q],mt[Q]=Dt(_,mt[Q]);const Rt=mt[0],It=r.convert(_.format,_.colorSpace),pt=r.convert(_.type),Zt=b(_.internalFormat,It,pt,_.colorSpace),U=_.isVideoTexture!==!0,Mt=Y.__version===void 0||X===!0,ct=j.dataReady;let wt=y(_,Rt);Ot(i.TEXTURE_CUBE_MAP,_);let lt;if(Ht){U&&Mt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Zt,Rt.width,Rt.height);for(let Q=0;Q<6;Q++){lt=mt[Q].mipmaps;for(let ft=0;ft<lt.length;ft++){const Xt=lt[ft];_.format!==Nn?It!==null?U?ct&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,0,0,Xt.width,Xt.height,It,Xt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,Zt,Xt.width,Xt.height,0,Xt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,0,0,Xt.width,Xt.height,It,pt,Xt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,Zt,Xt.width,Xt.height,0,It,pt,Xt.data)}}}else{if(lt=_.mipmaps,U&&Mt){lt.length>0&&wt++;const Q=ht(mt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Zt,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(at){U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,mt[Q].width,mt[Q].height,It,pt,mt[Q].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Zt,mt[Q].width,mt[Q].height,0,It,pt,mt[Q].data);for(let ft=0;ft<lt.length;ft++){const ge=lt[ft].image[Q].image;U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,0,0,ge.width,ge.height,It,pt,ge.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,Zt,ge.width,ge.height,0,It,pt,ge.data)}}else{U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,It,pt,mt[Q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Zt,It,pt,mt[Q]);for(let ft=0;ft<lt.length;ft++){const Xt=lt[ft];U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,0,0,It,pt,Xt.image[Q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,Zt,It,pt,Xt.image[Q])}}}m(_)&&p(i.TEXTURE_CUBE_MAP),Y.__version=j.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function yt(A,_,O,X,j,Y){const Pt=r.convert(O.format,O.colorSpace),dt=r.convert(O.type),At=b(O.internalFormat,Pt,dt,O.colorSpace),Ht=n.get(_),at=n.get(O);if(at.__renderTarget=_,!Ht.__hasExternalTextures){const mt=Math.max(1,_.width>>Y),Rt=Math.max(1,_.height>>Y);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?e.texImage3D(j,Y,At,mt,Rt,_.depth,0,Pt,dt,null):e.texImage2D(j,Y,At,mt,Rt,0,Pt,dt,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,j,at.__webglTexture,0,R(_)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,j,at.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Nt(A,_,O){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer){const X=_.depthTexture,j=X&&X.isDepthTexture?X.type:null,Y=M(_.stencilBuffer,j),Pt=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(_),Y,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(_),Y,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Y,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Pt,i.RENDERBUFFER,A)}else{const X=_.textures;for(let j=0;j<X.length;j++){const Y=X[j],Pt=r.convert(Y.format,Y.colorSpace),dt=r.convert(Y.type),At=b(Y.internalFormat,Pt,dt,Y.colorSpace);bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(_),At,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(_),At,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,At,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function St(A,_,O){const X=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(_.depthTexture);if(j.__renderTarget=_,(!j.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),X){if(j.__webglInit===void 0&&(j.__webglInit=!0,_.depthTexture.addEventListener("dispose",T)),j.__webglTexture===void 0){j.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),Ot(i.TEXTURE_CUBE_MAP,_.depthTexture);const Ht=r.convert(_.depthTexture.format),at=r.convert(_.depthTexture.type);let mt;_.depthTexture.format===li?mt=i.DEPTH_COMPONENT24:_.depthTexture.format===zi&&(mt=i.DEPTH24_STENCIL8);for(let Rt=0;Rt<6;Rt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0,mt,_.width,_.height,0,Ht,at,null)}}else N(_.depthTexture,0);const Y=j.__webglTexture,Pt=R(_),dt=X?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,At=_.depthTexture.format===zi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===li)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,At,dt,Y,0,Pt):i.framebufferTexture2D(i.FRAMEBUFFER,At,dt,Y,0);else if(_.depthTexture.format===zi)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,At,dt,Y,0,Pt):i.framebufferTexture2D(i.FRAMEBUFFER,At,dt,Y,0);else throw new Error("Unknown depthTexture format")}function Jt(A){const _=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){const X=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),X){const j=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,X.removeEventListener("dispose",j)};X.addEventListener("dispose",j),_.__depthDisposeCallback=j}_.__boundDepthTexture=X}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(O)for(let X=0;X<6;X++)St(_.__webglFramebuffer[X],A,X);else{const X=A.texture.mipmaps;X&&X.length>0?St(_.__webglFramebuffer[0],A,0):St(_.__webglFramebuffer,A,0)}else if(O){_.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[X]),_.__webglDepthbuffer[X]===void 0)_.__webglDepthbuffer[X]=i.createRenderbuffer(),Nt(_.__webglDepthbuffer[X],A,!1);else{const j=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,Y)}}else{const X=A.texture.mipmaps;if(X&&X.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Nt(_.__webglDepthbuffer,A,!1);else{const j=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,Y)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function ae(A,_,O){const X=n.get(A);_!==void 0&&yt(X.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Jt(A)}function Wt(A){const _=A.texture,O=n.get(A),X=n.get(_);A.addEventListener("dispose",C);const j=A.textures,Y=A.isWebGLCubeRenderTarget===!0,Pt=j.length>1;if(Pt||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=_.version,a.memory.textures++),Y){O.__webglFramebuffer=[];for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer[dt]=[];for(let At=0;At<_.mipmaps.length;At++)O.__webglFramebuffer[dt][At]=i.createFramebuffer()}else O.__webglFramebuffer[dt]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer=[];for(let dt=0;dt<_.mipmaps.length;dt++)O.__webglFramebuffer[dt]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(Pt)for(let dt=0,At=j.length;dt<At;dt++){const Ht=n.get(j[dt]);Ht.__webglTexture===void 0&&(Ht.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&bt(A)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let dt=0;dt<j.length;dt++){const At=j[dt];O.__webglColorRenderbuffer[dt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[dt]);const Ht=r.convert(At.format,At.colorSpace),at=r.convert(At.type),mt=b(At.internalFormat,Ht,at,At.colorSpace,A.isXRRenderTarget===!0),Rt=R(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Rt,mt,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,O.__webglColorRenderbuffer[dt])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Nt(O.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Ot(i.TEXTURE_CUBE_MAP,_);for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0)for(let At=0;At<_.mipmaps.length;At++)yt(O.__webglFramebuffer[dt][At],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,At);else yt(O.__webglFramebuffer[dt],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0);m(_)&&p(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Pt){for(let dt=0,At=j.length;dt<At;dt++){const Ht=j[dt],at=n.get(Ht);let mt=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(mt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(mt,at.__webglTexture),Ot(mt,Ht),yt(O.__webglFramebuffer,A,Ht,i.COLOR_ATTACHMENT0+dt,mt,0),m(Ht)&&p(mt)}e.unbindTexture()}else{let dt=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(dt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(dt,X.__webglTexture),Ot(dt,_),_.mipmaps&&_.mipmaps.length>0)for(let At=0;At<_.mipmaps.length;At++)yt(O.__webglFramebuffer[At],A,_,i.COLOR_ATTACHMENT0,dt,At);else yt(O.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,dt,0);m(_)&&p(dt),e.unbindTexture()}A.depthBuffer&&Jt(A)}function $(A){const _=A.textures;for(let O=0,X=_.length;O<X;O++){const j=_[O];if(m(j)){const Y=w(A),Pt=n.get(j).__webglTexture;e.bindTexture(Y,Pt),p(Y),e.unbindTexture()}}}const st=[],J=[];function rt(A){if(A.samples>0){if(bt(A)===!1){const _=A.textures,O=A.width,X=A.height;let j=i.COLOR_BUFFER_BIT;const Y=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Pt=n.get(A),dt=_.length>1;if(dt)for(let Ht=0;Ht<_.length;Ht++)e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer);const At=A.texture.mipmaps;At&&At.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer);for(let Ht=0;Ht<_.length;Ht++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),dt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Pt.__webglColorRenderbuffer[Ht]);const at=n.get(_[Ht]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,at,0)}i.blitFramebuffer(0,0,O,X,0,0,O,X,j,i.NEAREST),l===!0&&(st.length=0,J.length=0,st.push(i.COLOR_ATTACHMENT0+Ht),A.depthBuffer&&A.resolveDepthBuffer===!1&&(st.push(Y),J.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,J)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,st))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),dt)for(let Ht=0;Ht<_.length;Ht++){e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.RENDERBUFFER,Pt.__webglColorRenderbuffer[Ht]);const at=n.get(_[Ht]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.TEXTURE_2D,at,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const _=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function R(A){return Math.min(s.maxSamples,A.samples)}function bt(A){const _=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function xt(A){const _=a.render.frame;h.get(A)!==_&&(h.set(A,_),A.update())}function Dt(A,_){const O=A.colorSpace,X=A.format,j=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==ys&&O!==_i&&(ee.getTransfer(O)===ue?(X!==Nn||j!==fn)&&Ft("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qt("WebGLTextures: Unsupported texture color space:",O)),_}function ht(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=I,this.setTexture2D=N,this.setTexture2DArray=H,this.setTexture3D=z,this.setTextureCube=q,this.rebindTextures=ae,this.setupRenderTarget=Wt,this.updateRenderTargetMipmap=$,this.updateMultisampleRenderTarget=rt,this.setupDepthRenderbuffer=Jt,this.setupFrameBufferTexture=yt,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Rx(i,t){function e(n,s=_i){let r;const a=ee.getTransfer(s);if(n===fn)return i.UNSIGNED_BYTE;if(n===_l)return i.UNSIGNED_SHORT_4_4_4_4;if(n===vl)return i.UNSIGNED_SHORT_5_5_5_1;if(n===_h)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===vh)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===gh)return i.BYTE;if(n===xh)return i.SHORT;if(n===Js)return i.UNSIGNED_SHORT;if(n===xl)return i.INT;if(n===Yn)return i.UNSIGNED_INT;if(n===Fn)return i.FLOAT;if(n===oi)return i.HALF_FLOAT;if(n===Mh)return i.ALPHA;if(n===yh)return i.RGB;if(n===Nn)return i.RGBA;if(n===li)return i.DEPTH_COMPONENT;if(n===zi)return i.DEPTH_STENCIL;if(n===Ml)return i.RED;if(n===yl)return i.RED_INTEGER;if(n===Ms)return i.RG;if(n===Sl)return i.RG_INTEGER;if(n===wl)return i.RGBA_INTEGER;if(n===Gr||n===Vr||n===Wr||n===Xr)if(a===ue)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Gr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Vr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Xr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Gr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Vr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Xr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===yo||n===So||n===wo||n===bo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===yo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===So)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===wo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===bo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Eo||n===To||n===Co||n===Ao||n===Ro||n===Po||n===Io)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Eo||n===To)return a===ue?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Co)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ao)return r.COMPRESSED_R11_EAC;if(n===Ro)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Po)return r.COMPRESSED_RG11_EAC;if(n===Io)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Lo||n===Do||n===Fo||n===No||n===Uo||n===Oo||n===Bo||n===ko||n===zo||n===Ho||n===Go||n===Vo||n===Wo||n===Xo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Lo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Do)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Fo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===No)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Uo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Oo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Bo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ko)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===zo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ho)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Go)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Vo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Wo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Xo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Yo||n===qo||n===Zo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Yo)return a===ue?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===qo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Zo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===$o||n===Ko||n===Jo||n===jo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===$o)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ko)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Jo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===jo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===js?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const Px=`
void main() {
