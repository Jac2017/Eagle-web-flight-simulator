...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function Yh(){return new Dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qa(),fragmentShader:`
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function qh(){return new Dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qa(),fragmentShader:`
...
`)}const tu=new qe;function W_(s){nt._getMatrix(tu,nt.workingColorSpace,s);const e=`mat3( ${tu.elements.map(t=>t.toFixed(4))} )`;switch(nt.getTransfer(s)){case La:return[e,"LinearTransferOETF"];case dt:return[e,"sRGBTransferOETF"];default:return Ee("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function nu(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)+`
`+p);const w=M+m+a,S=M+p+o,v=eu(i,i.VERTEX_SHADER,w),A=eu(i,i.FRAGMENT_SHADER,S);i.attachShader(x,v),i.attachShader(x,A),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function E(I){if(s.debug.checkShaderErrors){const P=i.getProgramInfoLog(x)||"",N=i.getShaderInfoLog(v)||"",B=i.getShaderInfoLog(A)||"",k=P.trim(),V=N.trim(),z=B.trim();let K=!0,ie=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,v,A);else{const Z=nu(i,v,"vertex"),ne=nu(i,A,"fragment");He("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
