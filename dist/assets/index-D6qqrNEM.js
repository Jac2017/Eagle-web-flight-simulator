...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function Qx(r,t,e){const n=new Float32Array(Ji),i=new N(0,1,0);return new Nn({name:"SphericalGaussianBlur",defines:{n:Ji,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:no(),fragmentShader:`
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function tu(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:no(),fragmentShader:`
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function eu(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:no(),fragmentShader:`
