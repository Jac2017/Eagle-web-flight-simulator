...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function U0(i,t,e){const n=new Float32Array(Bi),s=new D(0,1,0);return new En({name:"SphericalGaussianBlur",defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:fa(),fragmentShader:`
...
`)}const Hg={[lh]:"Linear",[ch]:"Reinhard",[hh]:"Cineon",[uh]:"ACESFilmic",[fh]:"AgX",[ph]:"Neutral",[dh]:"Custom"};function Gg(i,t){const e=Hg[t];return e===void 0?(Ot("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Or=new D;function Vg(){se.getLuminanceCoefficients(Or);const i=Or.x.toFixed(4),t=Or.y.toFixed(4),e=Or.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,wx=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],bx=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],Qc=new te,ks=new D,to=new D;function Ex(i,t,e){let n=new Al;const s=new ut,r=new ut,a=new Ee,o=new Pf,l=new If,c={},h=e.maxTextureSize,u={[wi]:rn,[rn]:wi,[ke]:ke},d=new En({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ut},radius:{value:4}},vertexShader:yx,fragmentShader:Sx}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new an;g.setAttribute("position",new wn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new it(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Hr;let p=this.type;this.render=function(T,C,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;T.type===wu&&(Ot("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),T.type=Hr);const v=i.getRenderTarget(),S=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),I=i.state;I.setBlending(si),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const F=p!==this.type;F&&C.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(N=>N.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,N=T.length;B<N;B++){const H=T[B],z=H.shadow;if(z===void 0){Ot("WebGLShadowMap:",H,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const Z=z.getFrameExtents();if(s.multiply(Z),r.copy(z.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/Z.x),s.x=r.x*Z.x,z.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/Z.y),s.y=r.y*Z.y,z.mapSize.y=r.y)),z.map===null||F===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Vs){if(H.isPointLight){Ot("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Xn(s.x,s.y,{format:ys,type:oi,minFilter:He,magFilter:He,generateMipmaps:!1}),z.map.texture.name=H.name+".shadowMap",z.map.depthTexture=new er(s.x,s.y,Fn),z.map.depthTexture.name=H.name+".shadowMapDepth",z.map.depthTexture.format=li,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ve,z.map.depthTexture.magFilter=Ve}else{H.isPointLight?(z.map=new Ih(s.x),z.map.depthTexture=new qd(s.x,Yn)):(z.map=new Xn(s.x,s.y),z.map.depthTexture=new er(s.x,s.y,Yn)),z.map.depthTexture.name=H.name+".shadowMap",z.map.depthTexture.format=li;const $=i.state.buffers.depth.getReversed();this.type===Hr?(z.map.depthTexture.compareFunction=$?El:bl,z.map.depthTexture.minFilter=He,z.map.depthTexture.magFilter=He):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ve,z.map.depthTexture.magFilter=Ve)}z.camera.updateProjectionMatrix()}const st=z.map.isWebGLCubeRenderTarget?6:1;for(let $=0;$<st;$++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,$),i.clear();else{$===0&&(i.setRenderTarget(z.map),i.clear());const nt=z.getViewport($);a.set(r.x*nt.x,r.y*nt.y,r.x*nt.z,r.y*nt.w),I.viewport(a)}if(H.isPointLight){const nt=z.camera,Lt=z.matrix,It=H.distance||nt.far;It!==nt.far&&(nt.far=It,nt.updateProjectionMatrix()),ks.setFromMatrixPosition(H.matrixWorld),nt.position.copy(ks),to.copy(nt.position),to.add(wx[$]),nt.up.copy(bx[$]),nt.lookAt(to),nt.updateMatrixWorld(),Lt.makeTranslation(-ks.x,-ks.y,-ks.z),Qc.multiplyMatrices(nt.projectionMatrix,nt.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Qc,nt.coordinateSystem,nt.reversedDepth)}else z.updateMatrices(H);n=z.getFrustum(),M(C,L,z.camera,H,this.type)}z.isPointLightShadow!==!0&&this.type===Vs&&w(z,L),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(v,S,P)};function w(T,C){const L=t.update(x);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Xn(s.x,s.y,{format:ys,type:oi})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(C,null,L,d,x,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(C,null,L,f,x,null)}function b(T,C,L,v){let S=null;const P=L.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)S=P;else if(S=L.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const I=S.uuid,F=C.uuid;let B=c[I];B===void 0&&(B={},c[I]=B);let N=B[F];N===void 0&&(N=S.clone(),B[F]=N,C.addEventListener("dispose",y)),S=N}if(S.visible=C.visible,S.wireframe=C.wireframe,v===Vs?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:u[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const I=i.properties.get(S);I.light=L}return S}function M(T,C,L,v,S){if(T.visible===!1)return;if(T.layers.test(C.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&S===Vs)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,T.matrixWorld);const F=t.update(T),B=T.material;if(Array.isArray(B)){const N=F.groups;for(let H=0,z=N.length;H<z;H++){const Z=N[H],st=B[Z.materialIndex];if(st&&st.visible){const $=b(T,st,v,S);T.onBeforeShadow(i,T,C,L,F,$,Z),i.renderBufferDirect(L,null,F,$,T,Z),T.onAfterShadow(i,T,C,L,F,$,Z)}}}else if(B.visible){const N=b(T,B,v,S);T.onBeforeShadow(i,T,C,L,F,N,null),i.renderBufferDirect(L,null,F,N,T,null),T.onAfterShadow(i,T,C,L,F,N,null)}}const I=T.children;for(let F=0,B=I.length;F<B;F++)M(I[F],C,L,v,S)}function y(T){T.target.removeEventListener("dispose",y);for(const L in c){const v=c[L],S=T.target.uuid;S in v&&(v[S].dispose(),delete v[S])}}}const Tx={[co]:ho,[uo]:mo,[fo]:go,[vs]:po,[ho]:co,[mo]:uo,[go]:fo,[po]:vs};function Cx(i,t){function e(){let U=!1;const St=new Ee;let ct=null;const wt=new Ee(0,0,0,0);return{setMask:function(lt){ct!==lt&&!U&&(i.colorMask(lt,lt,lt,lt),ct=lt)},setLocked:function(lt){U=lt},setClear:function(lt,et,ft,Yt,me){me===!0&&(lt*=Yt,et*=Yt,ft*=Yt),St.set(lt,et,ft,Yt),wt.equals(St)===!1&&(i.clearColor(lt,et,ft,Yt),wt.copy(St))},reset:function(){U=!1,ct=null,wt.set(-1,0,0,0)}}}function n(){let U=!1,St=!1,ct=null,wt=null,lt=null;return{setReversed:function(et){if(St!==et){const ft=t.get("EXT_clip_control");et?ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.ZERO_TO_ONE_EXT):ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.NEGATIVE_ONE_TO_ONE_EXT),St=et;const Yt=lt;lt=null,this.setClear(Yt)}},getReversed:function(){return St},setTest:function(et){et?j(i.DEPTH_TEST):mt(i.DEPTH_TEST)},setMask:function(et){ct!==et&&!U&&(i.depthMask(et),ct=et)},setFunc:function(et){if(St&&(et=Tx[et]),wt!==et){switch(et){case co:i.depthFunc(i.NEVER);break;case ho:i.depthFunc(i.ALWAYS);break;case uo:i.depthFunc(i.LESS);break;case vs:i.depthFunc(i.LEQUAL);break;case fo:i.depthFunc(i.EQUAL);break;case po:i.depthFunc(i.GEQUAL);break;case mo:i.depthFunc(i.GREATER);break;case go:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}wt=et}},setLocked:function(et){U=et},setClear:function(et){lt!==et&&(St&&(et=1-et),i.clearDepth(et),lt=et)},reset:function(){U=!1,ct=null,wt=null,lt=null,St=!1}}}function s(){let U=!1,St=null,ct=null,wt=null,lt=null,et=null,ft=null,Yt=null,me=null;return{setTest:function(ce){U||(ce?j(i.STENCIL_TEST):mt(i.STENCIL_TEST))},setMask:function(ce){St!==ce&&!U&&(i.stencilMask(ce),St=ce)},setFunc:function(ce,Un,Zn){(ct!==ce||wt!==Un||lt!==Zn)&&(i.stencilFunc(ce,Un,Zn),ct=ce,wt=Un,lt=Zn)},setOp:function(ce,Un,Zn){(et!==ce||ft!==Un||Yt!==Zn)&&(i.stencilOp(ce,Un,Zn),et=ce,ft=Un,Yt=Zn)},setLocked:function(ce){U=ce},setClear:function(ce){me!==ce&&(i.clearStencil(ce),me=ce)},reset:function(){U=!1,St=null,ct=null,wt=null,lt=null,et=null,ft=null,Yt=null,me=null}}}const r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,b=null,M=null,y=null,T=null,C=new Bt(0,0,0),L=0,v=!1,S=null,P=null,I=null,F=null,B=null;const N=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,z=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(Z)[1]),H=z>=1):Z.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),H=z>=2);let st=null,$={};const nt=i.getParameter(i.SCISSOR_BOX),Lt=i.getParameter(i.VIEWPORT),It=new Ee().fromArray(nt),Jt=new Ee().fromArray(Lt);function Wt(U,St,ct,wt){const lt=new Uint8Array(4),et=i.createTexture();i.bindTexture(U,et),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ft=0;ft<ct;ft++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(St,0,i.RGBA,1,1,wt,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(St+ft,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return et}const q={};q[i.TEXTURE_2D]=Wt(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=Wt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=Wt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=Wt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),j(i.DEPTH_TEST),a.setFunc(vs),Q(!1),at(ql),j(i.CULL_FACE),K(si);function j(U){h[U]!==!0&&(i.enable(U),h[U]=!0)}function mt(U){h[U]!==!1&&(i.disable(U),h[U]=!1)}function Dt(U,St){return u[U]!==St?(i.bindFramebuffer(U,St),u[U]=St,U===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=St),U===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=St),!0):!1}function Mt(U,St){let ct=f,wt=!1;if(U){ct=d.get(St),ct===void 0&&(ct=[],d.set(St,ct));const lt=U.textures;if(ct.length!==lt.length||ct[0]!==i.COLOR_ATTACHMENT0){for(let et=0,ft=lt.length;et<ft;et++)ct[et]=i.COLOR_ATTACHMENT0+et;ct.length=lt.length,wt=!0}}else ct[0]!==i.BACK&&(ct[0]=i.BACK,wt=!0);wt&&i.drawBuffers(ct)}function qt(U){return g!==U?(i.useProgram(U),g=U,!0):!1}const ne={[Oi]:i.FUNC_ADD,[Eu]:i.FUNC_SUBTRACT,[Tu]:i.FUNC_REVERSE_SUBTRACT};ne[Cu]=i.MIN,ne[Au]=i.MAX;const Xt={[Ru]:i.ZERO,[Pu]:i.ONE,[Iu]:i.SRC_COLOR,[oo]:i.SRC_ALPHA,[Ou]:i.SRC_ALPHA_SATURATE,[Nu]:i.DST_COLOR,[Du]:i.DST_ALPHA,[Lu]:i.ONE_MINUS_SRC_COLOR,[lo]:i.ONE_MINUS_SRC_ALPHA,[Uu]:i.ONE_MINUS_DST_COLOR,[Fu]:i.ONE_MINUS_DST_ALPHA,[Bu]:i.CONSTANT_COLOR,[ku]:i.ONE_MINUS_CONSTANT_COLOR,[zu]:i.CONSTANT_ALPHA,[Hu]:i.ONE_MINUS_CONSTANT_ALPHA};function K(U,St,ct,wt,lt,et,ft,Yt,me,ce){if(U===si){x===!0&&(mt(i.BLEND),x=!1);return}if(x===!1&&(j(i.BLEND),x=!0),U!==bu){if(U!==m||ce!==v){if((p!==Oi||M!==Oi)&&(i.blendEquation(i.FUNC_ADD),p=Oi,M=Oi),ce)switch(U){case xs:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Sn:i.blendFunc(i.ONE,i.ONE);break;case Zl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case $l:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:ee("WebGLState: Invalid blending: ",U);break}else switch(U){case xs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Sn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Zl:ee("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case $l:ee("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ee("WebGLState: Invalid blending: ",U);break}w=null,b=null,y=null,T=null,C.set(0,0,0),L=0,m=U,v=ce}return}lt=lt||St,et=et||ct,ft=ft||wt,(St!==p||lt!==M)&&(i.blendEquationSeparate(ne[St],ne[lt]),p=St,M=lt),(ct!==w||wt!==b||et!==y||ft!==T)&&(i.blendFuncSeparate(Xt[ct],Xt[wt],Xt[et],Xt[ft]),w=ct,b=wt,y=et,T=ft),(Yt.equals(C)===!1||me!==L)&&(i.blendColor(Yt.r,Yt.g,Yt.b,me),C.copy(Yt),L=me),m=U,v=!1}function rt(U,St){U.side===ke?mt(i.CULL_FACE):j(i.CULL_FACE);let ct=U.side===rn;St&&(ct=!ct),Q(ct),U.blending===xs&&U.transparent===!1?K(si):K(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);const wt=U.stencilWrite;o.setTest(wt),wt&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),bt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?j(i.SAMPLE_ALPHA_TO_COVERAGE):mt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Q(U){S!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),S=U)}function at(U){U!==yu?(j(i.CULL_FACE),U!==P&&(U===ql?i.cullFace(i.BACK):U===Su?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):mt(i.CULL_FACE),P=U}function R(U){U!==I&&(H&&i.lineWidth(U),I=U)}function bt(U,St,ct){U?(j(i.POLYGON_OFFSET_FILL),(F!==St||B!==ct)&&(i.polygonOffset(St,ct),F=St,B=ct)):mt(i.POLYGON_OFFSET_FILL)}function _t(U){U?j(i.SCISSOR_TEST):mt(i.SCISSOR_TEST)}function Ut(U){U===void 0&&(U=i.TEXTURE0+N-1),st!==U&&(i.activeTexture(U),st=U)}function ht(U,St,ct){ct===void 0&&(st===null?ct=i.TEXTURE0+N-1:ct=st);let wt=$[ct];wt===void 0&&(wt={type:void 0,texture:void 0},$[ct]=wt),(wt.type!==U||wt.texture!==St)&&(st!==ct&&(i.activeTexture(ct),st=ct),i.bindTexture(U,St||q[U]),wt.type=U,wt.texture=St)}function A(){const U=$[st];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(U){ee("WebGLState:",U)}}function O(){try{i.compressedTexImage3D(...arguments)}catch(U){ee("WebGLState:",U)}}function X(){try{i.texSubImage2D(...arguments)}catch(U){ee("WebGLState:",U)}}function tt(){try{i.texSubImage3D(...arguments)}catch(U){ee("WebGLState:",U)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(U){ee("WebGLState:",U)}}function Pt(){try{i.compressedTexSubImage3D(...arguments)}catch(U){ee("WebGLState:",U)}}function dt(){try{i.texStorage2D(...arguments)}catch(U){ee("WebGLState:",U)}}function At(){try{i.texStorage3D(...arguments)}catch(U){ee("WebGLState:",U)}}function Ht(){try{i.texImage2D(...arguments)}catch(U){ee("WebGLState:",U)}}function ot(){try{i.texImage3D(...arguments)}catch(U){ee("WebGLState:",U)}}function gt(U){It.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),It.copy(U))}function Rt(U){Jt.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Jt.copy(U))}function Ft(U,St){let ct=c.get(St);ct===void 0&&(ct=new WeakMap,c.set(St,ct));let wt=ct.get(U);wt===void 0&&(wt=i.getUniformBlockIndex(St,U.name),ct.set(U,wt))}function pt(U,St){const wt=c.get(St).get(U);l.get(St)!==wt&&(i.uniformBlockBinding(St,wt,U.__bindingPointIndex),l.set(St,wt))}function Kt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},st=null,$={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,b=null,M=null,y=null,T=null,C=new Bt(0,0,0),L=0,v=!1,S=null,P=null,I=null,F=null,B=null,It.set(0,0,i.canvas.width,i.canvas.height),Jt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:j,disable:mt,bindFramebuffer:Dt,drawBuffers:Mt,useProgram:qt,setBlending:K,setMaterial:rt,setFlipSided:Q,setCullFace:at,setLineWidth:R,setPolygonOffset:bt,setScissorTest:_t,activeTexture:Ut,bindTexture:ht,unbindTexture:A,compressedTexImage2D:_,compressedTexImage3D:O,texImage2D:Ht,texImage3D:ot,updateUBOMapping:Ft,uniformBlockBinding:pt,texStorage2D:dt,texStorage3D:At,texSubImage2D:X,texSubImage3D:tt,compressedTexSubImage2D:Y,compressedTexSubImage3D:Pt,scissor:gt,viewport:Rt,reset:Kt}}function Ax(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ut,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,_){return f?new OffscreenCanvas(A,_):Jr("canvas")}function x(A,_,O){let X=1;const tt=ht(A);if((tt.width>O||tt.height>O)&&(X=O/Math.max(tt.width,tt.height)),X<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const Y=Math.floor(X*tt.width),Pt=Math.floor(X*tt.height);u===void 0&&(u=g(Y,Pt));const dt=_?g(Y,Pt):u;return dt.width=Y,dt.height=Pt,dt.getContext("2d").drawImage(A,0,0,Y,Pt),Ot("WebGLRenderer: Texture has been resized from ("+tt.width+"x"+tt.height+") to ("+Y+"x"+Pt+")."),dt}else return"data"in A&&Ot("WebGLRenderer: Image in DataTexture is too big ("+tt.width+"x"+tt.height+")."),A;return A}function m(A){return A.generateMipmaps}function p(A){i.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(A,_,O,X,tt=!1){if(A!==null){if(i[A]!==void 0)return i[A];Ot("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let Y=_;if(_===i.RED&&(O===i.FLOAT&&(Y=i.R32F),O===i.HALF_FLOAT&&(Y=i.R16F),O===i.UNSIGNED_BYTE&&(Y=i.R8)),_===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.R8UI),O===i.UNSIGNED_SHORT&&(Y=i.R16UI),O===i.UNSIGNED_INT&&(Y=i.R32UI),O===i.BYTE&&(Y=i.R8I),O===i.SHORT&&(Y=i.R16I),O===i.INT&&(Y=i.R32I)),_===i.RG&&(O===i.FLOAT&&(Y=i.RG32F),O===i.HALF_FLOAT&&(Y=i.RG16F),O===i.UNSIGNED_BYTE&&(Y=i.RG8)),_===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RG8UI),O===i.UNSIGNED_SHORT&&(Y=i.RG16UI),O===i.UNSIGNED_INT&&(Y=i.RG32UI),O===i.BYTE&&(Y=i.RG8I),O===i.SHORT&&(Y=i.RG16I),O===i.INT&&(Y=i.RG32I)),_===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),O===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),O===i.UNSIGNED_INT&&(Y=i.RGB32UI),O===i.BYTE&&(Y=i.RGB8I),O===i.SHORT&&(Y=i.RGB16I),O===i.INT&&(Y=i.RGB32I)),_===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),O===i.UNSIGNED_INT&&(Y=i.RGBA32UI),O===i.BYTE&&(Y=i.RGBA8I),O===i.SHORT&&(Y=i.RGBA16I),O===i.INT&&(Y=i.RGBA32I)),_===i.RGB&&(O===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),_===i.RGBA){const Pt=tt?$r:se.getTransfer(X);O===i.FLOAT&&(Y=i.RGBA32F),O===i.HALF_FLOAT&&(Y=i.RGBA16F),O===i.UNSIGNED_BYTE&&(Y=Pt===ue?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function M(A,_){let O;return A?_===null||_===Yn||_===js?O=i.DEPTH24_STENCIL8:_===Fn?O=i.DEPTH32F_STENCIL8:_===Js&&(O=i.DEPTH24_STENCIL8,Ot("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Yn||_===js?O=i.DEPTH_COMPONENT24:_===Fn?O=i.DEPTH_COMPONENT32F:_===Js&&(O=i.DEPTH_COMPONENT16),O}function y(A,_){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ve&&A.minFilter!==He?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function T(A){const _=A.target;_.removeEventListener("dispose",T),L(_),_.isVideoTexture&&h.delete(_)}function C(A){const _=A.target;_.removeEventListener("dispose",C),S(_)}function L(A){const _=n.get(A);if(_.__webglInit===void 0)return;const O=A.source,X=d.get(O);if(X){const tt=X[_.__cacheKey];tt.usedTimes--,tt.usedTimes===0&&v(A),Object.keys(X).length===0&&d.delete(O)}n.remove(A)}function v(A){const _=n.get(A);i.deleteTexture(_.__webglTexture);const O=A.source,X=d.get(O);delete X[_.__cacheKey],a.memory.textures--}function S(A){const _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(_.__webglFramebuffer[X]))for(let tt=0;tt<_.__webglFramebuffer[X].length;tt++)i.deleteFramebuffer(_.__webglFramebuffer[X][tt]);else i.deleteFramebuffer(_.__webglFramebuffer[X]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[X])}else{if(Array.isArray(_.__webglFramebuffer))for(let X=0;X<_.__webglFramebuffer.length;X++)i.deleteFramebuffer(_.__webglFramebuffer[X]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let X=0;X<_.__webglColorRenderbuffer.length;X++)_.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[X]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const O=A.textures;for(let X=0,tt=O.length;X<tt;X++){const Y=n.get(O[X]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(O[X])}n.remove(A)}let P=0;function I(){P=0}function F(){const A=P;return A>=s.maxTextures&&Ot("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),P+=1,A}function B(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function N(A,_){const O=n.get(A);if(A.isVideoTexture&&_t(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const X=A.image;if(X===null)Ot("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ot("WebGLRenderer: Texture marked for update but image is incomplete");else{q(O,A,_);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+_)}function H(A,_){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){q(O,A,_);return}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+_)}function z(A,_){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){q(O,A,_);return}e.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+_)}function Z(A,_){const O=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&O.__version!==A.version){j(O,A,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+_)}const st={[vo]:i.REPEAT,[ei]:i.CLAMP_TO_EDGE,[Mo]:i.MIRRORED_REPEAT},$={[Ve]:i.NEAREST,[Wu]:i.NEAREST_MIPMAP_NEAREST,[hr]:i.NEAREST_MIPMAP_LINEAR,[He]:i.LINEAR,[va]:i.LINEAR_MIPMAP_NEAREST,[ki]:i.LINEAR_MIPMAP_LINEAR},nt={[qu]:i.NEVER,[ju]:i.ALWAYS,[Zu]:i.LESS,[bl]:i.LEQUAL,[$u]:i.EQUAL,[El]:i.GEQUAL,[Ku]:i.GREATER,[Ju]:i.NOTEQUAL};function Lt(A,_){if(_.type===Fn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===He||_.magFilter===va||_.magFilter===hr||_.magFilter===ki||_.minFilter===He||_.minFilter===va||_.minFilter===hr||_.minFilter===ki)&&Ot("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,st[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,st[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,st[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,$[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,$[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,nt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ve||_.minFilter!==hr&&_.minFilter!==ki||_.type===Fn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const O=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function It(A,_){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",T));const X=_.source;let tt=d.get(X);tt===void 0&&(tt={},d.set(X,tt));const Y=B(_);if(Y!==A.__cacheKey){tt[Y]===void 0&&(tt[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),tt[Y].usedTimes++;const Pt=tt[A.__cacheKey];Pt!==void 0&&(tt[A.__cacheKey].usedTimes--,Pt.usedTimes===0&&v(_)),A.__cacheKey=Y,A.__webglTexture=tt[Y].texture}return O}function Jt(A,_,O){return Math.floor(Math.floor(A/O)/_)}function Wt(A,_,O,X){const Y=A.updateRanges;if(Y.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,O,X,_.data);else{Y.sort((ot,gt)=>ot.start-gt.start);let Pt=0;for(let ot=1;ot<Y.length;ot++){const gt=Y[Pt],Rt=Y[ot],Ft=gt.start+gt.count,pt=Jt(Rt.start,_.width,4),Kt=Jt(gt.start,_.width,4);Rt.start<=Ft+1&&pt===Kt&&Jt(Rt.start+Rt.count-1,_.width,4)===pt?gt.count=Math.max(gt.count,Rt.start+Rt.count-gt.start):(++Pt,Y[Pt]=Rt)}Y.length=Pt+1;const dt=i.getParameter(i.UNPACK_ROW_LENGTH),At=i.getParameter(i.UNPACK_SKIP_PIXELS),Ht=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ot=0,gt=Y.length;ot<gt;ot++){const Rt=Y[ot],Ft=Math.floor(Rt.start/4),pt=Math.ceil(Rt.count/4),Kt=Ft%_.width,U=Math.floor(Ft/_.width),St=pt,ct=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Kt),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),e.texSubImage2D(i.TEXTURE_2D,0,Kt,U,St,ct,O,X,_.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,dt),i.pixelStorei(i.UNPACK_SKIP_PIXELS,At),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ht)}}function q(A,_,O){let X=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(X=i.TEXTURE_3D);const tt=It(A,_),Y=_.source;e.bindTexture(X,A.__webglTexture,i.TEXTURE0+O);const Pt=n.get(Y);if(Y.version!==Pt.__version||tt===!0){e.activeTexture(i.TEXTURE0+O);const dt=se.getPrimaries(se.workingColorSpace),At=_.colorSpace===_i?null:se.getPrimaries(_.colorSpace),Ht=_.colorSpace===_i||dt===At?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ht);let ot=x(_.image,!1,s.maxTextureSize);ot=Ut(_,ot);const gt=r.convert(_.format,_.colorSpace),Rt=r.convert(_.type);let Ft=b(_.internalFormat,gt,Rt,_.colorSpace,_.isVideoTexture);Lt(X,_);let pt;const Kt=_.mipmaps,U=_.isVideoTexture!==!0,St=Pt.__version===void 0||tt===!0,ct=Y.dataReady,wt=y(_,ot);if(_.isDepthTexture)Ft=M(_.format===zi,_.type),St&&(U?e.texStorage2D(i.TEXTURE_2D,1,Ft,ot.width,ot.height):e.texImage2D(i.TEXTURE_2D,0,Ft,ot.width,ot.height,0,gt,Rt,null));else if(_.isDataTexture)if(Kt.length>0){U&&St&&e.texStorage2D(i.TEXTURE_2D,wt,Ft,Kt[0].width,Kt[0].height);for(let lt=0,et=Kt.length;lt<et;lt++)pt=Kt[lt],U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,gt,Rt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,Ft,pt.width,pt.height,0,gt,Rt,pt.data);_.generateMipmaps=!1}else U?(St&&e.texStorage2D(i.TEXTURE_2D,wt,Ft,ot.width,ot.height),ct&&Wt(_,ot,gt,Rt)):e.texImage2D(i.TEXTURE_2D,0,Ft,ot.width,ot.height,0,gt,Rt,ot.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&St&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,Ft,Kt[0].width,Kt[0].height,ot.depth);for(let lt=0,et=Kt.length;lt<et;lt++)if(pt=Kt[lt],_.format!==Nn)if(gt!==null)if(U){if(ct)if(_.layerUpdates.size>0){const ft=Pc(pt.width,pt.height,_.format,_.type);for(const Yt of _.layerUpdates){const me=pt.data.subarray(Yt*ft/pt.data.BYTES_PER_ELEMENT,(Yt+1)*ft/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,Yt,pt.width,pt.height,1,gt,me)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,ot.depth,gt,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,lt,Ft,pt.width,pt.height,ot.depth,0,pt.data,0,0);else Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?ct&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,ot.depth,gt,Rt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,lt,Ft,pt.width,pt.height,ot.depth,0,gt,Rt,pt.data)}else{U&&St&&e.texStorage2D(i.TEXTURE_2D,wt,Ft,Kt[0].width,Kt[0].height);for(let lt=0,et=Kt.length;lt<et;lt++)pt=Kt[lt],_.format!==Nn?gt!==null?U?ct&&e.compressedTexSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,gt,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,lt,Ft,pt.width,pt.height,0,pt.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,gt,Rt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,Ft,pt.width,pt.height,0,gt,Rt,pt.data)}else if(_.isDataArrayTexture)if(U){if(St&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,Ft,ot.width,ot.height,ot.depth),ct)if(_.layerUpdates.size>0){const lt=Pc(ot.width,ot.height,_.format,_.type);for(const et of _.layerUpdates){const ft=ot.data.subarray(et*lt/ot.data.BYTES_PER_ELEMENT,(et+1)*lt/ot.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,et,ot.width,ot.height,1,gt,Rt,ft)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ot.width,ot.height,ot.depth,gt,Rt,ot.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Ft,ot.width,ot.height,ot.depth,0,gt,Rt,ot.data);else if(_.isData3DTexture)U?(St&&e.texStorage3D(i.TEXTURE_3D,wt,Ft,ot.width,ot.height,ot.depth),ct&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ot.width,ot.height,ot.depth,gt,Rt,ot.data)):e.texImage3D(i.TEXTURE_3D,0,Ft,ot.width,ot.height,ot.depth,0,gt,Rt,ot.data);else if(_.isFramebufferTexture){if(St)if(U)e.texStorage2D(i.TEXTURE_2D,wt,Ft,ot.width,ot.height);else{let lt=ot.width,et=ot.height;for(let ft=0;ft<wt;ft++)e.texImage2D(i.TEXTURE_2D,ft,Ft,lt,et,0,gt,Rt,null),lt>>=1,et>>=1}}else if(Kt.length>0){if(U&&St){const lt=ht(Kt[0]);e.texStorage2D(i.TEXTURE_2D,wt,Ft,lt.width,lt.height)}for(let lt=0,et=Kt.length;lt<et;lt++)pt=Kt[lt],U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,gt,Rt,pt):e.texImage2D(i.TEXTURE_2D,lt,Ft,gt,Rt,pt);_.generateMipmaps=!1}else if(U){if(St){const lt=ht(ot);e.texStorage2D(i.TEXTURE_2D,wt,Ft,lt.width,lt.height)}ct&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,gt,Rt,ot)}else e.texImage2D(i.TEXTURE_2D,0,Ft,gt,Rt,ot);m(_)&&p(X),Pt.__version=Y.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function j(A,_,O){if(_.image.length!==6)return;const X=It(A,_),tt=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+O);const Y=n.get(tt);if(tt.version!==Y.__version||X===!0){e.activeTexture(i.TEXTURE0+O);const Pt=se.getPrimaries(se.workingColorSpace),dt=_.colorSpace===_i?null:se.getPrimaries(_.colorSpace),At=_.colorSpace===_i||Pt===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,At);const Ht=_.isCompressedTexture||_.image[0].isCompressedTexture,ot=_.image[0]&&_.image[0].isDataTexture,gt=[];for(let et=0;et<6;et++)!Ht&&!ot?gt[et]=x(_.image[et],!0,s.maxCubemapSize):gt[et]=ot?_.image[et].image:_.image[et],gt[et]=Ut(_,gt[et]);const Rt=gt[0],Ft=r.convert(_.format,_.colorSpace),pt=r.convert(_.type),Kt=b(_.internalFormat,Ft,pt,_.colorSpace),U=_.isVideoTexture!==!0,St=Y.__version===void 0||X===!0,ct=tt.dataReady;let wt=y(_,Rt);Lt(i.TEXTURE_CUBE_MAP,_);let lt;if(Ht){U&&St&&e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Kt,Rt.width,Rt.height);for(let et=0;et<6;et++){lt=gt[et].mipmaps;for(let ft=0;ft<lt.length;ft++){const Yt=lt[ft];_.format!==Nn?Ft!==null?U?ct&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft,0,0,Yt.width,Yt.height,Ft,Yt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft,Kt,Yt.width,Yt.height,0,Yt.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft,0,0,Yt.width,Yt.height,Ft,pt,Yt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft,Kt,Yt.width,Yt.height,0,Ft,pt,Yt.data)}}}else{if(lt=_.mipmaps,U&&St){lt.length>0&&wt++;const et=ht(gt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Kt,et.width,et.height)}for(let et=0;et<6;et++)if(ot){U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,gt[et].width,gt[et].height,Ft,pt,gt[et].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Kt,gt[et].width,gt[et].height,0,Ft,pt,gt[et].data);for(let ft=0;ft<lt.length;ft++){const me=lt[ft].image[et].image;U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft+1,0,0,me.width,me.height,Ft,pt,me.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft+1,Kt,me.width,me.height,0,Ft,pt,me.data)}}else{U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,Ft,pt,gt[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Kt,Ft,pt,gt[et]);for(let ft=0;ft<lt.length;ft++){const Yt=lt[ft];U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft+1,0,0,Ft,pt,Yt.image[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,ft+1,Kt,Ft,pt,Yt.image[et])}}}m(_)&&p(i.TEXTURE_CUBE_MAP),Y.__version=tt.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function mt(A,_,O,X,tt,Y){const Pt=r.convert(O.format,O.colorSpace),dt=r.convert(O.type),At=b(O.internalFormat,Pt,dt,O.colorSpace),Ht=n.get(_),ot=n.get(O);if(ot.__renderTarget=_,!Ht.__hasExternalTextures){const gt=Math.max(1,_.width>>Y),Rt=Math.max(1,_.height>>Y);tt===i.TEXTURE_3D||tt===i.TEXTURE_2D_ARRAY?e.texImage3D(tt,Y,At,gt,Rt,_.depth,0,Pt,dt,null):e.texImage2D(tt,Y,At,gt,Rt,0,Pt,dt,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,tt,ot.__webglTexture,0,R(_)):(tt===i.TEXTURE_2D||tt>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&tt<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,tt,ot.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Dt(A,_,O){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer){const X=_.depthTexture,tt=X&&X.isDepthTexture?X.type:null,Y=M(_.stencilBuffer,tt),Pt=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(_),Y,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(_),Y,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Y,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Pt,i.RENDERBUFFER,A)}else{const X=_.textures;for(let tt=0;tt<X.length;tt++){const Y=X[tt],Pt=r.convert(Y.format,Y.colorSpace),dt=r.convert(Y.type),At=b(Y.internalFormat,Pt,dt,Y.colorSpace);bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(_),At,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(_),At,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,At,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Mt(A,_,O){const X=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const tt=n.get(_.depthTexture);if(tt.__renderTarget=_,(!tt.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),X){if(tt.__webglInit===void 0&&(tt.__webglInit=!0,_.depthTexture.addEventListener("dispose",T)),tt.__webglTexture===void 0){tt.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,tt.__webglTexture),Lt(i.TEXTURE_CUBE_MAP,_.depthTexture);const Ht=r.convert(_.depthTexture.format),ot=r.convert(_.depthTexture.type);let gt;_.depthTexture.format===li?gt=i.DEPTH_COMPONENT24:_.depthTexture.format===zi&&(gt=i.DEPTH24_STENCIL8);for(let Rt=0;Rt<6;Rt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0,gt,_.width,_.height,0,Ht,ot,null)}}else N(_.depthTexture,0);const Y=tt.__webglTexture,Pt=R(_),dt=X?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,At=_.depthTexture.format===zi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===li)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,At,dt,Y,0,Pt):i.framebufferTexture2D(i.FRAMEBUFFER,At,dt,Y,0);else if(_.depthTexture.format===zi)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,At,dt,Y,0,Pt):i.framebufferTexture2D(i.FRAMEBUFFER,At,dt,Y,0);else throw new Error("Unknown depthTexture format")}function qt(A){const _=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){const X=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),X){const tt=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,X.removeEventListener("dispose",tt)};X.addEventListener("dispose",tt),_.__depthDisposeCallback=tt}_.__boundDepthTexture=X}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(O)for(let X=0;X<6;X++)Mt(_.__webglFramebuffer[X],A,X);else{const X=A.texture.mipmaps;X&&X.length>0?Mt(_.__webglFramebuffer[0],A,0):Mt(_.__webglFramebuffer,A,0)}else if(O){_.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[X]),_.__webglDepthbuffer[X]===void 0)_.__webglDepthbuffer[X]=i.createRenderbuffer(),Dt(_.__webglDepthbuffer[X],A,!1);else{const tt=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,tt,i.RENDERBUFFER,Y)}}else{const X=A.texture.mipmaps;if(X&&X.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Dt(_.__webglDepthbuffer,A,!1);else{const tt=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,tt,i.RENDERBUFFER,Y)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function ne(A,_,O){const X=n.get(A);_!==void 0&&mt(X.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&qt(A)}function Xt(A){const _=A.texture,O=n.get(A),X=n.get(_);A.addEventListener("dispose",C);const tt=A.textures,Y=A.isWebGLCubeRenderTarget===!0,Pt=tt.length>1;if(Pt||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=_.version,a.memory.textures++),Y){O.__webglFramebuffer=[];for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer[dt]=[];for(let At=0;At<_.mipmaps.length;At++)O.__webglFramebuffer[dt][At]=i.createFramebuffer()}else O.__webglFramebuffer[dt]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer=[];for(let dt=0;dt<_.mipmaps.length;dt++)O.__webglFramebuffer[dt]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(Pt)for(let dt=0,At=tt.length;dt<At;dt++){const Ht=n.get(tt[dt]);Ht.__webglTexture===void 0&&(Ht.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&bt(A)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let dt=0;dt<tt.length;dt++){const At=tt[dt];O.__webglColorRenderbuffer[dt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[dt]);const Ht=r.convert(At.format,At.colorSpace),ot=r.convert(At.type),gt=b(At.internalFormat,Ht,ot,At.colorSpace,A.isXRRenderTarget===!0),Rt=R(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Rt,gt,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,O.__webglColorRenderbuffer[dt])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Dt(O.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Lt(i.TEXTURE_CUBE_MAP,_);for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0)for(let At=0;At<_.mipmaps.length;At++)mt(O.__webglFramebuffer[dt][At],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,At);else mt(O.__webglFramebuffer[dt],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0);m(_)&&p(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Pt){for(let dt=0,At=tt.length;dt<At;dt++){const Ht=tt[dt],ot=n.get(Ht);let gt=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(gt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(gt,ot.__webglTexture),Lt(gt,Ht),mt(O.__webglFramebuffer,A,Ht,i.COLOR_ATTACHMENT0+dt,gt,0),m(Ht)&&p(gt)}e.unbindTexture()}else{let dt=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(dt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(dt,X.__webglTexture),Lt(dt,_),_.mipmaps&&_.mipmaps.length>0)for(let At=0;At<_.mipmaps.length;At++)mt(O.__webglFramebuffer[At],A,_,i.COLOR_ATTACHMENT0,dt,At);else mt(O.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,dt,0);m(_)&&p(dt),e.unbindTexture()}A.depthBuffer&&qt(A)}function K(A){const _=A.textures;for(let O=0,X=_.length;O<X;O++){const tt=_[O];if(m(tt)){const Y=w(A),Pt=n.get(tt).__webglTexture;e.bindTexture(Y,Pt),p(Y),e.unbindTexture()}}}const rt=[],Q=[];function at(A){if(A.samples>0){if(bt(A)===!1){const _=A.textures,O=A.width,X=A.height;let tt=i.COLOR_BUFFER_BIT;const Y=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Pt=n.get(A),dt=_.length>1;if(dt)for(let Ht=0;Ht<_.length;Ht++)e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer);const At=A.texture.mipmaps;At&&At.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer);for(let Ht=0;Ht<_.length;Ht++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(tt|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(tt|=i.STENCIL_BUFFER_BIT)),dt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Pt.__webglColorRenderbuffer[Ht]);const ot=n.get(_[Ht]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ot,0)}i.blitFramebuffer(0,0,O,X,0,0,O,X,tt,i.NEAREST),l===!0&&(rt.length=0,Q.length=0,rt.push(i.COLOR_ATTACHMENT0+Ht),A.depthBuffer&&A.resolveDepthBuffer===!1&&(rt.push(Y),Q.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Q)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,rt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),dt)for(let Ht=0;Ht<_.length;Ht++){e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.RENDERBUFFER,Pt.__webglColorRenderbuffer[Ht]);const ot=n.get(_[Ht]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.TEXTURE_2D,ot,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const _=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function R(A){return Math.min(s.maxSamples,A.samples)}function bt(A){const _=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function _t(A){const _=a.render.frame;h.get(A)!==_&&(h.set(A,_),A.update())}function Ut(A,_){const O=A.colorSpace,X=A.format,tt=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==Ss&&O!==_i&&(se.getTransfer(O)===ue?(X!==Nn||tt!==fn)&&Ot("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ee("WebGLTextures: Unsupported texture color space:",O)),_}function ht(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=I,this.setTexture2D=N,this.setTexture2DArray=H,this.setTexture3D=z,this.setTextureCube=Z,this.rebindTextures=ne,this.setupRenderTarget=Xt,this.updateRenderTargetMipmap=K,this.updateMultisampleRenderTarget=at,this.setupDepthRenderbuffer=qt,this.setupFrameBufferTexture=mt,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Rx(i,t){function e(n,s=_i){let r;const a=se.getTransfer(s);if(n===fn)return i.UNSIGNED_BYTE;if(n===_l)return i.UNSIGNED_SHORT_4_4_4_4;if(n===vl)return i.UNSIGNED_SHORT_5_5_5_1;if(n===_h)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===vh)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===gh)return i.BYTE;if(n===xh)return i.SHORT;if(n===Js)return i.UNSIGNED_SHORT;if(n===xl)return i.INT;if(n===Yn)return i.UNSIGNED_INT;if(n===Fn)return i.FLOAT;if(n===oi)return i.HALF_FLOAT;if(n===Mh)return i.ALPHA;if(n===yh)return i.RGB;if(n===Nn)return i.RGBA;if(n===li)return i.DEPTH_COMPONENT;if(n===zi)return i.DEPTH_STENCIL;if(n===Ml)return i.RED;if(n===yl)return i.RED_INTEGER;if(n===ys)return i.RG;if(n===Sl)return i.RG_INTEGER;if(n===wl)return i.RGBA_INTEGER;if(n===Gr||n===Vr||n===Wr||n===Xr)if(a===ue)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Gr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Vr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Xr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Gr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Vr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Xr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===yo||n===So||n===wo||n===bo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===yo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===So)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===wo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===bo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Eo||n===To||n===Co||n===Ao||n===Ro||n===Po||n===Io)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Eo||n===To)return a===ue?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Co)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ao)return r.COMPRESSED_R11_EAC;if(n===Ro)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Po)return r.COMPRESSED_RG11_EAC;if(n===Io)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Lo||n===Do||n===Fo||n===No||n===Uo||n===Oo||n===Bo||n===ko||n===zo||n===Ho||n===Go||n===Vo||n===Wo||n===Xo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Lo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Do)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Fo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===No)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Uo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Oo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Bo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ko)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===zo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ho)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Go)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Vo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Wo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Xo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Yo||n===qo||n===Zo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Yo)return a===ue?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===qo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Zo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===$o||n===Ko||n===Jo||n===jo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===$o)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ko)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Jo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===jo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===js?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const Px=`
void main() {
...
}`;class Lx{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const n=new Nh(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new En({vertexShader:Px,fragmentShader:Ix,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new it(new Xi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Dx extends Ts{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,f=null,g=null;const x=typeof XRWebGLBinding<"u",m=new Lx,p={},w=e.getContextAttributes();let b=null,M=null;const y=[],T=[],C=new ut;let L=null;const v=new Mn;v.viewport=new Ee;const S=new Mn;S.viewport=new Ee;const P=[v,S],I=new Hf;let F=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let j=y[q];return j===void 0&&(j=new za,y[q]=j),j.getTargetRaySpace()},this.getControllerGrip=function(q){let j=y[q];return j===void 0&&(j=new za,y[q]=j),j.getGripSpace()},this.getHand=function(q){let j=y[q];return j===void 0&&(j=new za,y[q]=j),j.getHandSpace()};function N(q){const j=T.indexOf(q.inputSource);if(j===-1)return;const mt=y[j];mt!==void 0&&(mt.update(q.inputSource,q.frame,c||a),mt.dispatchEvent({type:q.type,data:q.inputSource}))}function H(){s.removeEventListener("select",N),s.removeEventListener("selectstart",N),s.removeEventListener("selectend",N),s.removeEventListener("squeeze",N),s.removeEventListener("squeezestart",N),s.removeEventListener("squeezeend",N),s.removeEventListener("end",H),s.removeEventListener("inputsourceschange",z);for(let q=0;q<y.length;q++){const j=T[q];j!==null&&(T[q]=null,y[q].disconnect(j))}F=null,B=null,m.reset();for(const q in p)delete p[q];t.setRenderTarget(b),f=null,d=null,u=null,s=null,M=null,Wt.stop(),n.isPresenting=!1,t.setPixelRatio(L),t.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){r=q,n.isPresenting===!0&&Ot("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,n.isPresenting===!0&&Ot("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u===null&&x&&(u=new XRWebGLBinding(s,e)),u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(q){if(s=q,s!==null){if(b=t.getRenderTarget(),s.addEventListener("select",N),s.addEventListener("selectstart",N),s.addEventListener("selectend",N),s.addEventListener("squeeze",N),s.addEventListener("squeezestart",N),s.addEventListener("squeezeend",N),s.addEventListener("end",H),s.addEventListener("inputsourceschange",z),w.xrCompatible!==!0&&await e.makeXRCompatible(),L=t.getPixelRatio(),t.getSize(C),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let mt=null,Dt=null,Mt=null;w.depth&&(Mt=w.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,mt=w.stencil?zi:li,Dt=w.stencil?js:Yn);const qt={colorFormat:e.RGBA8,depthFormat:Mt,scaleFactor:r};u=this.getBinding(),d=u.createProjectionLayer(qt),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),M=new Xn(d.textureWidth,d.textureHeight,{format:Nn,type:fn,depthTexture:new er(d.textureWidth,d.textureHeight,Dt,void 0,void 0,void 0,void 0,void 0,void 0,mt),stencilBuffer:w.stencil,colorSpace:t.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const mt={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,mt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new Xn(f.framebufferWidth,f.framebufferHeight,{format:Nn,type:fn,colorSpace:t.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Wt.setContext(s),Wt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function z(q){for(let j=0;j<q.removed.length;j++){const mt=q.removed[j],Dt=T.indexOf(mt);Dt>=0&&(T[Dt]=null,y[Dt].disconnect(mt))}for(let j=0;j<q.added.length;j++){const mt=q.added[j];let Dt=T.indexOf(mt);if(Dt===-1){for(let qt=0;qt<y.length;qt++)if(qt>=T.length){T.push(mt),Dt=qt;break}else if(T[qt]===null){T[qt]=mt,Dt=qt;break}if(Dt===-1)break}const Mt=y[Dt];Mt&&Mt.connect(mt)}}const Z=new D,st=new D;function $(q,j,mt){Z.setFromMatrixPosition(j.matrixWorld),st.setFromMatrixPosition(mt.matrixWorld);const Dt=Z.distanceTo(st),Mt=j.projectionMatrix.elements,qt=mt.projectionMatrix.elements,ne=Mt[14]/(Mt[10]-1),Xt=Mt[14]/(Mt[10]+1),K=(Mt[9]+1)/Mt[5],rt=(Mt[9]-1)/Mt[5],Q=(Mt[8]-1)/Mt[0],at=(qt[8]+1)/qt[0],R=ne*Q,bt=ne*at,_t=Dt/(-Q+at),Ut=_t*-Q;if(j.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(Ut),q.translateZ(_t),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),Mt[10]===-1)q.projectionMatrix.copy(j.projectionMatrix),q.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{const ht=ne+_t,A=Xt+_t,_=R-Ut,O=bt+(Dt-Ut),X=K*Xt/A*ht,tt=rt*Xt/A*ht;q.projectionMatrix.makePerspective(_,O,X,tt,ht,A),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function nt(q,j){j===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(j.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(s===null)return;let j=q.near,mt=q.far;m.texture!==null&&(m.depthNear>0&&(j=m.depthNear),m.depthFar>0&&(mt=m.depthFar)),I.near=S.near=v.near=j,I.far=S.far=v.far=mt,(F!==I.near||B!==I.far)&&(s.updateRenderState({depthNear:I.near,depthFar:I.far}),F=I.near,B=I.far),I.layers.mask=q.layers.mask|6,v.layers.mask=I.layers.mask&3,S.layers.mask=I.layers.mask&5;const Dt=q.parent,Mt=I.cameras;nt(I,Dt);for(let qt=0;qt<Mt.length;qt++)nt(Mt[qt],Dt);Mt.length===2?$(I,v,S):I.projectionMatrix.copy(v.projectionMatrix),Lt(q,I,Dt)};function Lt(q,j,mt){mt===null?q.matrix.copy(j.matrixWorld):(q.matrix.copy(mt.matrixWorld),q.matrix.invert(),q.matrix.multiply(j.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(j.projectionMatrix),q.projectionMatrixInverse.copy(j.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=tr*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(d===null&&f===null))return l},this.setFoveation=function(q){l=q,d!==null&&(d.fixedFoveation=q),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=q)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(I)},this.getCameraTexture=function(q){return p[q]};let It=null;function Jt(q,j){if(h=j.getViewerPose(c||a),g=j,h!==null){const mt=h.views;f!==null&&(t.setRenderTargetFramebuffer(M,f.framebuffer),t.setRenderTarget(M));let Dt=!1;mt.length!==I.cameras.length&&(I.cameras.length=0,Dt=!0);for(let Xt=0;Xt<mt.length;Xt++){const K=mt[Xt];let rt=null;if(f!==null)rt=f.getViewport(K);else{const at=u.getViewSubImage(d,K);rt=at.viewport,Xt===0&&(t.setRenderTargetTextures(M,at.colorTexture,at.depthStencilTexture),t.setRenderTarget(M))}let Q=P[Xt];Q===void 0&&(Q=new Mn,Q.layers.enable(Xt),Q.viewport=new Ee,P[Xt]=Q),Q.matrix.fromArray(K.transform.matrix),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.projectionMatrix.fromArray(K.projectionMatrix),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert(),Q.viewport.set(rt.x,rt.y,rt.width,rt.height),Xt===0&&(I.matrix.copy(Q.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Dt===!0&&I.cameras.push(Q)}const Mt=s.enabledFeatures;if(Mt&&Mt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&x){u=n.getBinding();const Xt=u.getDepthInformation(mt[0]);Xt&&Xt.isValid&&Xt.texture&&m.init(Xt,s.renderState)}if(Mt&&Mt.includes("camera-access")&&x){t.state.unbindTexture(),u=n.getBinding();for(let Xt=0;Xt<mt.length;Xt++){const K=mt[Xt].camera;if(K){let rt=p[K];rt||(rt=new Nh,p[K]=rt);const Q=u.getCameraImage(K);rt.sourceTexture=Q}}}}for(let mt=0;mt<y.length;mt++){const Dt=T[mt],Mt=y[mt];Dt!==null&&Mt!==void 0&&Mt.update(Dt,j,c||a)}It&&It(q,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),g=null}const Wt=new qh;Wt.setAnimationLoop(Jt),this.setAnimationLoop=function(q){It=q},this.dispose=function(){}}}const Ni=new Ne,Fx=new te;function Nx(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Ah(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,w,b,M){p.isMeshBasicMaterial||p.isMeshLambertMaterial?r(m,p):p.isMeshToonMaterial?(r(m,p),u(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p)):p.isMeshStandardMaterial?(r(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,M)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),x(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,w,b):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===rn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===rn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const w=t.get(p),b=w.envMap,M=w.envMapRotation;b&&(m.envMap.value=b,Ni.copy(M),Ni.x*=-1,Ni.y*=-1,Ni.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Ni.y*=-1,Ni.z*=-1),m.envMapRotation.value.setFromMatrix4(Fx.makeRotationFromEuler(Ni)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,w,b){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*w,m.scale.value=b*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,w){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===rn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function x(m,p){const w=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Ux(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,b){const M=b.program;n.uniformBlockBinding(w,M)}function c(w,b){let M=s[w.id];M===void 0&&(g(w),M=h(w),s[w.id]=M,w.addEventListener("dispose",m));const y=b.program;n.updateUBOMapping(w,y);const T=t.render.frame;r[w.id]!==T&&(d(w),r[w.id]=T)}function h(w){const b=u();w.__bindingPointIndex=b;const M=i.createBuffer(),y=w.__size,T=w.usage;return i.bindBuffer(i.UNIFORM_BUFFER,M),i.bufferData(i.UNIFORM_BUFFER,y,T),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,M),M}function u(){for(let w=0;w<o;w++)if(a.indexOf(w)===-1)return a.push(w),w;return ee("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(w){const b=s[w.id],M=w.uniforms,y=w.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let T=0,C=M.length;T<C;T++){const L=Array.isArray(M[T])?M[T]:[M[T]];for(let v=0,S=L.length;v<S;v++){const P=L[v];if(f(P,T,v,y)===!0){const I=P.__offset,F=Array.isArray(P.value)?P.value:[P.value];let B=0;for(let N=0;N<F.length;N++){const H=F[N],z=x(H);typeof H=="number"||typeof H=="boolean"?(P.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,I+B,P.__data)):H.isMatrix3?(P.__data[0]=H.elements[0],P.__data[1]=H.elements[1],P.__data[2]=H.elements[2],P.__data[3]=0,P.__data[4]=H.elements[3],P.__data[5]=H.elements[4],P.__data[6]=H.elements[5],P.__data[7]=0,P.__data[8]=H.elements[6],P.__data[9]=H.elements[7],P.__data[10]=H.elements[8],P.__data[11]=0):(H.toArray(P.__data,B),B+=z.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,I,P.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(w,b,M,y){const T=w.value,C=b+"_"+M;if(y[C]===void 0)return typeof T=="number"||typeof T=="boolean"?y[C]=T:y[C]=T.clone(),!0;{const L=y[C];if(typeof T=="number"||typeof T=="boolean"){if(L!==T)return y[C]=T,!0}else if(L.equals(T)===!1)return L.copy(T),!0}return!1}function g(w){const b=w.uniforms;let M=0;const y=16;for(let C=0,L=b.length;C<L;C++){const v=Array.isArray(b[C])?b[C]:[b[C]];for(let S=0,P=v.length;S<P;S++){const I=v[S],F=Array.isArray(I.value)?I.value:[I.value];for(let B=0,N=F.length;B<N;B++){const H=F[B],z=x(H),Z=M%y,st=Z%z.boundary,$=Z+st;M+=st,$!==0&&y-$<z.storage&&(M+=y-$),I.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=M,M+=z.storage}}}const T=M%y;return T>0&&(M+=y-T),w.__size=M,w.__cache={},this}function x(w){const b={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(b.boundary=4,b.storage=4):w.isVector2?(b.boundary=8,b.storage=8):w.isVector3||w.isColor?(b.boundary=16,b.storage=12):w.isVector4?(b.boundary=16,b.storage=16):w.isMatrix3?(b.boundary=48,b.storage=48):w.isMatrix4?(b.boundary=64,b.storage=64):w.isTexture?Ot("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ot("WebGLRenderer: Unsupported uniform value type.",w),b}function m(w){const b=w.target;b.removeEventListener("dispose",m);const M=a.indexOf(b.__bindingPointIndex);a.splice(M,1),i.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function p(){for(const w in s)i.deleteBuffer(s[w]);a=[],s={},r={}}return{bind:l,update:c,dispose:p}}const Ox=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let On=null;function Bx(){return On===null&&(On=new Dh(Ox,16,16,ys,oi),On.name="DFG_LUT",On.minFilter=He,On.magFilter=He,On.wrapS=ei,On.wrapT=ei,On.generateMipmaps=!1,On.needsUpdate=!0),On}class kx{constructor(t={}){const{canvas:e=Qu(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=fn}=t;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const x=f,m=new Set([wl,Sl,yl]),p=new Set([fn,Yn,Js,js,_l,vl]),w=new Uint32Array(4),b=new Int32Array(4);let M=null,y=null;const T=[],C=[];let L=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Vn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const v=this;let S=!1;this._outputColorSpace=xn;let P=0,I=0,F=null,B=-1,N=null;const H=new Ee,z=new Ee;let Z=null;const st=new Bt(0);let $=0,nt=e.width,Lt=e.height,It=1,Jt=null,Wt=null;const q=new Ee(0,0,nt,Lt),j=new Ee(0,0,nt,Lt);let mt=!1;const Dt=new Al;let Mt=!1,qt=!1;const ne=new te,Xt=new D,K=new Ee,rt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Q=!1;function at(){return F===null?It:1}let R=n;function bt(E,k){return e.getContext(E,k)}try{const E={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${gl}`),e.addEventListener("webglcontextlost",Yt,!1),e.addEventListener("webglcontextrestored",me,!1),e.addEventListener("webglcontextcreationerror",ce,!1),R===null){const k="webgl2";if(R=bt(k,E),R===null)throw bt(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw ee("WebGLRenderer: "+E.message),E}let _t,Ut,ht,A,_,O,X,tt,Y,Pt,dt,At,Ht,ot,gt,Rt,Ft,pt,Kt,U,St,ct,wt,lt;function et(){_t=new B0(R),_t.init(),ct=new Rx(R,_t),Ut=new R0(R,_t,t,ct),ht=new Cx(R,_t),Ut.reversedDepthBuffer&&d&&ht.buffers.depth.setReversed(!0),A=new H0(R),_=new dx,O=new Ax(R,_t,ht,_,Ut,ct,A),X=new I0(v),tt=new O0(v),Y=new Xf(R),wt=new C0(R,Y),Pt=new k0(R,Y,A,wt),dt=new V0(R,Pt,Y,A),Kt=new G0(R,Ut,O),Rt=new P0(_),At=new ux(v,X,tt,_t,Ut,wt,Rt),Ht=new Nx(v,_),ot=new px,gt=new Mx(_t),pt=new T0(v,X,tt,ht,dt,g,l),Ft=new Ex(v,dt,Ut),lt=new Ux(R,A,Ut,ht),U=new A0(R,_t,A),St=new z0(R,_t,A),A.programs=At.programs,v.capabilities=Ut,v.extensions=_t,v.properties=_,v.renderLists=ot,v.shadowMap=Ft,v.state=ht,v.info=A}et(),x!==fn&&(L=new X0(x,e.width,e.height,s,r));const ft=new Dx(v,R);this.xr=ft,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const E=_t.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=_t.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return It},this.setPixelRatio=function(E){E!==void 0&&(It=E,this.setSize(nt,Lt,!1))},this.getSize=function(E){return E.set(nt,Lt)},this.setSize=function(E,k,W=!0){if(ft.isPresenting){Ot("WebGLRenderer: Can't change size while VR device is presenting.");return}nt=E,Lt=k,e.width=Math.floor(E*It),e.height=Math.floor(k*It),W===!0&&(e.style.width=E+"px",e.style.height=k+"px"),L!==null&&L.setSize(e.width,e.height),this.setViewport(0,0,E,k)},this.getDrawingBufferSize=function(E){return E.set(nt*It,Lt*It).floor()},this.setDrawingBufferSize=function(E,k,W){nt=E,Lt=k,It=W,e.width=Math.floor(E*W),e.height=Math.floor(k*W),this.setViewport(0,0,E,k)},this.setEffects=function(E){if(x===fn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let k=0;k<E.length;k++)if(E[k].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}L.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(H)},this.getViewport=function(E){return E.copy(q)},this.setViewport=function(E,k,W,V){E.isVector4?q.set(E.x,E.y,E.z,E.w):q.set(E,k,W,V),ht.viewport(H.copy(q).multiplyScalar(It).round())},this.getScissor=function(E){return E.copy(j)},this.setScissor=function(E,k,W,V){E.isVector4?j.set(E.x,E.y,E.z,E.w):j.set(E,k,W,V),ht.scissor(z.copy(j).multiplyScalar(It).round())},this.getScissorTest=function(){return mt},this.setScissorTest=function(E){ht.setScissorTest(mt=E)},this.setOpaqueSort=function(E){Jt=E},this.setTransparentSort=function(E){Wt=E},this.getClearColor=function(E){return E.copy(pt.getClearColor())},this.setClearColor=function(){pt.setClearColor(...arguments)},this.getClearAlpha=function(){return pt.getClearAlpha()},this.setClearAlpha=function(){pt.setClearAlpha(...arguments)},this.clear=function(E=!0,k=!0,W=!0){let V=0;if(E){let G=!1;if(F!==null){const xt=F.texture.format;G=m.has(xt)}if(G){const xt=F.texture.type,Et=p.has(xt),yt=pt.getClearColor(),Ct=pt.getClearAlpha(),Nt=yt.r,Gt=yt.g,kt=yt.b;Et?(w[0]=Nt,w[1]=Gt,w[2]=kt,w[3]=Ct,R.clearBufferuiv(R.COLOR,0,w)):(b[0]=Nt,b[1]=Gt,b[2]=kt,b[3]=Ct,R.clearBufferiv(R.COLOR,0,b))}else V|=R.COLOR_BUFFER_BIT}k&&(V|=R.DEPTH_BUFFER_BIT),W&&(V|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Yt,!1),e.removeEventListener("webglcontextrestored",me,!1),e.removeEventListener("webglcontextcreationerror",ce,!1),pt.dispose(),ot.dispose(),gt.dispose(),_.dispose(),X.dispose(),tt.dispose(),dt.dispose(),wt.dispose(),lt.dispose(),At.dispose(),ft.dispose(),ft.removeEventListener("sessionstart",zl),ft.removeEventListener("sessionend",Hl),Ei.stop()};function Yt(E){E.preventDefault(),jr("WebGLRenderer: Context Lost."),S=!0}function me(){jr("WebGLRenderer: Context Restored."),S=!1;const E=A.autoReset,k=Ft.enabled,W=Ft.autoUpdate,V=Ft.needsUpdate,G=Ft.type;et(),A.autoReset=E,Ft.enabled=k,Ft.autoUpdate=W,Ft.needsUpdate=V,Ft.type=G}function ce(E){ee("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function Un(E){const k=E.target;k.removeEventListener("dispose",Un),Zn(k)}function Zn(E){fu(E),_.remove(E)}function fu(E){const k=_.get(E).programs;k!==void 0&&(k.forEach(function(W){At.releaseProgram(W)}),E.isShaderMaterial&&At.releaseShaderCache(E))}this.renderBufferDirect=function(E,k,W,V,G,xt){k===null&&(k=rt);const Et=G.isMesh&&G.matrixWorld.determinant()<0,yt=mu(E,k,W,V,G);ht.setMaterial(V,Et);let Ct=W.index,Nt=1;if(V.wireframe===!0){if(Ct=Pt.getWireframeAttribute(W),Ct===void 0)return;Nt=2}const Gt=W.drawRange,kt=W.attributes.position;let jt=Gt.start*Nt,fe=(Gt.start+Gt.count)*Nt;xt!==null&&(jt=Math.max(jt,xt.start*Nt),fe=Math.min(fe,(xt.start+xt.count)*Nt)),Ct!==null?(jt=Math.max(jt,0),fe=Math.min(fe,Ct.count)):kt!=null&&(jt=Math.max(jt,0),fe=Math.min(fe,kt.count));const ve=fe-jt;if(ve<0||ve===1/0)return;wt.setup(G,V,yt,W,Ct);let Me,pe=U;if(Ct!==null&&(Me=Y.get(Ct),pe=St,pe.setIndex(Me)),G.isMesh)V.wireframe===!0?(ht.setLineWidth(V.wireframeLinewidth*at()),pe.setMode(R.LINES)):pe.setMode(R.TRIANGLES);else if(G.isLine){let zt=V.linewidth;zt===void 0&&(zt=1),ht.setLineWidth(zt*at()),G.isLineSegments?pe.setMode(R.LINES):G.isLineLoop?pe.setMode(R.LINE_LOOP):pe.setMode(R.LINE_STRIP)}else G.isPoints?pe.setMode(R.POINTS):G.isSprite&&pe.setMode(R.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)Qs("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),pe.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(_t.get("WEBGL_multi_draw"))pe.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const zt=G._multiDrawStarts,he=G._multiDrawCounts,re=G._multiDrawCount,on=Ct?Y.get(Ct).bytesPerElement:1,Yi=_.get(V).currentProgram.getUniforms();for(let ln=0;ln<re;ln++)Yi.setValue(R,"_gl_DrawID",ln),pe.render(zt[ln]/on,he[ln])}else if(G.isInstancedMesh)pe.renderInstances(jt,ve,G.count);else if(W.isInstancedBufferGeometry){const zt=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,he=Math.min(W.instanceCount,zt);pe.renderInstances(jt,ve,he)}else pe.render(jt,ve)};function kl(E,k,W){E.transparent===!0&&E.side===ke&&E.forceSinglePass===!1?(E.side=rn,E.needsUpdate=!0,cr(E,k,W),E.side=wi,E.needsUpdate=!0,cr(E,k,W),E.side=ke):cr(E,k,W)}this.compile=function(E,k,W=null){W===null&&(W=E),y=gt.get(W),y.init(k),C.push(y),W.traverseVisible(function(G){G.isLight&&G.layers.test(k.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),E!==W&&E.traverseVisible(function(G){G.isLight&&G.layers.test(k.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),y.setupLights();const V=new Set;return E.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const xt=G.material;if(xt)if(Array.isArray(xt))for(let Et=0;Et<xt.length;Et++){const yt=xt[Et];kl(yt,W,G),V.add(yt)}else kl(xt,W,G),V.add(xt)}),y=C.pop(),V},this.compileAsync=function(E,k,W=null){const V=this.compile(E,k,W);return new Promise(G=>{function xt(){if(V.forEach(function(Et){_.get(Et).currentProgram.isReady()&&V.delete(Et)}),V.size===0){G(E);return}setTimeout(xt,10)}_t.get("KHR_parallel_shader_compile")!==null?xt():setTimeout(xt,10)})};let ga=null;function pu(E){ga&&ga(E)}function zl(){Ei.stop()}function Hl(){Ei.start()}const Ei=new qh;Ei.setAnimationLoop(pu),typeof self<"u"&&Ei.setContext(self),this.setAnimationLoop=function(E){ga=E,ft.setAnimationLoop(E),E===null?Ei.stop():Ei.start()},ft.addEventListener("sessionstart",zl),ft.addEventListener("sessionend",Hl),this.render=function(E,k){if(k!==void 0&&k.isCamera!==!0){ee("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;const W=ft.enabled===!0&&ft.isPresenting===!0,V=L!==null&&(F===null||W)&&L.begin(v,F);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),ft.enabled===!0&&ft.isPresenting===!0&&(L===null||L.isCompositing()===!1)&&(ft.cameraAutoUpdate===!0&&ft.updateCamera(k),k=ft.getCamera()),E.isScene===!0&&E.onBeforeRender(v,E,k,F),y=gt.get(E,C.length),y.init(k),C.push(y),ne.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),Dt.setFromProjectionMatrix(ne,zn,k.reversedDepth),qt=this.localClippingEnabled,Mt=Rt.init(this.clippingPlanes,qt),M=ot.get(E,T.length),M.init(),T.push(M),ft.enabled===!0&&ft.isPresenting===!0){const Et=v.xr.getDepthSensingMesh();Et!==null&&xa(Et,k,-1/0,v.sortObjects)}xa(E,k,0,v.sortObjects),M.finish(),v.sortObjects===!0&&M.sort(Jt,Wt),Q=ft.enabled===!1||ft.isPresenting===!1||ft.hasDepthSensing()===!1,Q&&pt.addToRenderList(M,E),this.info.render.frame++,Mt===!0&&Rt.beginShadows();const G=y.state.shadowsArray;if(Ft.render(G,E,k),Mt===!0&&Rt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(V&&L.hasRenderPass())===!1){const Et=M.opaque,yt=M.transmissive;if(y.setupLights(),k.isArrayCamera){const Ct=k.cameras;if(yt.length>0)for(let Nt=0,Gt=Ct.length;Nt<Gt;Nt++){const kt=Ct[Nt];Vl(Et,yt,E,kt)}Q&&pt.render(E);for(let Nt=0,Gt=Ct.length;Nt<Gt;Nt++){const kt=Ct[Nt];Gl(M,E,kt,kt.viewport)}}else yt.length>0&&Vl(Et,yt,E,k),Q&&pt.render(E),Gl(M,E,k)}F!==null&&I===0&&(O.updateMultisampleRenderTarget(F),O.updateRenderTargetMipmap(F)),V&&L.end(v),E.isScene===!0&&E.onAfterRender(v,E,k),wt.resetDefaultState(),B=-1,N=null,C.pop(),C.length>0?(y=C[C.length-1],Mt===!0&&Rt.setGlobalState(v.clippingPlanes,y.state.camera)):y=null,T.pop(),T.length>0?M=T[T.length-1]:M=null};function xa(E,k,W,V){if(E.visible===!1)return;if(E.layers.test(k.layers)){if(E.isGroup)W=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(k);else if(E.isLight)y.pushLight(E),E.castShadow&&y.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Dt.intersectsSprite(E)){V&&K.setFromMatrixPosition(E.matrixWorld).applyMatrix4(ne);const Et=dt.update(E),yt=E.material;yt.visible&&M.push(E,Et,yt,W,K.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Dt.intersectsObject(E))){const Et=dt.update(E),yt=E.material;if(V&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),K.copy(E.boundingSphere.center)):(Et.boundingSphere===null&&Et.computeBoundingSphere(),K.copy(Et.boundingSphere.center)),K.applyMatrix4(E.matrixWorld).applyMatrix4(ne)),Array.isArray(yt)){const Ct=Et.groups;for(let Nt=0,Gt=Ct.length;Nt<Gt;Nt++){const kt=Ct[Nt],jt=yt[kt.materialIndex];jt&&jt.visible&&M.push(E,Et,jt,W,K.z,kt)}}else yt.visible&&M.push(E,Et,yt,W,K.z,null)}}const xt=E.children;for(let Et=0,yt=xt.length;Et<yt;Et++)xa(xt[Et],k,W,V)}function Gl(E,k,W,V){const{opaque:G,transmissive:xt,transparent:Et}=E;y.setupLightsView(W),Mt===!0&&Rt.setGlobalState(v.clippingPlanes,W),V&&ht.viewport(H.copy(V)),G.length>0&&lr(G,k,W),xt.length>0&&lr(xt,k,W),Et.length>0&&lr(Et,k,W),ht.buffers.depth.setTest(!0),ht.buffers.depth.setMask(!0),ht.buffers.color.setMask(!0),ht.setPolygonOffset(!1)}function Vl(E,k,W,V){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[V.id]===void 0){const jt=_t.has("EXT_color_buffer_half_float")||_t.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[V.id]=new Xn(1,1,{generateMipmaps:!0,type:jt?oi:fn,minFilter:ki,samples:Ut.samples,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:se.workingColorSpace})}const xt=y.state.transmissionRenderTarget[V.id],Et=V.viewport||H;xt.setSize(Et.z*v.transmissionResolutionScale,Et.w*v.transmissionResolutionScale);const yt=v.getRenderTarget(),Ct=v.getActiveCubeFace(),Nt=v.getActiveMipmapLevel();v.setRenderTarget(xt),v.getClearColor(st),$=v.getClearAlpha(),$<1&&v.setClearColor(16777215,.5),v.clear(),Q&&pt.render(W);const Gt=v.toneMapping;v.toneMapping=Vn;const kt=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),y.setupLightsView(V),Mt===!0&&Rt.setGlobalState(v.clippingPlanes,V),lr(E,W,V),O.updateMultisampleRenderTarget(xt),O.updateRenderTargetMipmap(xt),_t.has("WEBGL_multisampled_render_to_texture")===!1){let jt=!1;for(let fe=0,ve=k.length;fe<ve;fe++){const Me=k[fe],{object:pe,geometry:zt,material:he,group:re}=Me;if(he.side===ke&&pe.layers.test(V.layers)){const on=he.side;he.side=rn,he.needsUpdate=!0,Wl(pe,W,V,zt,he,re),he.side=on,he.needsUpdate=!0,jt=!0}}jt===!0&&(O.updateMultisampleRenderTarget(xt),O.updateRenderTargetMipmap(xt))}v.setRenderTarget(yt,Ct,Nt),v.setClearColor(st,$),kt!==void 0&&(V.viewport=kt),v.toneMapping=Gt}function lr(E,k,W){const V=k.isScene===!0?k.overrideMaterial:null;for(let G=0,xt=E.length;G<xt;G++){const Et=E[G],{object:yt,geometry:Ct,group:Nt}=Et;let Gt=Et.material;Gt.allowOverride===!0&&V!==null&&(Gt=V),yt.layers.test(W.layers)&&Wl(yt,k,W,Ct,Gt,Nt)}}function Wl(E,k,W,V,G,xt){E.onBeforeRender(v,k,W,V,G,xt),E.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),G.onBeforeRender(v,k,W,V,E,xt),G.transparent===!0&&G.side===ke&&G.forceSinglePass===!1?(G.side=rn,G.needsUpdate=!0,v.renderBufferDirect(W,k,V,G,E,xt),G.side=wi,G.needsUpdate=!0,v.renderBufferDirect(W,k,V,G,E,xt),G.side=ke):v.renderBufferDirect(W,k,V,G,E,xt),E.onAfterRender(v,k,W,V,G,xt)}function cr(E,k,W){k.isScene!==!0&&(k=rt);const V=_.get(E),G=y.state.lights,xt=y.state.shadowsArray,Et=G.state.version,yt=At.getParameters(E,G.state,xt,k,W),Ct=At.getProgramCacheKey(yt);let Nt=V.programs;V.environment=E.isMeshStandardMaterial?k.environment:null,V.fog=k.fog,V.envMap=(E.isMeshStandardMaterial?tt:X).get(E.envMap||V.environment),V.envMapRotation=V.environment!==null&&E.envMap===null?k.environmentRotation:E.envMapRotation,Nt===void 0&&(E.addEventListener("dispose",Un),Nt=new Map,V.programs=Nt);let Gt=Nt.get(Ct);if(Gt!==void 0){if(V.currentProgram===Gt&&V.lightsStateVersion===Et)return Yl(E,yt),Gt}else yt.uniforms=At.getUniforms(E),E.onBeforeCompile(yt,v),Gt=At.acquireProgram(yt,Ct),Nt.set(Ct,Gt),V.uniforms=yt.uniforms;const kt=V.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(kt.clippingPlanes=Rt.uniform),Yl(E,yt),V.needsLights=xu(E),V.lightsStateVersion=Et,V.needsLights&&(kt.ambientLightColor.value=G.state.ambient,kt.lightProbe.value=G.state.probe,kt.directionalLights.value=G.state.directional,kt.directionalLightShadows.value=G.state.directionalShadow,kt.spotLights.value=G.state.spot,kt.spotLightShadows.value=G.state.spotShadow,kt.rectAreaLights.value=G.state.rectArea,kt.ltc_1.value=G.state.rectAreaLTC1,kt.ltc_2.value=G.state.rectAreaLTC2,kt.pointLights.value=G.state.point,kt.pointLightShadows.value=G.state.pointShadow,kt.hemisphereLights.value=G.state.hemi,kt.directionalShadowMap.value=G.state.directionalShadowMap,kt.directionalShadowMatrix.value=G.state.directionalShadowMatrix,kt.spotShadowMap.value=G.state.spotShadowMap,kt.spotLightMatrix.value=G.state.spotLightMatrix,kt.spotLightMap.value=G.state.spotLightMap,kt.pointShadowMap.value=G.state.pointShadowMap,kt.pointShadowMatrix.value=G.state.pointShadowMatrix),V.currentProgram=Gt,V.uniformsList=null,Gt}function Xl(E){if(E.uniformsList===null){const k=E.currentProgram.getUniforms();E.uniformsList=Yr.seqWithValue(k.seq,E.uniforms)}return E.uniformsList}function Yl(E,k){const W=_.get(E);W.outputColorSpace=k.outputColorSpace,W.batching=k.batching,W.batchingColor=k.batchingColor,W.instancing=k.instancing,W.instancingColor=k.instancingColor,W.instancingMorph=k.instancingMorph,W.skinning=k.skinning,W.morphTargets=k.morphTargets,W.morphNormals=k.morphNormals,W.morphColors=k.morphColors,W.morphTargetsCount=k.morphTargetsCount,W.numClippingPlanes=k.numClippingPlanes,W.numIntersection=k.numClipIntersection,W.vertexAlphas=k.vertexAlphas,W.vertexTangents=k.vertexTangents,W.toneMapping=k.toneMapping}function mu(E,k,W,V,G){k.isScene!==!0&&(k=rt),O.resetTextureUnits();const xt=k.fog,Et=V.isMeshStandardMaterial?k.environment:null,yt=F===null?v.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Ss,Ct=(V.isMeshStandardMaterial?tt:X).get(V.envMap||Et),Nt=V.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Gt=!!W.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),kt=!!W.morphAttributes.position,jt=!!W.morphAttributes.normal,fe=!!W.morphAttributes.color;let ve=Vn;V.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(ve=v.toneMapping);const Me=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,pe=Me!==void 0?Me.length:0,zt=_.get(V),he=y.state.lights;if(Mt===!0&&(qt===!0||E!==N)){const $e=E===N&&V.id===B;Rt.setState(V,E,$e)}let re=!1;V.version===zt.__version?(zt.needsLights&&zt.lightsStateVersion!==he.state.version||zt.outputColorSpace!==yt||G.isBatchedMesh&&zt.batching===!1||!G.isBatchedMesh&&zt.batching===!0||G.isBatchedMesh&&zt.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&zt.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&zt.instancing===!1||!G.isInstancedMesh&&zt.instancing===!0||G.isSkinnedMesh&&zt.skinning===!1||!G.isSkinnedMesh&&zt.skinning===!0||G.isInstancedMesh&&zt.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&zt.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&zt.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&zt.instancingMorph===!1&&G.morphTexture!==null||zt.envMap!==Ct||V.fog===!0&&zt.fog!==xt||zt.numClippingPlanes!==void 0&&(zt.numClippingPlanes!==Rt.numPlanes||zt.numIntersection!==Rt.numIntersection)||zt.vertexAlphas!==Nt||zt.vertexTangents!==Gt||zt.morphTargets!==kt||zt.morphNormals!==jt||zt.morphColors!==fe||zt.toneMapping!==ve||zt.morphTargetsCount!==pe)&&(re=!0):(re=!0,zt.__version=V.version);let on=zt.currentProgram;re===!0&&(on=cr(V,k,G));let Yi=!1,ln=!1,As=!1;const ge=on.getUniforms(),en=zt.uniforms;if(ht.useProgram(on.program)&&(Yi=!0,ln=!0,As=!0),V.id!==B&&(B=V.id,ln=!0),Yi||N!==E){ht.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),ge.setValue(R,"projectionMatrix",E.projectionMatrix),ge.setValue(R,"viewMatrix",E.matrixWorldInverse);const nn=ge.map.cameraPosition;nn!==void 0&&nn.setValue(R,Xt.setFromMatrixPosition(E.matrixWorld)),Ut.logarithmicDepthBuffer&&ge.setValue(R,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ge.setValue(R,"isOrthographic",E.isOrthographicCamera===!0),N!==E&&(N=E,ln=!0,As=!0)}if(zt.needsLights&&(he.state.directionalShadowMap.length>0&&ge.setValue(R,"directionalShadowMap",he.state.directionalShadowMap,O),he.state.spotShadowMap.length>0&&ge.setValue(R,"spotShadowMap",he.state.spotShadowMap,O),he.state.pointShadowMap.length>0&&ge.setValue(R,"pointShadowMap",he.state.pointShadowMap,O)),G.isSkinnedMesh){ge.setOptional(R,G,"bindMatrix"),ge.setOptional(R,G,"bindMatrixInverse");const $e=G.skeleton;$e&&($e.boneTexture===null&&$e.computeBoneTexture(),ge.setValue(R,"boneTexture",$e.boneTexture,O))}G.isBatchedMesh&&(ge.setOptional(R,G,"batchingTexture"),ge.setValue(R,"batchingTexture",G._matricesTexture,O),ge.setOptional(R,G,"batchingIdTexture"),ge.setValue(R,"batchingIdTexture",G._indirectTexture,O),ge.setOptional(R,G,"batchingColorTexture"),G._colorsTexture!==null&&ge.setValue(R,"batchingColorTexture",G._colorsTexture,O));const pn=W.morphAttributes;if((pn.position!==void 0||pn.normal!==void 0||pn.color!==void 0)&&Kt.update(G,W,on),(ln||zt.receiveShadow!==G.receiveShadow)&&(zt.receiveShadow=G.receiveShadow,ge.setValue(R,"receiveShadow",G.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(en.envMap.value=Ct,en.flipEnvMap.value=Ct.isCubeTexture&&Ct.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&k.environment!==null&&(en.envMapIntensity.value=k.environmentIntensity),en.dfgLUT!==void 0&&(en.dfgLUT.value=Bx()),ln&&(ge.setValue(R,"toneMappingExposure",v.toneMappingExposure),zt.needsLights&&gu(en,As),xt&&V.fog===!0&&Ht.refreshFogUniforms(en,xt),Ht.refreshMaterialUniforms(en,V,It,Lt,y.state.transmissionRenderTarget[E.id]),Yr.upload(R,Xl(zt),en,O)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Yr.upload(R,Xl(zt),en,O),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ge.setValue(R,"center",G.center),ge.setValue(R,"modelViewMatrix",G.modelViewMatrix),ge.setValue(R,"normalMatrix",G.normalMatrix),ge.setValue(R,"modelMatrix",G.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const $e=V.uniformsGroups;for(let nn=0,_a=$e.length;nn<_a;nn++){const Ti=$e[nn];lt.update(Ti,on),lt.bind(Ti,on)}}return on}function gu(E,k){E.ambientLightColor.needsUpdate=k,E.lightProbe.needsUpdate=k,E.directionalLights.needsUpdate=k,E.directionalLightShadows.needsUpdate=k,E.pointLights.needsUpdate=k,E.pointLightShadows.needsUpdate=k,E.spotLights.needsUpdate=k,E.spotLightShadows.needsUpdate=k,E.rectAreaLights.needsUpdate=k,E.hemisphereLights.needsUpdate=k}function xu(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(E,k,W){const V=_.get(E);V.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),_.get(E.texture).__webglTexture=k,_.get(E.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:W,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,k){const W=_.get(E);W.__webglFramebuffer=k,W.__useDefaultFramebuffer=k===void 0};const _u=R.createFramebuffer();this.setRenderTarget=function(E,k=0,W=0){F=E,P=k,I=W;let V=null,G=!1,xt=!1;if(E){const yt=_.get(E);if(yt.__useDefaultFramebuffer!==void 0){ht.bindFramebuffer(R.FRAMEBUFFER,yt.__webglFramebuffer),H.copy(E.viewport),z.copy(E.scissor),Z=E.scissorTest,ht.viewport(H),ht.scissor(z),ht.setScissorTest(Z),B=-1;return}else if(yt.__webglFramebuffer===void 0)O.setupRenderTarget(E);else if(yt.__hasExternalTextures)O.rebindTextures(E,_.get(E.texture).__webglTexture,_.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const Gt=E.depthTexture;if(yt.__boundDepthTexture!==Gt){if(Gt!==null&&_.has(Gt)&&(E.width!==Gt.image.width||E.height!==Gt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");O.setupDepthRenderbuffer(E)}}const Ct=E.texture;(Ct.isData3DTexture||Ct.isDataArrayTexture||Ct.isCompressedArrayTexture)&&(xt=!0);const Nt=_.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Nt[k])?V=Nt[k][W]:V=Nt[k],G=!0):E.samples>0&&O.useMultisampledRTT(E)===!1?V=_.get(E).__webglMultisampledFramebuffer:Array.isArray(Nt)?V=Nt[W]:V=Nt,H.copy(E.viewport),z.copy(E.scissor),Z=E.scissorTest}else H.copy(q).multiplyScalar(It).floor(),z.copy(j).multiplyScalar(It).floor(),Z=mt;if(W!==0&&(V=_u),ht.bindFramebuffer(R.FRAMEBUFFER,V)&&ht.drawBuffers(E,V),ht.viewport(H),ht.scissor(z),ht.setScissorTest(Z),G){const yt=_.get(E.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+k,yt.__webglTexture,W)}else if(xt){const yt=k;for(let Ct=0;Ct<E.textures.length;Ct++){const Nt=_.get(E.textures[Ct]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+Ct,Nt.__webglTexture,W,yt)}}else if(E!==null&&W!==0){const yt=_.get(E.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,yt.__webglTexture,W)}B=-1},this.readRenderTargetPixels=function(E,k,W,V,G,xt,Et,yt=0){if(!(E&&E.isWebGLRenderTarget)){ee("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ct=_.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Et!==void 0&&(Ct=Ct[Et]),Ct){ht.bindFramebuffer(R.FRAMEBUFFER,Ct);try{const Nt=E.textures[yt],Gt=Nt.format,kt=Nt.type;if(!Ut.textureFormatReadable(Gt)){ee("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ut.textureTypeReadable(kt)){ee("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=E.width-V&&W>=0&&W<=E.height-G&&(E.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+yt),R.readPixels(k,W,V,G,ct.convert(Gt),ct.convert(kt),xt))}finally{const Nt=F!==null?_.get(F).__webglFramebuffer:null;ht.bindFramebuffer(R.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(E,k,W,V,G,xt,Et,yt=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ct=_.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Et!==void 0&&(Ct=Ct[Et]),Ct)if(k>=0&&k<=E.width-V&&W>=0&&W<=E.height-G){ht.bindFramebuffer(R.FRAMEBUFFER,Ct);const Nt=E.textures[yt],Gt=Nt.format,kt=Nt.type;if(!Ut.textureFormatReadable(Gt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ut.textureTypeReadable(kt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const jt=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,jt),R.bufferData(R.PIXEL_PACK_BUFFER,xt.byteLength,R.STREAM_READ),E.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+yt),R.readPixels(k,W,V,G,ct.convert(Gt),ct.convert(kt),0);const fe=F!==null?_.get(F).__webglFramebuffer:null;ht.bindFramebuffer(R.FRAMEBUFFER,fe);const ve=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await td(R,ve,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,jt),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,xt),R.deleteBuffer(jt),R.deleteSync(ve),xt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,k=null,W=0){const V=Math.pow(2,-W),G=Math.floor(E.image.width*V),xt=Math.floor(E.image.height*V),Et=k!==null?k.x:0,yt=k!==null?k.y:0;O.setTexture2D(E,0),R.copyTexSubImage2D(R.TEXTURE_2D,W,0,0,Et,yt,G,xt),ht.unbindTexture()};const vu=R.createFramebuffer(),Mu=R.createFramebuffer();this.copyTextureToTexture=function(E,k,W=null,V=null,G=0,xt=null){xt===null&&(G!==0?(Qs("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),xt=G,G=0):xt=0);let Et,yt,Ct,Nt,Gt,kt,jt,fe,ve;const Me=E.isCompressedTexture?E.mipmaps[xt]:E.image;if(W!==null)Et=W.max.x-W.min.x,yt=W.max.y-W.min.y,Ct=W.isBox3?W.max.z-W.min.z:1,Nt=W.min.x,Gt=W.min.y,kt=W.isBox3?W.min.z:0;else{const pn=Math.pow(2,-G);Et=Math.floor(Me.width*pn),yt=Math.floor(Me.height*pn),E.isDataArrayTexture?Ct=Me.depth:E.isData3DTexture?Ct=Math.floor(Me.depth*pn):Ct=1,Nt=0,Gt=0,kt=0}V!==null?(jt=V.x,fe=V.y,ve=V.z):(jt=0,fe=0,ve=0);const pe=ct.convert(k.format),zt=ct.convert(k.type);let he;k.isData3DTexture?(O.setTexture3D(k,0),he=R.TEXTURE_3D):k.isDataArrayTexture||k.isCompressedArrayTexture?(O.setTexture2DArray(k,0),he=R.TEXTURE_2D_ARRAY):(O.setTexture2D(k,0),he=R.TEXTURE_2D),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,k.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,k.unpackAlignment);const re=R.getParameter(R.UNPACK_ROW_LENGTH),on=R.getParameter(R.UNPACK_IMAGE_HEIGHT),Yi=R.getParameter(R.UNPACK_SKIP_PIXELS),ln=R.getParameter(R.UNPACK_SKIP_ROWS),As=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,Me.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Me.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Nt),R.pixelStorei(R.UNPACK_SKIP_ROWS,Gt),R.pixelStorei(R.UNPACK_SKIP_IMAGES,kt);const ge=E.isDataArrayTexture||E.isData3DTexture,en=k.isDataArrayTexture||k.isData3DTexture;if(E.isDepthTexture){const pn=_.get(E),$e=_.get(k),nn=_.get(pn.__renderTarget),_a=_.get($e.__renderTarget);ht.bindFramebuffer(R.READ_FRAMEBUFFER,nn.__webglFramebuffer),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,_a.__webglFramebuffer);for(let Ti=0;Ti<Ct;Ti++)ge&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,_.get(E).__webglTexture,G,kt+Ti),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,_.get(k).__webglTexture,xt,ve+Ti)),R.blitFramebuffer(Nt,Gt,Et,yt,jt,fe,Et,yt,R.DEPTH_BUFFER_BIT,R.NEAREST);ht.bindFramebuffer(R.READ_FRAMEBUFFER,null),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(G!==0||E.isRenderTargetTexture||_.has(E)){const pn=_.get(E),$e=_.get(k);ht.bindFramebuffer(R.READ_FRAMEBUFFER,vu),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,Mu);for(let nn=0;nn<Ct;nn++)ge?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,pn.__webglTexture,G,kt+nn):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,pn.__webglTexture,G),en?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,$e.__webglTexture,xt,ve+nn):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,$e.__webglTexture,xt),G!==0?R.blitFramebuffer(Nt,Gt,Et,yt,jt,fe,Et,yt,R.COLOR_BUFFER_BIT,R.NEAREST):en?R.copyTexSubImage3D(he,xt,jt,fe,ve+nn,Nt,Gt,Et,yt):R.copyTexSubImage2D(he,xt,jt,fe,Nt,Gt,Et,yt);ht.bindFramebuffer(R.READ_FRAMEBUFFER,null),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else en?E.isDataTexture||E.isData3DTexture?R.texSubImage3D(he,xt,jt,fe,ve,Et,yt,Ct,pe,zt,Me.data):k.isCompressedArrayTexture?R.compressedTexSubImage3D(he,xt,jt,fe,ve,Et,yt,Ct,pe,Me.data):R.texSubImage3D(he,xt,jt,fe,ve,Et,yt,Ct,pe,zt,Me):E.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,xt,jt,fe,Et,yt,pe,zt,Me.data):E.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,xt,jt,fe,Me.width,Me.height,pe,Me.data):R.texSubImage2D(R.TEXTURE_2D,xt,jt,fe,Et,yt,pe,zt,Me);R.pixelStorei(R.UNPACK_ROW_LENGTH,re),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,on),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Yi),R.pixelStorei(R.UNPACK_SKIP_ROWS,ln),R.pixelStorei(R.UNPACK_SKIP_IMAGES,As),xt===0&&k.generateMipmaps&&R.generateMipmap(he),ht.unbindTexture()},this.initRenderTarget=function(E){_.get(E).__webglFramebuffer===void 0&&O.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?O.setTextureCube(E,0):E.isData3DTexture?O.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?O.setTexture2DArray(E,0):O.setTexture2D(E,0),ht.unbindTexture()},this.resetState=function(){P=0,I=0,F=null,ht.reset(),wt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return zn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=se._getDrawingBufferColorSpace(t),e.unpackColorSpace=se._getUnpackColorSpace()}}let Pe,In,Ln;function zx(){Cesium.Ion.defaultAccessToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIzMzA1M2Q0MC01YzY1LTRkNDMtYWYzMS05MDdmZmI2MzAwYjYiLCJpZCI6NDA5NTYwLCJpYXQiOjE3NzQ1NDA1MjR9.szCoX8ALGsZ-jqCF6lvDtejplRGt2AJmQjZ2G7_51G0";let i;try{i=Cesium.Terrain.fromWorldTerrain()}catch{console.warn("Cesium World Terrain unavailable, using ellipsoid"),i=void 0}Pe=new Cesium.Viewer("cesiumContainer",{terrain:i,timeline:!1,animation:!1,baseLayerPicker:!1,geocoder:!1,homeButton:!1,infoBox:!1,sceneModePicker:!1,selectionIndicator:!1,navigationHelpButton:!1,fullscreenButton:!1,shouldAnimate:!1}),In=new Cesium.Viewer("minimapCesium",{terrain:null,timeline:!1,animation:!1,baseLayerPicker:!1,geocoder:!1,homeButton:!1,infoBox:!1,sceneModePicker:!1,selectionIndicator:!1,navigationHelpButton:!1,fullscreenButton:!1,shouldAnimate:!1,skyBox:!1,skyAtmosphere:!1,contextOptions:{webgl:{preserveDrawingBuffer:!0}}}),Ln=new Cesium.Viewer("pauseMinimapCesium",{terrain:null,timeline:!1,animation:!1,baseLayerPicker:!1,geocoder:!1,homeButton:!1,infoBox:!1,sceneModePicker:!1,selectionIndicator:!1,navigationHelpButton:!1,fullscreenButton:!1,shouldAnimate:!1,skyBox:!1,skyAtmosphere:!1,contextOptions:{webgl:{preserveDrawingBuffer:!0}}}),[Pe,In,Ln].forEach(t=>{t.scene.requestRenderMode=!1,t.scene.maximumRenderTimeChange=0,t.scene.globe.maximumScreenSpaceError=2,t.resolutionScale=.75,t.scene.screenSpaceCameraController.enableRotate=!1,t.scene.screenSpaceCameraController.enableTranslate=!1,t.scene.screenSpaceCameraController.enableZoom=!1,t.scene.screenSpaceCameraController.enableTilt=!1,t.scene.screenSpaceCameraController.enableLook=!1,t.scene.screenSpaceCameraController.maximumZoomDistance=25e6,t.scene.globe.tileCacheSize=2048,t.scene.globe.preloadAncestors=!0,t.scene.globe.preloadSiblings=!0,t.scene.globe.loadingDescendantLimit=20,t.scene.globe.skipLevelOfDetail=!0,t.scene.globe.baseScreenSpaceError=1024,t.scene.globe.skipScreenSpaceErrorFactor=16,t.scene.globe.skipLevels=1,t._cesiumWidget._creditContainer.style.display="none"}),Pe.scene.globe.baseColor=Cesium.Color.fromCssColorString("#1a3a1a");try{Pe.scene.globe.tileFailed&&Pe.scene.globe.tileFailed.addEventListener(()=>{})}catch{}return[In,Ln].forEach(t=>{t.scene.globe.enableLighting=!1,t.scene.globe.showGroundAtmosphere=!1,t.scene.fog.enabled=!1,t.scene.highDynamicRange=!1,t.scene.postProcessStages.fxaa.enabled=!1,t.resolutionScale=1,t.scene.globe.maximumScreenSpaceError=2,t.scene.globe.baseColor=Cesium.Color.BLACK,t.scene.skyAtmosphere&&(t.scene.skyAtmosphere.show=!1)}),Pe.scene.globe.enableLighting=!0,Pe.scene.highDynamicRange=!1,Pe.scene.postProcessStages.fxaa.enabled=!0,Pe.scene.skyAtmosphere=new Cesium.SkyAtmosphere,Pe.scene.fog.enabled=!0,Pe.scene.fog.density=1e-4,ma(!1),Pe}function Fl(i){!Pe||!In||!Ln||[Pe,In,Ln].forEach(t=>{t.scene.requestRenderMode=!i,t.scene.maximumRenderTimeChange=i?0:1/0})}function ma(i){if(!Pe)return;const t=Pe.scene.screenSpaceCameraController;t.enableRotate=i,t.enableTranslate=i,t.enableZoom=i,t.enableTilt=i,t.enableLook=i}function Hx(i,t,e,n,s,r){Pe&&(Pe.camera.setView({destination:Cesium.Cartesian3.fromDegrees(i,t,e),orientation:{heading:Cesium.Math.toRadians(n),pitch:Cesium.Math.toRadians(s),roll:Cesium.Math.toRadians(r)}}),Pe.scene.requestRender())}function Gx(i,t,e,n){In&&(In.canvas.width===0||In.canvas.height===0||(In.camera.setView({destination:Cesium.Cartesian3.fromDegrees(i,t,e),orientation:{heading:Cesium.Math.toRadians(n),pitch:Cesium.Math.toRadians(-90),roll:0}}),In.scene.requestRender()))}function Vx(i,t,e,n){Ln&&(Ln.canvas.width===0||Ln.canvas.height===0||(Ln.camera.setView({destination:Cesium.Cartesian3.fromDegrees(i,t,e),orientation:{heading:Cesium.Math.toRadians(n),pitch:Cesium.Math.toRadians(-90),roll:0}}),Ln.scene.requestRender()))}function we(){return Pe}function Wx(){return In}function Xx(){return Ln}class jh{constructor(){this.speed=15,this.maxSpeed=50,this.minSpeed=4,this.maxDiveSpeed=120,this.turboSpeed=400,this.mass=5,this.wingArea=.65,this.wingspan=2.1,this.aspectRatio=this.wingspan*this.wingspan/this.wingArea,this.clMax=1.6,this.cd0=.02,this.cdWingSpread=.008,this.k=1/(Math.PI*this.aspectRatio*.85),this.isFlapping=!1,this.flapStrength=0,this.flapCooldown=0,this.flapCycleDuration=.35,this.flapThrustImpulse=25,this.flapLiftImpulse=15,this.flapDecay=3,this.flapInput=!1,this.flapPrevInput=!1,this.gravity=9.8,this.airDensity=1.225,this.isGliding=!0,this.wingSpread=1,this.verticalSpeed=0,this.glideRatio=20,this.thermalLift=0,this.thermalStrength=0,this.thermalTimer=0,this.inThermal=!1,this.pitch=0,this.roll=0,this.heading=0,this.pitchRate=2,this.rollRate=3.2,this.yawRate=1,this.isBoosting=!1,this.boostTimeRemaining=0,this.boostDuration=4,this.boostMultiplier=2.5,this.boostRotations=0,this.boostPressed=!1,this.isTurbo=!1,this.turboPressed=!1,this.turboWindup=0,this.throttle=0,this.quaternion=new qe}boost(){this.boostTimeRemaining<=0&&(this.isBoosting=!0,this.boostTimeRemaining=this.boostDuration)}reset(t,e,n,s,r,a){this.heading=s||0,this.pitch=r||0,this.roll=a||0,this.speed=15,this.verticalSpeed=0,this.thermalLift=0,this.thermalStrength=0,this.isGliding=!0,this.isFlapping=!1,this.flapStrength=0,this.flapCooldown=0,this.wingSpread=1,this.isTurbo=!1,this.turboWindup=0;const o=new Ne(Se.degToRad(this.pitch),Se.degToRad(this.heading),Se.degToRad(this.roll),"YXZ");this.quaternion.setFromEuler(o)}getAirDensity(t){const e=t*.3048;return this.airDensity*Math.exp(-e/8500)}getLiftCoefficient(t){return t<-5?-.2:t<12?this.clMax*(t/12):t<18?this.clMax*(1-(t-12)/12):.1}updateThermals(t,e){this.thermalTimer+=t;const n=Math.max(0,1-(e-2e3)/15e3),s=this.thermalTimer,r=Math.sin(s*.3)*.4+Math.sin(s*.7+1.5)*.3+Math.sin(s*1.2+3)*.3;this.thermalStrength=Math.max(0,r)*n,this.inThermal=this.thermalStrength>.15;const a=Math.abs(this.roll)>15&&Math.abs(this.roll)<45?1.5:1;this.thermalLift=this.thermalStrength*3*a*this.wingSpread}update(t,e){this.boostTimeRemaining>0&&(this.boostTimeRemaining-=e,this.boostTimeRemaining<=0&&(this.isBoosting=!1,this.boostTimeRemaining=0)),t.boost?(!this.boostPressed&&!this.isBoosting&&!this.isTurbo&&this.boost(),this.boostPressed=!0):this.boostPressed=!1,t.turbo?(this.turboPressed||(this.isTurbo=!this.isTurbo,this.isTurbo&&(this.isBoosting=!1,this.boostTimeRemaining=0)),this.turboPressed=!0):this.turboPressed=!1,this.turboWindup=this.isTurbo?Math.min(1,this.turboWindup+e*.7):Math.max(0,this.turboWindup-e*1.5),this.flapInput=t.flap||!1,this.flapInput&&!this.isBoosting&&!this.isTurbo?(this.isFlapping=!0,this.isGliding=!1,this.flapCooldown-=e,this.flapCooldown<=0&&(this.flapStrength=1,this.flapCooldown=this.flapCycleDuration)):this.flapInput||(this.isFlapping=!1,!this.isBoosting&&!this.isTurbo&&(this.isGliding=!0)),this.flapStrength=Math.max(0,this.flapStrength-this.flapDecay*e),this.isTurbo||this.turboWindup>.1?this.wingSpread+=(.15-this.wingSpread)*e*6:this.isBoosting?(this.wingSpread+=(.2-this.wingSpread)*e*5,this.isGliding=!1):this.isGliding?this.wingSpread+=(1-this.wingSpread)*e*3:this.wingSpread=.65+this.flapStrength*.25,this.throttle=this.isFlapping?.3+this.flapStrength*.7:0;const n=this.getAirDensity(0),s=this.speed,r=.5*n*s*s,a=Math.max(-10,Math.min(20,-this.pitch*.3)),o=this.getLiftCoefficient(a)*this.wingSpread,l=r*this.wingArea*o,c=this.k*o*o,h=this.cd0+c+this.wingSpread*this.cdWingSpread;let u=r*this.wingArea*h;this.isBoosting&&(u*=.25),(this.isTurbo||this.turboWindup>.1)&&(u*=.05);let d=0;this.isFlapping&&(d=this.flapThrustImpulse*this.flapStrength);const f=Se.degToRad(this.pitch),g=this.mass*this.gravity*Math.sin(f),m=(d-u+g)/this.mass;this.speed+=m*e;let p=this.isBoosting?this.maxDiveSpeed:this.maxSpeed;if(this.pitch<-20&&!this.isBoosting&&(p+=(this.maxDiveSpeed-this.maxSpeed)*Math.min(1,Math.abs(this.pitch)/60)),(this.isTurbo||this.turboWindup>.01)&&(p=this.turboSpeed),this.speed=Math.max(this.minSpeed,Math.min(p,this.speed)),this.isTurbo||this.turboWindup>.01){const B=this.turboWindup*this.turboWindup*(3-2*this.turboWindup);this.speed+=(this.turboSpeed*B-this.speed)*e*2.5}this.isBoosting&&(this.speed+=(this.maxDiveSpeed*.8-this.speed)*e*3),this.updateThermals(e,0);const w=this.mass*this.gravity,b=this.isFlapping?this.flapLiftImpulse*this.flapStrength:0,M=(l+b-w+this.thermalLift*this.mass)/this.mass;this.verticalSpeed+=(M*.15-this.verticalSpeed)*e*2,this.speed<=this.minSpeed*1.3&&!this.isBoosting&&!this.isTurbo&&(this.pitch=Se.lerp(this.pitch,Math.min(this.pitch,-8),e*.8));const y=Math.min(1.2,this.speed/this.maxSpeed),T=y>.3?.5+y*.5:y/.3*.5,C=t.pitch*this.pitchRate*e*T,L=t.roll*this.rollRate*e*T,v=t.yaw*this.yawRate*e*T,S=new qe().setFromAxisAngle(new D(1,0,0),C),P=new qe().setFromAxisAngle(new D(0,0,1),L),I=new qe().setFromAxisAngle(new D(0,1,0),v);this.quaternion.multiply(I).multiply(S).multiply(P).normalize();const F=new Ne().setFromQuaternion(this.quaternion,"YXZ");return this.heading=Se.radToDeg(F.y),this.pitch=Se.radToDeg(F.x),this.roll=Se.radToDeg(F.z),{speed:this.speed,pitch:this.pitch,roll:this.roll,heading:this.heading,isBoosting:this.isBoosting,boostTimeRemaining:this.boostTimeRemaining,boostDuration:this.boostDuration,boostRotations:this.boostRotations,isGliding:this.isGliding,isFlapping:this.isFlapping,flapStrength:this.flapStrength,wingSpread:this.wingSpread,thermalStrength:this.thermalStrength,inThermal:this.inThermal,verticalSpeed:this.verticalSpeed,flapPhase:this.flapCooldown,liftForce:l,isTurbo:this.isTurbo,turboWindup:this.turboWindup}}}class Yx{constructor(){this.keys={},this.prevKeys={},window.addEventListener("keydown",t=>this.keys[t.key.toLowerCase()]=!0),window.addEventListener("keyup",t=>this.keys[t.key.toLowerCase()]=!1),this.mouseDragging=!1,this.mouseDeltaX=0,this.mouseDeltaY=0,this.lastMouseX=0,this.lastMouseY=0,window.addEventListener("mousedown",t=>{t.button===0&&(this.mouseDragging=!0,this.lastMouseX=t.clientX,this.lastMouseY=t.clientY)}),window.addEventListener("mousemove",t=>{this.mouseDragging&&(this.mouseDeltaX+=t.clientX-this.lastMouseX,this.mouseDeltaY+=t.clientY-this.lastMouseY,this.lastMouseX=t.clientX,this.lastMouseY=t.clientY)}),window.addEventListener("mouseup",t=>{t.button===0&&(this.mouseDragging=!1)}),this.input={throttle:0,pitch:0,roll:0,yaw:0,boost:!1,turbo:!1,flap:!1,cameraYaw:0,cameraPitch:0,isDragging:!1,fire:!1,fireFlare:!1,weaponIndex:-1,toggleWeapon:!1},this.sensitivity=.2,this.isMobile=this.detectMobile(),this.tiltEnabled=!1,this.tiltPitch=0,this.tiltRoll=0,this.tiltCalibration={pitch:0,roll:0},this.tiltSensitivity=1,this.touchThrottle=0,this.touchBoosting=!1,this.touchTurbo=!1,this.touchFlapping=!1,this.touchFiring=!1,this.touchFlare=!1,this.touchWeaponToggle=!1,this.touchPrevWeaponToggle=!1,this.touchCameraDragging=!1,this.touchCameraDeltaX=0,this.touchCameraDeltaY=0,this.lastTouchX=0,this.lastTouchY=0,this.cameraFingerID=null,this.isMobile&&this.initMobileControls()}detectMobile(){return/Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"ontouchstart"in window||navigator.maxTouchPoints>0}async initMobileControls(){this.createTouchUI(),await this.requestOrientationPermission(),window.addEventListener("deviceorientation",s=>{if(!this.tiltEnabled)return;const r=s.beta||0,a=s.gamma||0;this.tiltPitch=r-this.tiltCalibration.pitch,this.tiltRoll=a-this.tiltCalibration.roll},!0);const t=document.getElementById("cesiumContainer"),n=document.getElementById("threeContainer")||t||document.body;n.addEventListener("touchstart",s=>this.handleViewTouchStart(s),{passive:!1}),n.addEventListener("touchmove",s=>this.handleViewTouchMove(s),{passive:!1}),n.addEventListener("touchend",s=>this.handleViewTouchEnd(s),{passive:!1})}async requestOrientationPermission(){if(typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function")try{await DeviceOrientationEvent.requestPermission()==="granted"&&(this.tiltEnabled=!0)}catch(t){console.warn("Device orientation permission denied:",t),this.tiltEnabled=!1}else this.tiltEnabled=!0}calibrateTilt(){this.tiltCalibration.pitch=this.tiltPitch+this.tiltCalibration.pitch,this.tiltCalibration.roll=this.tiltRoll+this.tiltCalibration.roll}createTouchUI(){const t=document.createElement("div");t.id="mobile-controls",t.style.cssText=`
