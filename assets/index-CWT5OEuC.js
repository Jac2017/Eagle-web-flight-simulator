...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function Qh(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:no(),fragmentShader:`
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function tu(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:no(),fragmentShader:`
