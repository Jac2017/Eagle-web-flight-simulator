...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function Qx(r,t,e){const n=new Float32Array(Ji),i=new N(0,1,0);return new Fn({name:"SphericalGaussianBlur",defines:{n:Ji,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:no(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function Qh(){return new Fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:no(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function tu(){return new Fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:no(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		`;const o=(g,p,w,S=52)=>{const y=document.createElement("div");return y.id=g,y.style.cssText=`
