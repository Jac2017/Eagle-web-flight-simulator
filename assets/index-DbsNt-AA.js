...
#endif`,Cp="gl_FragColor = linearToOutputTexel( gl_FragColor );",Ap=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
#define LOW_PRECISION`),t}const ix={[Ha]:"SHADOWMAP_TYPE_PCF",[Vs]:"SHADOWMAP_TYPE_VSM"};function sx(i){return ix[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const ax={[Hi]:"ENVMAP_TYPE_CUBE",[vs]:"ENVMAP_TYPE_CUBE",[hr]:"ENVMAP_TYPE_CUBE_UV"};function rx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":ax[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const ox={[vs]:"ENVMAP_MODE_REFRACTION"};function lx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":ox[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const cx={[cr]:"ENVMAP_BLENDING_MULTIPLY",[qu]:"ENVMAP_BLENDING_MIX",[Zu]:"ENVMAP_BLENDING_ADD"};function hx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":cx[i.combine]||"ENVMAP_BLENDING_NONE"}function ux(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function dx(i,t,e,n){const s=i.getContext(),a=e.defines;let r=e.vertexShader,o=e.fragmentShader;const l=sx(e),c=rx(e),h=lx(e),u=hx(e),d=ux(e),p=$g(e),g=Kg(a),x=s.createProgram();let m,f,w=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+f);const b=w+m+r,y=w+f+o,T=Wc(s,s.VERTEX_SHADER,b),P=Wc(s,s.FRAGMENT_SHADER,y);s.attachShader(x,T),s.attachShader(x,P),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(v){if(i.debug.checkShaderErrors){const R=s.getProgramInfoLog(x)||"",L=s.getShaderInfoLog(T)||"",U=s.getShaderInfoLog(P)||"",N=R.trim(),H=L.trim(),k=U.trim();let q=!0,ot=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,T,P);else{const tt=Yc(s,T,"vertex"),it=Yc(s,P,"fragment");Qt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,Ax=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],Rx=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],th=new jt,ks=new F,to=new F;function Px(i,t,e){let n=new Rl;const s=new ut,a=new ut,r=new Ee,o=new Nf,l=new Uf,c={},h=e.maxTextureSize,u={[wi]:an,[an]:wi,[Le]:Le},d=new Tn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ut},radius:{value:4}},vertexShader:Tx,fragmentShader:Cx}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new rn;g.setAttribute("position",new bn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new nt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ha;let f=this.type;this.render=function(P,C,D){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||P.length===0)return;P.type===Au&&(Ft("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),P.type=Ha);const M=i.getRenderTarget(),S=i.getActiveCubeFace(),v=i.getActiveMipmapLevel(),R=i.state;R.setBlending(ai),R.buffers.depth.getReversed()===!0?R.buffers.color.setClear(0,0,0,0):R.buffers.color.setClear(1,1,1,1),R.buffers.depth.setTest(!0),R.setScissorTest(!1);const L=f!==this.type;L&&C.traverse(function(U){U.material&&(Array.isArray(U.material)?U.material.forEach(N=>N.needsUpdate=!0):U.material.needsUpdate=!0)});for(let U=0,N=P.length;U<N;U++){const H=P[U],k=H.shadow;if(k===void 0){Ft("WebGLShadowMap:",H,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;s.copy(k.mapSize);const q=k.getFrameExtents();if(s.multiply(q),a.copy(k.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/q.x),s.x=a.x*q.x,k.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/q.y),s.y=a.y*q.y,k.mapSize.y=a.y)),k.map===null||L===!0){if(k.map!==null&&(k.map.depthTexture!==null&&(k.map.depthTexture.dispose(),k.map.depthTexture=null),k.map.dispose()),this.type===Vs){if(H.isPointLight){Ft("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}k.map=new Yn(s.x,s.y,{format:Ms,type:li,minFilter:Ge,magFilter:Ge,generateMipmaps:!1}),k.map.texture.name=H.name+".shadowMap",k.map.depthTexture=new ea(s.x,s.y,Nn),k.map.depthTexture.name=H.name+".shadowMapDepth",k.map.depthTexture.format=ci,k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=We,k.map.depthTexture.magFilter=We}else{H.isPointLight?(k.map=new Uh(s.x),k.map.depthTexture=new jd(s.x,qn)):(k.map=new Yn(s.x,s.y),k.map.depthTexture=new ea(s.x,s.y,qn)),k.map.depthTexture.name=H.name+".shadowMap",k.map.depthTexture.format=ci;const tt=i.state.buffers.depth.getReversed();this.type===Ha?(k.map.depthTexture.compareFunction=tt?Tl:El,k.map.depthTexture.minFilter=Ge,k.map.depthTexture.magFilter=Ge):(k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=We,k.map.depthTexture.magFilter=We)}k.camera.updateProjectionMatrix()}const ot=k.map.isWebGLCubeRenderTarget?6:1;for(let tt=0;tt<ot;tt++){if(k.map.isWebGLCubeRenderTarget)i.setRenderTarget(k.map,tt),i.clear();else{tt===0&&(i.setRenderTarget(k.map),i.clear());const it=k.getViewport(tt);r.set(a.x*it.x,a.y*it.y,a.x*it.z,a.y*it.w),R.viewport(r)}if(H.isPointLight){const it=k.camera,Gt=k.matrix,kt=H.distance||it.far;kt!==it.far&&(it.far=kt,it.updateProjectionMatrix()),ks.setFromMatrixPosition(H.matrixWorld),it.position.copy(ks),to.copy(it.position),to.add(Ax[tt]),it.up.copy(Rx[tt]),it.lookAt(to),it.updateMatrixWorld(),Gt.makeTranslation(-ks.x,-ks.y,-ks.z),th.multiplyMatrices(it.projectionMatrix,it.matrixWorldInverse),k._frustum.setFromProjectionMatrix(th,it.coordinateSystem,it.reversedDepth)}else k.updateMatrices(H);n=k.getFrustum(),y(C,D,k.camera,H,this.type)}k.isPointLightShadow!==!0&&this.type===Vs&&w(k,D),k.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(M,S,v)};function w(P,C){const D=t.update(x);d.defines.VSM_SAMPLES!==P.blurSamples&&(d.defines.VSM_SAMPLES=P.blurSamples,p.defines.VSM_SAMPLES=P.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Yn(s.x,s.y,{format:Ms,type:li})),d.uniforms.shadow_pass.value=P.map.depthTexture,d.uniforms.resolution.value=P.mapSize,d.uniforms.radius.value=P.radius,i.setRenderTarget(P.mapPass),i.clear(),i.renderBufferDirect(C,null,D,d,x,null),p.uniforms.shadow_pass.value=P.mapPass.texture,p.uniforms.resolution.value=P.mapSize,p.uniforms.radius.value=P.radius,i.setRenderTarget(P.map),i.clear(),i.renderBufferDirect(C,null,D,p,x,null)}function b(P,C,D,M){let S=null;const v=D.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(v!==void 0)S=v;else if(S=D.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const R=S.uuid,L=C.uuid;let U=c[R];U===void 0&&(U={},c[R]=U);let N=U[L];N===void 0&&(N=S.clone(),U[L]=N,C.addEventListener("dispose",T)),S=N}if(S.visible=C.visible,S.wireframe=C.wireframe,M===Vs?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:u[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,D.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const R=i.properties.get(S);R.light=D}return S}function y(P,C,D,M,S){if(P.visible===!1)return;if(P.layers.test(C.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&S===Vs)&&(!P.frustumCulled||n.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,P.matrixWorld);const L=t.update(P),U=P.material;if(Array.isArray(U)){const N=L.groups;for(let H=0,k=N.length;H<k;H++){const q=N[H],ot=U[q.materialIndex];if(ot&&ot.visible){const tt=b(P,ot,M,S);P.onBeforeShadow(i,P,C,D,L,tt,q),i.renderBufferDirect(D,null,L,tt,P,q),P.onAfterShadow(i,P,C,D,L,tt,q)}}}else if(U.visible){const N=b(P,U,M,S);P.onBeforeShadow(i,P,C,D,L,N,null),i.renderBufferDirect(D,null,L,N,P,null),P.onAfterShadow(i,P,C,D,L,N,null)}}const R=P.children;for(let L=0,U=R.length;L<U;L++)y(R[L],C,D,M,S)}function T(P){P.target.removeEventListener("dispose",T);for(const D in c){const M=c[D],S=P.target.uuid;S in M&&(M[S].dispose(),delete M[S])}}}const Ix={[ho]:uo,[fo]:go,[po]:xo,[_s]:mo,[uo]:ho,[go]:fo,[xo]:po,[mo]:_s};function Lx(i,t){function e(){let O=!1;const Mt=new Ee;let ct=null;const wt=new Ee(0,0,0,0);return{setMask:function(lt){ct!==lt&&!O&&(i.colorMask(lt,lt,lt,lt),ct=lt)},setLocked:function(lt){O=lt},setClear:function(lt,Q,ft,Xt,ge){ge===!0&&(lt*=Xt,Q*=Xt,ft*=Xt),Mt.set(lt,Q,ft,Xt),wt.equals(Mt)===!1&&(i.clearColor(lt,Q,ft,Xt),wt.copy(Mt))},reset:function(){O=!1,ct=null,wt.set(-1,0,0,0)}}}function n(){let O=!1,Mt=!1,ct=null,wt=null,lt=null;return{setReversed:function(Q){if(Mt!==Q){const ft=t.get("EXT_clip_control");Q?ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.ZERO_TO_ONE_EXT):ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.NEGATIVE_ONE_TO_ONE_EXT),Mt=Q;const Xt=lt;lt=null,this.setClear(Xt)}},getReversed:function(){return Mt},setTest:function(Q){Q?et(i.DEPTH_TEST):yt(i.DEPTH_TEST)},setMask:function(Q){ct!==Q&&!O&&(i.depthMask(Q),ct=Q)},setFunc:function(Q){if(Mt&&(Q=Ix[Q]),wt!==Q){switch(Q){case ho:i.depthFunc(i.NEVER);break;case uo:i.depthFunc(i.ALWAYS);break;case fo:i.depthFunc(i.LESS);break;case _s:i.depthFunc(i.LEQUAL);break;case po:i.depthFunc(i.EQUAL);break;case mo:i.depthFunc(i.GEQUAL);break;case go:i.depthFunc(i.GREATER);break;case xo:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}wt=Q}},setLocked:function(Q){O=Q},setClear:function(Q){lt!==Q&&(Mt&&(Q=1-Q),i.clearDepth(Q),lt=Q)},reset:function(){O=!1,ct=null,wt=null,lt=null,Mt=!1}}}function s(){let O=!1,Mt=null,ct=null,wt=null,lt=null,Q=null,ft=null,Xt=null,ge=null;return{setTest:function(he){O||(he?et(i.STENCIL_TEST):yt(i.STENCIL_TEST))},setMask:function(he){Mt!==he&&!O&&(i.stencilMask(he),Mt=he)},setFunc:function(he,On,$n){(ct!==he||wt!==On||lt!==$n)&&(i.stencilFunc(he,On,$n),ct=he,wt=On,lt=$n)},setOp:function(he,On,$n){(Q!==he||ft!==On||Xt!==$n)&&(i.stencilOp(he,On,$n),Q=he,ft=On,Xt=$n)},setLocked:function(he){O=he},setClear:function(he){ge!==he&&(i.clearStencil(he),ge=he)},reset:function(){O=!1,Mt=null,ct=null,wt=null,lt=null,Q=null,ft=null,Xt=null,ge=null}}}const a=new e,r=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,p=[],g=null,x=!1,m=null,f=null,w=null,b=null,y=null,T=null,P=null,C=new Ut(0,0,0),D=0,M=!1,S=null,v=null,R=null,L=null,U=null;const N=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,k=0;const q=i.getParameter(i.VERSION);q.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(q)[1]),H=k>=1):q.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),H=k>=2);let ot=null,tt={};const it=i.getParameter(i.SCISSOR_BOX),Gt=i.getParameter(i.VIEWPORT),kt=new Ee().fromArray(it),ae=new Ee().fromArray(Gt);function ee(O,Mt,ct,wt){const lt=new Uint8Array(4),Q=i.createTexture();i.bindTexture(O,Q),i.texParameteri(O,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(O,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ft=0;ft<ct;ft++)O===i.TEXTURE_3D||O===i.TEXTURE_2D_ARRAY?i.texImage3D(Mt,0,i.RGBA,1,1,wt,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(Mt+ft,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return Q}const Z={};Z[i.TEXTURE_2D]=ee(i.TEXTURE_2D,i.TEXTURE_2D,1),Z[i.TEXTURE_CUBE_MAP]=ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[i.TEXTURE_2D_ARRAY]=ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Z[i.TEXTURE_3D]=ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),et(i.DEPTH_TEST),r.setFunc(_s),J(!1),at(Zl),et(i.CULL_FACE),$(ai);function et(O){h[O]!==!0&&(i.enable(O),h[O]=!0)}function yt(O){h[O]!==!1&&(i.disable(O),h[O]=!1)}function Nt(O,Mt){return u[O]!==Mt?(i.bindFramebuffer(O,Mt),u[O]=Mt,O===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=Mt),O===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=Mt),!0):!1}function St(O,Mt){let ct=p,wt=!1;if(O){ct=d.get(Mt),ct===void 0&&(ct=[],d.set(Mt,ct));const lt=O.textures;if(ct.length!==lt.length||ct[0]!==i.COLOR_ATTACHMENT0){for(let Q=0,ft=lt.length;Q<ft;Q++)ct[Q]=i.COLOR_ATTACHMENT0+Q;ct.length=lt.length,wt=!0}}else ct[0]!==i.BACK&&(ct[0]=i.BACK,wt=!0);wt&&i.drawBuffers(ct)}function Jt(O){return g!==O?(i.useProgram(O),g=O,!0):!1}const re={[Oi]:i.FUNC_ADD,[Pu]:i.FUNC_SUBTRACT,[Iu]:i.FUNC_REVERSE_SUBTRACT};re[Lu]=i.MIN,re[Du]=i.MAX;const Wt={[Fu]:i.ZERO,[Nu]:i.ONE,[Uu]:i.SRC_COLOR,[lo]:i.SRC_ALPHA,[Gu]:i.SRC_ALPHA_SATURATE,[zu]:i.DST_COLOR,[Bu]:i.DST_ALPHA,[Ou]:i.ONE_MINUS_SRC_COLOR,[co]:i.ONE_MINUS_SRC_ALPHA,[Hu]:i.ONE_MINUS_DST_COLOR,[ku]:i.ONE_MINUS_DST_ALPHA,[Vu]:i.CONSTANT_COLOR,[Wu]:i.ONE_MINUS_CONSTANT_COLOR,[Xu]:i.CONSTANT_ALPHA,[Yu]:i.ONE_MINUS_CONSTANT_ALPHA};function $(O,Mt,ct,wt,lt,Q,ft,Xt,ge,he){if(O===ai){x===!0&&(yt(i.BLEND),x=!1);return}if(x===!1&&(et(i.BLEND),x=!0),O!==Ru){if(O!==m||he!==M){if((f!==Oi||y!==Oi)&&(i.blendEquation(i.FUNC_ADD),f=Oi,y=Oi),he)switch(O){case gs:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wn:i.blendFunc(i.ONE,i.ONE);break;case $l:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Kl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Qt("WebGLState: Invalid blending: ",O);break}else switch(O){case gs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case $l:Qt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Kl:Qt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qt("WebGLState: Invalid blending: ",O);break}w=null,b=null,T=null,P=null,C.set(0,0,0),D=0,m=O,M=he}return}lt=lt||Mt,Q=Q||ct,ft=ft||wt,(Mt!==f||lt!==y)&&(i.blendEquationSeparate(re[Mt],re[lt]),f=Mt,y=lt),(ct!==w||wt!==b||Q!==T||ft!==P)&&(i.blendFuncSeparate(Wt[ct],Wt[wt],Wt[Q],Wt[ft]),w=ct,b=wt,T=Q,P=ft),(Xt.equals(C)===!1||ge!==D)&&(i.blendColor(Xt.r,Xt.g,Xt.b,ge),C.copy(Xt),D=ge),m=O,M=!1}function st(O,Mt){O.side===Le?yt(i.CULL_FACE):et(i.CULL_FACE);let ct=O.side===an;Mt&&(ct=!ct),J(ct),O.blending===gs&&O.transparent===!1?$(ai):$(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),r.setFunc(O.depthFunc),r.setTest(O.depthTest),r.setMask(O.depthWrite),a.setMask(O.colorWrite);const wt=O.stencilWrite;o.setTest(wt),wt&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),bt(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?et(i.SAMPLE_ALPHA_TO_COVERAGE):yt(i.SAMPLE_ALPHA_TO_COVERAGE)}function J(O){S!==O&&(O?i.frontFace(i.CW):i.frontFace(i.CCW),S=O)}function at(O){O!==Tu?(et(i.CULL_FACE),O!==v&&(O===Zl?i.cullFace(i.BACK):O===Cu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):yt(i.CULL_FACE),v=O}function I(O){O!==R&&(H&&i.lineWidth(O),R=O)}function bt(O,Mt,ct){O?(et(i.POLYGON_OFFSET_FILL),(L!==Mt||U!==ct)&&(i.polygonOffset(Mt,ct),L=Mt,U=ct)):yt(i.POLYGON_OFFSET_FILL)}function xt(O){O?et(i.SCISSOR_TEST):yt(i.SCISSOR_TEST)}function Dt(O){O===void 0&&(O=i.TEXTURE0+N-1),ot!==O&&(i.activeTexture(O),ot=O)}function ht(O,Mt,ct){ct===void 0&&(ot===null?ct=i.TEXTURE0+N-1:ct=ot);let wt=tt[ct];wt===void 0&&(wt={type:void 0,texture:void 0},tt[ct]=wt),(wt.type!==O||wt.texture!==Mt)&&(ot!==ct&&(i.activeTexture(ct),ot=ct),i.bindTexture(O,Mt||Z[O]),wt.type=O,wt.texture=Mt)}function A(){const O=tt[ot];O!==void 0&&O.type!==void 0&&(i.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(O){Qt("WebGLState:",O)}}function B(){try{i.compressedTexImage3D(...arguments)}catch(O){Qt("WebGLState:",O)}}function X(){try{i.texSubImage2D(...arguments)}catch(O){Qt("WebGLState:",O)}}function j(){try{i.texSubImage3D(...arguments)}catch(O){Qt("WebGLState:",O)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(O){Qt("WebGLState:",O)}}function Pt(){try{i.compressedTexSubImage3D(...arguments)}catch(O){Qt("WebGLState:",O)}}function dt(){try{i.texStorage2D(...arguments)}catch(O){Qt("WebGLState:",O)}}function At(){try{i.texStorage3D(...arguments)}catch(O){Qt("WebGLState:",O)}}function zt(){try{i.texImage2D(...arguments)}catch(O){Qt("WebGLState:",O)}}function rt(){try{i.texImage3D(...arguments)}catch(O){Qt("WebGLState:",O)}}function mt(O){kt.equals(O)===!1&&(i.scissor(O.x,O.y,O.z,O.w),kt.copy(O))}function Rt(O){ae.equals(O)===!1&&(i.viewport(O.x,O.y,O.z,O.w),ae.copy(O))}function It(O,Mt){let ct=c.get(Mt);ct===void 0&&(ct=new WeakMap,c.set(Mt,ct));let wt=ct.get(O);wt===void 0&&(wt=i.getUniformBlockIndex(Mt,O.name),ct.set(O,wt))}function pt(O,Mt){const wt=c.get(Mt).get(O);l.get(Mt)!==wt&&(i.uniformBlockBinding(Mt,wt,O.__bindingPointIndex),l.set(Mt,wt))}function Zt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),r.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},ot=null,tt={},u={},d=new WeakMap,p=[],g=null,x=!1,m=null,f=null,w=null,b=null,y=null,T=null,P=null,C=new Ut(0,0,0),D=0,M=!1,S=null,v=null,R=null,L=null,U=null,kt.set(0,0,i.canvas.width,i.canvas.height),ae.set(0,0,i.canvas.width,i.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:et,disable:yt,bindFramebuffer:Nt,drawBuffers:St,useProgram:Jt,setBlending:$,setMaterial:st,setFlipSided:J,setCullFace:at,setLineWidth:I,setPolygonOffset:bt,setScissorTest:xt,activeTexture:Dt,bindTexture:ht,unbindTexture:A,compressedTexImage2D:_,compressedTexImage3D:B,texImage2D:zt,texImage3D:rt,updateUBOMapping:It,uniformBlockBinding:pt,texStorage2D:dt,texStorage3D:At,texSubImage2D:X,texSubImage3D:j,compressedTexSubImage2D:Y,compressedTexSubImage3D:Pt,scissor:mt,viewport:Rt,reset:Zt}}function Dx(i,t,e,n,s,a,r){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ut,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,_){return p?new OffscreenCanvas(A,_):Ja("canvas")}function x(A,_,B){let X=1;const j=ht(A);if((j.width>B||j.height>B)&&(X=B/Math.max(j.width,j.height)),X<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const Y=Math.floor(X*j.width),Pt=Math.floor(X*j.height);u===void 0&&(u=g(Y,Pt));const dt=_?g(Y,Pt):u;return dt.width=Y,dt.height=Pt,dt.getContext("2d").drawImage(A,0,0,Y,Pt),Ft("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+Y+"x"+Pt+")."),dt}else return"data"in A&&Ft("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),A;return A}function m(A){return A.generateMipmaps}function f(A){i.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(A,_,B,X,j=!1){if(A!==null){if(i[A]!==void 0)return i[A];Ft("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let Y=_;if(_===i.RED&&(B===i.FLOAT&&(Y=i.R32F),B===i.HALF_FLOAT&&(Y=i.R16F),B===i.UNSIGNED_BYTE&&(Y=i.R8)),_===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.R8UI),B===i.UNSIGNED_SHORT&&(Y=i.R16UI),B===i.UNSIGNED_INT&&(Y=i.R32UI),B===i.BYTE&&(Y=i.R8I),B===i.SHORT&&(Y=i.R16I),B===i.INT&&(Y=i.R32I)),_===i.RG&&(B===i.FLOAT&&(Y=i.RG32F),B===i.HALF_FLOAT&&(Y=i.RG16F),B===i.UNSIGNED_BYTE&&(Y=i.RG8)),_===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.RG8UI),B===i.UNSIGNED_SHORT&&(Y=i.RG16UI),B===i.UNSIGNED_INT&&(Y=i.RG32UI),B===i.BYTE&&(Y=i.RG8I),B===i.SHORT&&(Y=i.RG16I),B===i.INT&&(Y=i.RG32I)),_===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),B===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),B===i.UNSIGNED_INT&&(Y=i.RGB32UI),B===i.BYTE&&(Y=i.RGB8I),B===i.SHORT&&(Y=i.RGB16I),B===i.INT&&(Y=i.RGB32I)),_===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),B===i.UNSIGNED_INT&&(Y=i.RGBA32UI),B===i.BYTE&&(Y=i.RGBA8I),B===i.SHORT&&(Y=i.RGBA16I),B===i.INT&&(Y=i.RGBA32I)),_===i.RGB&&(B===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),B===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),_===i.RGBA){const Pt=j?$a:te.getTransfer(X);B===i.FLOAT&&(Y=i.RGBA32F),B===i.HALF_FLOAT&&(Y=i.RGBA16F),B===i.UNSIGNED_BYTE&&(Y=Pt===de?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function y(A,_){let B;return A?_===null||_===qn||_===js?B=i.DEPTH24_STENCIL8:_===Nn?B=i.DEPTH32F_STENCIL8:_===Js&&(B=i.DEPTH24_STENCIL8,Ft("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===qn||_===js?B=i.DEPTH_COMPONENT24:_===Nn?B=i.DEPTH_COMPONENT32F:_===Js&&(B=i.DEPTH_COMPONENT16),B}function T(A,_){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==We&&A.minFilter!==Ge?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function P(A){const _=A.target;_.removeEventListener("dispose",P),D(_),_.isVideoTexture&&h.delete(_)}function C(A){const _=A.target;_.removeEventListener("dispose",C),S(_)}function D(A){const _=n.get(A);if(_.__webglInit===void 0)return;const B=A.source,X=d.get(B);if(X){const j=X[_.__cacheKey];j.usedTimes--,j.usedTimes===0&&M(A),Object.keys(X).length===0&&d.delete(B)}n.remove(A)}function M(A){const _=n.get(A);i.deleteTexture(_.__webglTexture);const B=A.source,X=d.get(B);delete X[_.__cacheKey],r.memory.textures--}function S(A){const _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(_.__webglFramebuffer[X]))for(let j=0;j<_.__webglFramebuffer[X].length;j++)i.deleteFramebuffer(_.__webglFramebuffer[X][j]);else i.deleteFramebuffer(_.__webglFramebuffer[X]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[X])}else{if(Array.isArray(_.__webglFramebuffer))for(let X=0;X<_.__webglFramebuffer.length;X++)i.deleteFramebuffer(_.__webglFramebuffer[X]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let X=0;X<_.__webglColorRenderbuffer.length;X++)_.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[X]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const B=A.textures;for(let X=0,j=B.length;X<j;X++){const Y=n.get(B[X]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),r.memory.textures--),n.remove(B[X])}n.remove(A)}let v=0;function R(){v=0}function L(){const A=v;return A>=s.maxTextures&&Ft("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),v+=1,A}function U(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function N(A,_){const B=n.get(A);if(A.isVideoTexture&&xt(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&B.__version!==A.version){const X=A.image;if(X===null)Ft("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ft("WebGLRenderer: Texture marked for update but image is incomplete");else{Z(B,A,_);return}}else A.isExternalTexture&&(B.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+_)}function H(A,_){const B=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&B.__version!==A.version){Z(B,A,_);return}else A.isExternalTexture&&(B.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+_)}function k(A,_){const B=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&B.__version!==A.version){Z(B,A,_);return}e.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+_)}function q(A,_){const B=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&B.__version!==A.version){et(B,A,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+_)}const ot={[Mo]:i.REPEAT,[ni]:i.CLAMP_TO_EDGE,[yo]:i.MIRRORED_REPEAT},tt={[We]:i.NEAREST,[$u]:i.NEAREST_MIPMAP_NEAREST,[ha]:i.NEAREST_MIPMAP_LINEAR,[Ge]:i.LINEAR,[vr]:i.LINEAR_MIPMAP_NEAREST,[ki]:i.LINEAR_MIPMAP_LINEAR},it={[ju]:i.NEVER,[id]:i.ALWAYS,[Qu]:i.LESS,[El]:i.LEQUAL,[td]:i.EQUAL,[Tl]:i.GEQUAL,[ed]:i.GREATER,[nd]:i.NOTEQUAL};function Gt(A,_){if(_.type===Nn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ge||_.magFilter===vr||_.magFilter===ha||_.magFilter===ki||_.minFilter===Ge||_.minFilter===vr||_.minFilter===ha||_.minFilter===ki)&&Ft("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,ot[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,ot[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,ot[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,tt[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,tt[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,it[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===We||_.minFilter!==ha&&_.minFilter!==ki||_.type===Nn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function kt(A,_){let B=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",P));const X=_.source;let j=d.get(X);j===void 0&&(j={},d.set(X,j));const Y=U(_);if(Y!==A.__cacheKey){j[Y]===void 0&&(j[Y]={texture:i.createTexture(),usedTimes:0},r.memory.textures++,B=!0),j[Y].usedTimes++;const Pt=j[A.__cacheKey];Pt!==void 0&&(j[A.__cacheKey].usedTimes--,Pt.usedTimes===0&&M(_)),A.__cacheKey=Y,A.__webglTexture=j[Y].texture}return B}function ae(A,_,B){return Math.floor(Math.floor(A/B)/_)}function ee(A,_,B,X){const Y=A.updateRanges;if(Y.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,B,X,_.data);else{Y.sort((rt,mt)=>rt.start-mt.start);let Pt=0;for(let rt=1;rt<Y.length;rt++){const mt=Y[Pt],Rt=Y[rt],It=mt.start+mt.count,pt=ae(Rt.start,_.width,4),Zt=ae(mt.start,_.width,4);Rt.start<=It+1&&pt===Zt&&ae(Rt.start+Rt.count-1,_.width,4)===pt?mt.count=Math.max(mt.count,Rt.start+Rt.count-mt.start):(++Pt,Y[Pt]=Rt)}Y.length=Pt+1;const dt=i.getParameter(i.UNPACK_ROW_LENGTH),At=i.getParameter(i.UNPACK_SKIP_PIXELS),zt=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let rt=0,mt=Y.length;rt<mt;rt++){const Rt=Y[rt],It=Math.floor(Rt.start/4),pt=Math.ceil(Rt.count/4),Zt=It%_.width,O=Math.floor(It/_.width),Mt=pt,ct=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Zt),i.pixelStorei(i.UNPACK_SKIP_ROWS,O),e.texSubImage2D(i.TEXTURE_2D,0,Zt,O,Mt,ct,B,X,_.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,dt),i.pixelStorei(i.UNPACK_SKIP_PIXELS,At),i.pixelStorei(i.UNPACK_SKIP_ROWS,zt)}}function Z(A,_,B){let X=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(X=i.TEXTURE_3D);const j=kt(A,_),Y=_.source;e.bindTexture(X,A.__webglTexture,i.TEXTURE0+B);const Pt=n.get(Y);if(Y.version!==Pt.__version||j===!0){e.activeTexture(i.TEXTURE0+B);const dt=te.getPrimaries(te.workingColorSpace),At=_.colorSpace===vi?null:te.getPrimaries(_.colorSpace),zt=_.colorSpace===vi||dt===At?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,zt);let rt=x(_.image,!1,s.maxTextureSize);rt=Dt(_,rt);const mt=a.convert(_.format,_.colorSpace),Rt=a.convert(_.type);let It=b(_.internalFormat,mt,Rt,_.colorSpace,_.isVideoTexture);Gt(X,_);let pt;const Zt=_.mipmaps,O=_.isVideoTexture!==!0,Mt=Pt.__version===void 0||j===!0,ct=Y.dataReady,wt=T(_,rt);if(_.isDepthTexture)It=y(_.format===zi,_.type),Mt&&(O?e.texStorage2D(i.TEXTURE_2D,1,It,rt.width,rt.height):e.texImage2D(i.TEXTURE_2D,0,It,rt.width,rt.height,0,mt,Rt,null));else if(_.isDataTexture)if(Zt.length>0){O&&Mt&&e.texStorage2D(i.TEXTURE_2D,wt,It,Zt[0].width,Zt[0].height);for(let lt=0,Q=Zt.length;lt<Q;lt++)pt=Zt[lt],O?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,Rt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,It,pt.width,pt.height,0,mt,Rt,pt.data);_.generateMipmaps=!1}else O?(Mt&&e.texStorage2D(i.TEXTURE_2D,wt,It,rt.width,rt.height),ct&&ee(_,rt,mt,Rt)):e.texImage2D(i.TEXTURE_2D,0,It,rt.width,rt.height,0,mt,Rt,rt.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){O&&Mt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,It,Zt[0].width,Zt[0].height,rt.depth);for(let lt=0,Q=Zt.length;lt<Q;lt++)if(pt=Zt[lt],_.format!==Un)if(mt!==null)if(O){if(ct)if(_.layerUpdates.size>0){const ft=Ic(pt.width,pt.height,_.format,_.type);for(const Xt of _.layerUpdates){const ge=pt.data.subarray(Xt*ft/pt.data.BYTES_PER_ELEMENT,(Xt+1)*ft/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,Xt,pt.width,pt.height,1,mt,ge)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,rt.depth,mt,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,lt,It,pt.width,pt.height,rt.depth,0,pt.data,0,0);else Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else O?ct&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,rt.depth,mt,Rt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,lt,It,pt.width,pt.height,rt.depth,0,mt,Rt,pt.data)}else{O&&Mt&&e.texStorage2D(i.TEXTURE_2D,wt,It,Zt[0].width,Zt[0].height);for(let lt=0,Q=Zt.length;lt<Q;lt++)pt=Zt[lt],_.format!==Un?mt!==null?O?ct&&e.compressedTexSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,lt,It,pt.width,pt.height,0,pt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):O?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,Rt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,It,pt.width,pt.height,0,mt,Rt,pt.data)}else if(_.isDataArrayTexture)if(O){if(Mt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,It,rt.width,rt.height,rt.depth),ct)if(_.layerUpdates.size>0){const lt=Ic(rt.width,rt.height,_.format,_.type);for(const Q of _.layerUpdates){const ft=rt.data.subarray(Q*lt/rt.data.BYTES_PER_ELEMENT,(Q+1)*lt/rt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,rt.width,rt.height,1,mt,Rt,ft)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,mt,Rt,rt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,It,rt.width,rt.height,rt.depth,0,mt,Rt,rt.data);else if(_.isData3DTexture)O?(Mt&&e.texStorage3D(i.TEXTURE_3D,wt,It,rt.width,rt.height,rt.depth),ct&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,mt,Rt,rt.data)):e.texImage3D(i.TEXTURE_3D,0,It,rt.width,rt.height,rt.depth,0,mt,Rt,rt.data);else if(_.isFramebufferTexture){if(Mt)if(O)e.texStorage2D(i.TEXTURE_2D,wt,It,rt.width,rt.height);else{let lt=rt.width,Q=rt.height;for(let ft=0;ft<wt;ft++)e.texImage2D(i.TEXTURE_2D,ft,It,lt,Q,0,mt,Rt,null),lt>>=1,Q>>=1}}else if(Zt.length>0){if(O&&Mt){const lt=ht(Zt[0]);e.texStorage2D(i.TEXTURE_2D,wt,It,lt.width,lt.height)}for(let lt=0,Q=Zt.length;lt<Q;lt++)pt=Zt[lt],O?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,mt,Rt,pt):e.texImage2D(i.TEXTURE_2D,lt,It,mt,Rt,pt);_.generateMipmaps=!1}else if(O){if(Mt){const lt=ht(rt);e.texStorage2D(i.TEXTURE_2D,wt,It,lt.width,lt.height)}ct&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,mt,Rt,rt)}else e.texImage2D(i.TEXTURE_2D,0,It,mt,Rt,rt);m(_)&&f(X),Pt.__version=Y.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function et(A,_,B){if(_.image.length!==6)return;const X=kt(A,_),j=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+B);const Y=n.get(j);if(j.version!==Y.__version||X===!0){e.activeTexture(i.TEXTURE0+B);const Pt=te.getPrimaries(te.workingColorSpace),dt=_.colorSpace===vi?null:te.getPrimaries(_.colorSpace),At=_.colorSpace===vi||Pt===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,At);const zt=_.isCompressedTexture||_.image[0].isCompressedTexture,rt=_.image[0]&&_.image[0].isDataTexture,mt=[];for(let Q=0;Q<6;Q++)!zt&&!rt?mt[Q]=x(_.image[Q],!0,s.maxCubemapSize):mt[Q]=rt?_.image[Q].image:_.image[Q],mt[Q]=Dt(_,mt[Q]);const Rt=mt[0],It=a.convert(_.format,_.colorSpace),pt=a.convert(_.type),Zt=b(_.internalFormat,It,pt,_.colorSpace),O=_.isVideoTexture!==!0,Mt=Y.__version===void 0||X===!0,ct=j.dataReady;let wt=T(_,Rt);Gt(i.TEXTURE_CUBE_MAP,_);let lt;if(zt){O&&Mt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Zt,Rt.width,Rt.height);for(let Q=0;Q<6;Q++){lt=mt[Q].mipmaps;for(let ft=0;ft<lt.length;ft++){const Xt=lt[ft];_.format!==Un?It!==null?O?ct&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,0,0,Xt.width,Xt.height,It,Xt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,Zt,Xt.width,Xt.height,0,Xt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,0,0,Xt.width,Xt.height,It,pt,Xt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft,Zt,Xt.width,Xt.height,0,It,pt,Xt.data)}}}else{if(lt=_.mipmaps,O&&Mt){lt.length>0&&wt++;const Q=ht(mt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Zt,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(rt){O?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,mt[Q].width,mt[Q].height,It,pt,mt[Q].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Zt,mt[Q].width,mt[Q].height,0,It,pt,mt[Q].data);for(let ft=0;ft<lt.length;ft++){const ge=lt[ft].image[Q].image;O?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,0,0,ge.width,ge.height,It,pt,ge.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,Zt,ge.width,ge.height,0,It,pt,ge.data)}}else{O?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,It,pt,mt[Q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Zt,It,pt,mt[Q]);for(let ft=0;ft<lt.length;ft++){const Xt=lt[ft];O?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,0,0,It,pt,Xt.image[Q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ft+1,Zt,It,pt,Xt.image[Q])}}}m(_)&&f(i.TEXTURE_CUBE_MAP),Y.__version=j.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function yt(A,_,B,X,j,Y){const Pt=a.convert(B.format,B.colorSpace),dt=a.convert(B.type),At=b(B.internalFormat,Pt,dt,B.colorSpace),zt=n.get(_),rt=n.get(B);if(rt.__renderTarget=_,!zt.__hasExternalTextures){const mt=Math.max(1,_.width>>Y),Rt=Math.max(1,_.height>>Y);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?e.texImage3D(j,Y,At,mt,Rt,_.depth,0,Pt,dt,null):e.texImage2D(j,Y,At,mt,Rt,0,Pt,dt,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,j,rt.__webglTexture,0,I(_)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,j,rt.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Nt(A,_,B){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer){const X=_.depthTexture,j=X&&X.isDepthTexture?X.type:null,Y=y(_.stencilBuffer,j),Pt=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),Y,_.width,_.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),Y,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Y,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Pt,i.RENDERBUFFER,A)}else{const X=_.textures;for(let j=0;j<X.length;j++){const Y=X[j],Pt=a.convert(Y.format,Y.colorSpace),dt=a.convert(Y.type),At=b(Y.internalFormat,Pt,dt,Y.colorSpace);bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),At,_.width,_.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),At,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,At,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function St(A,_,B){const X=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(_.depthTexture);if(j.__renderTarget=_,(!j.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),X){if(j.__webglInit===void 0&&(j.__webglInit=!0,_.depthTexture.addEventListener("dispose",P)),j.__webglTexture===void 0){j.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),Gt(i.TEXTURE_CUBE_MAP,_.depthTexture);const zt=a.convert(_.depthTexture.format),rt=a.convert(_.depthTexture.type);let mt;_.depthTexture.format===ci?mt=i.DEPTH_COMPONENT24:_.depthTexture.format===zi&&(mt=i.DEPTH24_STENCIL8);for(let Rt=0;Rt<6;Rt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0,mt,_.width,_.height,0,zt,rt,null)}}else N(_.depthTexture,0);const Y=j.__webglTexture,Pt=I(_),dt=X?i.TEXTURE_CUBE_MAP_POSITIVE_X+B:i.TEXTURE_2D,At=_.depthTexture.format===zi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===ci)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,At,dt,Y,0,Pt):i.framebufferTexture2D(i.FRAMEBUFFER,At,dt,Y,0);else if(_.depthTexture.format===zi)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,At,dt,Y,0,Pt):i.framebufferTexture2D(i.FRAMEBUFFER,At,dt,Y,0);else throw new Error("Unknown depthTexture format")}function Jt(A){const _=n.get(A),B=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){const X=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),X){const j=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,X.removeEventListener("dispose",j)};X.addEventListener("dispose",j),_.__depthDisposeCallback=j}_.__boundDepthTexture=X}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(B)for(let X=0;X<6;X++)St(_.__webglFramebuffer[X],A,X);else{const X=A.texture.mipmaps;X&&X.length>0?St(_.__webglFramebuffer[0],A,0):St(_.__webglFramebuffer,A,0)}else if(B){_.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[X]),_.__webglDepthbuffer[X]===void 0)_.__webglDepthbuffer[X]=i.createRenderbuffer(),Nt(_.__webglDepthbuffer[X],A,!1);else{const j=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,Y)}}else{const X=A.texture.mipmaps;if(X&&X.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Nt(_.__webglDepthbuffer,A,!1);else{const j=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,Y)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function re(A,_,B){const X=n.get(A);_!==void 0&&yt(X.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&Jt(A)}function Wt(A){const _=A.texture,B=n.get(A),X=n.get(_);A.addEventListener("dispose",C);const j=A.textures,Y=A.isWebGLCubeRenderTarget===!0,Pt=j.length>1;if(Pt||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=_.version,r.memory.textures++),Y){B.__webglFramebuffer=[];for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer[dt]=[];for(let At=0;At<_.mipmaps.length;At++)B.__webglFramebuffer[dt][At]=i.createFramebuffer()}else B.__webglFramebuffer[dt]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer=[];for(let dt=0;dt<_.mipmaps.length;dt++)B.__webglFramebuffer[dt]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(Pt)for(let dt=0,At=j.length;dt<At;dt++){const zt=n.get(j[dt]);zt.__webglTexture===void 0&&(zt.__webglTexture=i.createTexture(),r.memory.textures++)}if(A.samples>0&&bt(A)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let dt=0;dt<j.length;dt++){const At=j[dt];B.__webglColorRenderbuffer[dt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[dt]);const zt=a.convert(At.format,At.colorSpace),rt=a.convert(At.type),mt=b(At.internalFormat,zt,rt,At.colorSpace,A.isXRRenderTarget===!0),Rt=I(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Rt,mt,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,B.__webglColorRenderbuffer[dt])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),Nt(B.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Gt(i.TEXTURE_CUBE_MAP,_);for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0)for(let At=0;At<_.mipmaps.length;At++)yt(B.__webglFramebuffer[dt][At],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,At);else yt(B.__webglFramebuffer[dt],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0);m(_)&&f(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Pt){for(let dt=0,At=j.length;dt<At;dt++){const zt=j[dt],rt=n.get(zt);let mt=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(mt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(mt,rt.__webglTexture),Gt(mt,zt),yt(B.__webglFramebuffer,A,zt,i.COLOR_ATTACHMENT0+dt,mt,0),m(zt)&&f(mt)}e.unbindTexture()}else{let dt=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(dt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(dt,X.__webglTexture),Gt(dt,_),_.mipmaps&&_.mipmaps.length>0)for(let At=0;At<_.mipmaps.length;At++)yt(B.__webglFramebuffer[At],A,_,i.COLOR_ATTACHMENT0,dt,At);else yt(B.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,dt,0);m(_)&&f(dt),e.unbindTexture()}A.depthBuffer&&Jt(A)}function $(A){const _=A.textures;for(let B=0,X=_.length;B<X;B++){const j=_[B];if(m(j)){const Y=w(A),Pt=n.get(j).__webglTexture;e.bindTexture(Y,Pt),f(Y),e.unbindTexture()}}}const st=[],J=[];function at(A){if(A.samples>0){if(bt(A)===!1){const _=A.textures,B=A.width,X=A.height;let j=i.COLOR_BUFFER_BIT;const Y=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Pt=n.get(A),dt=_.length>1;if(dt)for(let zt=0;zt<_.length;zt++)e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+zt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+zt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer);const At=A.texture.mipmaps;At&&At.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer);for(let zt=0;zt<_.length;zt++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),dt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Pt.__webglColorRenderbuffer[zt]);const rt=n.get(_[zt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,rt,0)}i.blitFramebuffer(0,0,B,X,0,0,B,X,j,i.NEAREST),l===!0&&(st.length=0,J.length=0,st.push(i.COLOR_ATTACHMENT0+zt),A.depthBuffer&&A.resolveDepthBuffer===!1&&(st.push(Y),J.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,J)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,st))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),dt)for(let zt=0;zt<_.length;zt++){e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+zt,i.RENDERBUFFER,Pt.__webglColorRenderbuffer[zt]);const rt=n.get(_[zt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Pt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+zt,i.TEXTURE_2D,rt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const _=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function I(A){return Math.min(s.maxSamples,A.samples)}function bt(A){const _=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function xt(A){const _=r.render.frame;h.get(A)!==_&&(h.set(A,_),A.update())}function Dt(A,_){const B=A.colorSpace,X=A.format,j=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||B!==ys&&B!==vi&&(te.getTransfer(B)===de?(X!==Un||j!==fn)&&Ft("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qt("WebGLTextures: Unsupported texture color space:",B)),_}function ht(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=L,this.resetTextureUnits=R,this.setTexture2D=N,this.setTexture2DArray=H,this.setTexture3D=k,this.setTextureCube=q,this.rebindTextures=re,this.setupRenderTarget=Wt,this.updateRenderTargetMipmap=$,this.updateMultisampleRenderTarget=at,this.setupDepthRenderbuffer=Jt,this.setupFrameBufferTexture=yt,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Fx(i,t){function e(n,s=vi){let a;const r=te.getTransfer(s);if(n===fn)return i.UNSIGNED_BYTE;if(n===vl)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ml)return i.UNSIGNED_SHORT_5_5_5_1;if(n===wh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===bh)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===yh)return i.BYTE;if(n===Sh)return i.SHORT;if(n===Js)return i.UNSIGNED_SHORT;if(n===_l)return i.INT;if(n===qn)return i.UNSIGNED_INT;if(n===Nn)return i.FLOAT;if(n===li)return i.HALF_FLOAT;if(n===Eh)return i.ALPHA;if(n===Th)return i.RGB;if(n===Un)return i.RGBA;if(n===ci)return i.DEPTH_COMPONENT;if(n===zi)return i.DEPTH_STENCIL;if(n===yl)return i.RED;if(n===Sl)return i.RED_INTEGER;if(n===Ms)return i.RG;if(n===wl)return i.RG_INTEGER;if(n===bl)return i.RGBA_INTEGER;if(n===Ga||n===Va||n===Wa||n===Xa)if(r===de)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(n===Ga)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Va)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Wa)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Xa)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(n===Ga)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Va)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Wa)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Xa)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===So||n===wo||n===bo||n===Eo)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(n===So)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===wo)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===bo)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Eo)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===To||n===Co||n===Ao||n===Ro||n===Po||n===Io||n===Lo)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(n===To||n===Co)return r===de?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(n===Ao)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ro)return a.COMPRESSED_R11_EAC;if(n===Po)return a.COMPRESSED_SIGNED_R11_EAC;if(n===Io)return a.COMPRESSED_RG11_EAC;if(n===Lo)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Do||n===Fo||n===No||n===Uo||n===Oo||n===Bo||n===ko||n===zo||n===Ho||n===Go||n===Vo||n===Wo||n===Xo||n===Yo)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(n===Do)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Fo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===No)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Uo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Oo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Bo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ko)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===zo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ho)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Go)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Vo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Wo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Xo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Yo)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===qo||n===Zo||n===$o)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(n===qo)return r===de?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Zo)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===$o)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ko||n===Jo||n===jo||n===Qo)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(n===Ko)return a.COMPRESSED_RED_RGTC1_EXT;if(n===Jo)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===jo)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Qo)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===js?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const Nx=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		`;const o=(m,f,w,b=52)=>{const y=document.createElement("div");return y.id=m,y.style.cssText=`
