...
`)}const Gg={[ch]:"Linear",[hh]:"Reinhard",[uh]:"Cineon",[dh]:"ACESFilmic",[ph]:"AgX",[mh]:"Neutral",[fh]:"Custom"};function Vg(i,t){const e=Gg[t];return e===void 0?(Ot("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Br=new D;function Wg(){se.getLuminanceCoefficients(Br);const i=Br.x.toFixed(4),t=Br.y.toFixed(4),e=Br.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}const Qg={[Gr]:"SHADOWMAP_TYPE_PCF",[Ws]:"SHADOWMAP_TYPE_VSM"};function tx(i){return Qg[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const ex={[Gi]:"ENVMAP_TYPE_CUBE",[Ms]:"ENVMAP_TYPE_CUBE",[ua]:"ENVMAP_TYPE_CUBE_UV"};function nx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":ex[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const ix={[Ms]:"ENVMAP_MODE_REFRACTION"};function sx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":ix[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const rx={[ha]:"ENVMAP_BLENDING_MULTIPLY",[Vu]:"ENVMAP_BLENDING_MIX",[Wu]:"ENVMAP_BLENDING_ADD"};function ax(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":rx[i.combine]||"ENVMAP_BLENDING_NONE"}function ox(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function lx(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=tx(e),c=nx(e),h=sx(e),u=ax(e),d=ox(e),f=Xg(e),g=Yg(r),x=s.createProgram();let m,p,w=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const b=w+m+a,M=w+p+o,y=Vc(s,s.VERTEX_SHADER,b),T=Vc(s,s.FRAGMENT_SHADER,M);s.attachShader(x,y),s.attachShader(x,T),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(P){if(i.debug.checkShaderErrors){const I=s.getProgramInfoLog(x)||"",F=s.getShaderInfoLog(y)||"",B=s.getShaderInfoLog(T)||"",N=I.trim(),H=F.trim(),z=B.trim();let Z=!0,st=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,y,T);else{const K=Xc(s,y,"vertex"),Q=Xc(s,T,"fragment");ne("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,bx=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],Ex=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],Qc=new ee,zs=new D,to=new D;function Tx(i,t,e){let n=new Al;const s=new ut,r=new ut,a=new Ee,o=new If,l=new Lf,c={},h=e.maxTextureSize,u={[bi]:an,[an]:bi,[Fe]:Fe},d=new Tn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ut},radius:{value:4}},vertexShader:Sx,fragmentShader:wx}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new on;g.setAttribute("position",new bn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new it(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Gr;let p=this.type;this.render=function(T,C,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;T.type===bu&&(Ot("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),T.type=Gr);const v=i.getRenderTarget(),S=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),I=i.state;I.setBlending(ri),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const F=p!==this.type;F&&C.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(N=>N.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,N=T.length;B<N;B++){const H=T[B],z=H.shadow;if(z===void 0){Ot("WebGLShadowMap:",H,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const Z=z.getFrameExtents();if(s.multiply(Z),r.copy(z.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/Z.x),s.x=r.x*Z.x,z.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/Z.y),s.y=r.y*Z.y,z.mapSize.y=r.y)),z.map===null||F===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Ws){if(H.isPointLight){Ot("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Yn(s.x,s.y,{format:ys,type:li,minFilter:He,magFilter:He,generateMipmaps:!1}),z.map.texture.name=H.name+".shadowMap",z.map.depthTexture=new nr(s.x,s.y,Nn),z.map.depthTexture.name=H.name+".shadowMapDepth",z.map.depthTexture.format=ci,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ve,z.map.depthTexture.magFilter=Ve}else{H.isPointLight?(z.map=new Lh(s.x),z.map.depthTexture=new Zd(s.x,qn)):(z.map=new Yn(s.x,s.y),z.map.depthTexture=new nr(s.x,s.y,qn)),z.map.depthTexture.name=H.name+".shadowMap",z.map.depthTexture.format=ci;const K=i.state.buffers.depth.getReversed();this.type===Gr?(z.map.depthTexture.compareFunction=K?El:bl,z.map.depthTexture.minFilter=He,z.map.depthTexture.magFilter=He):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ve,z.map.depthTexture.magFilter=Ve)}z.camera.updateProjectionMatrix()}const st=z.map.isWebGLCubeRenderTarget?6:1;for(let K=0;K<st;K++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,K),i.clear();else{K===0&&(i.setRenderTarget(z.map),i.clear());const Q=z.getViewport(K);a.set(r.x*Q.x,r.y*Q.y,r.x*Q.z,r.y*Q.w),I.viewport(a)}if(H.isPointLight){const Q=z.camera,Lt=z.matrix,Ct=H.distance||Q.far;Ct!==Q.far&&(Q.far=Ct,Q.updateProjectionMatrix()),zs.setFromMatrixPosition(H.matrixWorld),Q.position.copy(zs),to.copy(Q.position),to.add(bx[K]),Q.up.copy(Ex[K]),Q.lookAt(to),Q.updateMatrixWorld(),Lt.makeTranslation(-zs.x,-zs.y,-zs.z),Qc.multiplyMatrices(Q.projectionMatrix,Q.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Qc,Q.coordinateSystem,Q.reversedDepth)}else z.updateMatrices(H);n=z.getFrustum(),M(C,L,z.camera,H,this.type)}z.isPointLightShadow!==!0&&this.type===Ws&&w(z,L),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(v,S,P)};function w(T,C){const L=t.update(x);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Yn(s.x,s.y,{format:ys,type:li})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(C,null,L,d,x,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(C,null,L,f,x,null)}function b(T,C,L,v){let S=null;const P=L.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)S=P;else if(S=L.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const I=S.uuid,F=C.uuid;let B=c[I];B===void 0&&(B={},c[I]=B);let N=B[F];N===void 0&&(N=S.clone(),B[F]=N,C.addEventListener("dispose",y)),S=N}if(S.visible=C.visible,S.wireframe=C.wireframe,v===Ws?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:u[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const I=i.properties.get(S);I.light=L}return S}function M(T,C,L,v,S){if(T.visible===!1)return;if(T.layers.test(C.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&S===Ws)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,T.matrixWorld);const F=t.update(T),B=T.material;if(Array.isArray(B)){const N=F.groups;for(let H=0,z=N.length;H<z;H++){const Z=N[H],st=B[Z.materialIndex];if(st&&st.visible){const K=b(T,st,v,S);T.onBeforeShadow(i,T,C,L,F,K,Z),i.renderBufferDirect(L,null,F,K,T,Z),T.onAfterShadow(i,T,C,L,F,K,Z)}}}else if(B.visible){const N=b(T,B,v,S);T.onBeforeShadow(i,T,C,L,F,N,null),i.renderBufferDirect(L,null,F,N,T,null),T.onAfterShadow(i,T,C,L,F,N,null)}}const I=T.children;for(let F=0,B=I.length;F<B;F++)M(I[F],C,L,v,S)}function y(T){T.target.removeEventListener("dispose",y);for(const L in c){const v=c[L],S=T.target.uuid;S in v&&(v[S].dispose(),delete v[S])}}}const Cx={[co]:ho,[uo]:mo,[fo]:go,[vs]:po,[ho]:co,[mo]:uo,[go]:fo,[po]:vs};function Ax(i,t){function e(){let U=!1;const St=new Ee;let ct=null;const wt=new Ee(0,0,0,0);return{setMask:function(lt){ct!==lt&&!U&&(i.colorMask(lt,lt,lt,lt),ct=lt)},setLocked:function(lt){U=lt},setClear:function(lt,nt,ft,Wt,ge){ge===!0&&(lt*=Wt,nt*=Wt,ft*=Wt),St.set(lt,nt,ft,Wt),wt.equals(St)===!1&&(i.clearColor(lt,nt,ft,Wt),wt.copy(St))},reset:function(){U=!1,ct=null,wt.set(-1,0,0,0)}}}function n(){let U=!1,St=!1,ct=null,wt=null,lt=null;return{setReversed:function(nt){if(St!==nt){const ft=t.get("EXT_clip_control");nt?ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.ZERO_TO_ONE_EXT):ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.NEGATIVE_ONE_TO_ONE_EXT),St=nt;const Wt=lt;lt=null,this.setClear(Wt)}},getReversed:function(){return St},setTest:function(nt){nt?$(i.DEPTH_TEST):vt(i.DEPTH_TEST)},setMask:function(nt){ct!==nt&&!U&&(i.depthMask(nt),ct=nt)},setFunc:function(nt){if(St&&(nt=Cx[nt]),wt!==nt){switch(nt){case co:i.depthFunc(i.NEVER);break;case ho:i.depthFunc(i.ALWAYS);break;case uo:i.depthFunc(i.LESS);break;case vs:i.depthFunc(i.LEQUAL);break;case fo:i.depthFunc(i.EQUAL);break;case po:i.depthFunc(i.GEQUAL);break;case mo:i.depthFunc(i.GREATER);break;case go:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}wt=nt}},setLocked:function(nt){U=nt},setClear:function(nt){lt!==nt&&(St&&(nt=1-nt),i.clearDepth(nt),lt=nt)},reset:function(){U=!1,ct=null,wt=null,lt=null,St=!1}}}function s(){let U=!1,St=null,ct=null,wt=null,lt=null,nt=null,ft=null,Wt=null,ge=null;return{setTest:function(ce){U||(ce?$(i.STENCIL_TEST):vt(i.STENCIL_TEST))},setMask:function(ce){St!==ce&&!U&&(i.stencilMask(ce),St=ce)},setFunc:function(ce,On,$n){(ct!==ce||wt!==On||lt!==$n)&&(i.stencilFunc(ce,On,$n),ct=ce,wt=On,lt=$n)},setOp:function(ce,On,$n){(nt!==ce||ft!==On||Wt!==$n)&&(i.stencilOp(ce,On,$n),nt=ce,ft=On,Wt=$n)},setLocked:function(ce){U=ce},setClear:function(ce){ge!==ce&&(i.clearStencil(ce),ge=ce)},reset:function(){U=!1,St=null,ct=null,wt=null,lt=null,nt=null,ft=null,Wt=null,ge=null}}}const r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,b=null,M=null,y=null,T=null,C=new Bt(0,0,0),L=0,v=!1,S=null,P=null,I=null,F=null,B=null;const N=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,z=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(Z)[1]),H=z>=1):Z.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),H=z>=2);let st=null,K={};const Q=i.getParameter(i.SCISSOR_BOX),Lt=i.getParameter(i.VIEWPORT),Ct=new Ee().fromArray(Q),Zt=new Ee().fromArray(Lt);function Xt(U,St,ct,wt){const lt=new Uint8Array(4),nt=i.createTexture();i.bindTexture(U,nt),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ft=0;ft<ct;ft++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(St,0,i.RGBA,1,1,wt,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(St+ft,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return nt}const W={};W[i.TEXTURE_2D]=Xt(i.TEXTURE_2D,i.TEXTURE_2D,1),W[i.TEXTURE_CUBE_MAP]=Xt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),W[i.TEXTURE_2D_ARRAY]=Xt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),W[i.TEXTURE_3D]=Xt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),$(i.DEPTH_TEST),a.setFunc(vs),tt(!1),at(ql),$(i.CULL_FACE),J(ri);function $(U){h[U]!==!0&&(i.enable(U),h[U]=!0)}function vt(U){h[U]!==!1&&(i.disable(U),h[U]=!1)}function Ft(U,St){return u[U]!==St?(i.bindFramebuffer(U,St),u[U]=St,U===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=St),U===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=St),!0):!1}function Mt(U,St){let ct=f,wt=!1;if(U){ct=d.get(St),ct===void 0&&(ct=[],d.set(St,ct));const lt=U.textures;if(ct.length!==lt.length||ct[0]!==i.COLOR_ATTACHMENT0){for(let nt=0,ft=lt.length;nt<ft;nt++)ct[nt]=i.COLOR_ATTACHMENT0+nt;ct.length=lt.length,wt=!0}}else ct[0]!==i.BACK&&(ct[0]=i.BACK,wt=!0);wt&&i.drawBuffers(ct)}function Yt(U){return g!==U?(i.useProgram(U),g=U,!0):!1}const Qt={[Bi]:i.FUNC_ADD,[Tu]:i.FUNC_SUBTRACT,[Cu]:i.FUNC_REVERSE_SUBTRACT};Qt[Au]=i.MIN,Qt[Ru]=i.MAX;const Gt={[Pu]:i.ZERO,[Iu]:i.ONE,[Lu]:i.SRC_COLOR,[oo]:i.SRC_ALPHA,[Bu]:i.SRC_ALPHA_SATURATE,[Uu]:i.DST_COLOR,[Fu]:i.DST_ALPHA,[Du]:i.ONE_MINUS_SRC_COLOR,[lo]:i.ONE_MINUS_SRC_ALPHA,[Ou]:i.ONE_MINUS_DST_COLOR,[Nu]:i.ONE_MINUS_DST_ALPHA,[ku]:i.CONSTANT_COLOR,[zu]:i.ONE_MINUS_CONSTANT_COLOR,[Hu]:i.CONSTANT_ALPHA,[Gu]:i.ONE_MINUS_CONSTANT_ALPHA};function J(U,St,ct,wt,lt,nt,ft,Wt,ge,ce){if(U===ri){x===!0&&(vt(i.BLEND),x=!1);return}if(x===!1&&($(i.BLEND),x=!0),U!==Eu){if(U!==m||ce!==v){if((p!==Bi||M!==Bi)&&(i.blendEquation(i.FUNC_ADD),p=Bi,M=Bi),ce)switch(U){case xs:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wn:i.blendFunc(i.ONE,i.ONE);break;case Zl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case $l:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:ne("WebGLState: Invalid blending: ",U);break}else switch(U){case xs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Zl:ne("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case $l:ne("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ne("WebGLState: Invalid blending: ",U);break}w=null,b=null,y=null,T=null,C.set(0,0,0),L=0,m=U,v=ce}return}lt=lt||St,nt=nt||ct,ft=ft||wt,(St!==p||lt!==M)&&(i.blendEquationSeparate(Qt[St],Qt[lt]),p=St,M=lt),(ct!==w||wt!==b||nt!==y||ft!==T)&&(i.blendFuncSeparate(Gt[ct],Gt[wt],Gt[nt],Gt[ft]),w=ct,b=wt,y=nt,T=ft),(Wt.equals(C)===!1||ge!==L)&&(i.blendColor(Wt.r,Wt.g,Wt.b,ge),C.copy(Wt),L=ge),m=U,v=!1}function rt(U,St){U.side===Fe?vt(i.CULL_FACE):$(i.CULL_FACE);let ct=U.side===an;St&&(ct=!ct),tt(ct),U.blending===xs&&U.transparent===!1?J(ri):J(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);const wt=U.stencilWrite;o.setTest(wt),wt&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),bt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?$(i.SAMPLE_ALPHA_TO_COVERAGE):vt(i.SAMPLE_ALPHA_TO_COVERAGE)}function tt(U){S!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),S=U)}function at(U){U!==Su?($(i.CULL_FACE),U!==P&&(U===ql?i.cullFace(i.BACK):U===wu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):vt(i.CULL_FACE),P=U}function R(U){U!==I&&(H&&i.lineWidth(U),I=U)}function bt(U,St,ct){U?($(i.POLYGON_OFFSET_FILL),(F!==St||B!==ct)&&(i.polygonOffset(St,ct),F=St,B=ct)):vt(i.POLYGON_OFFSET_FILL)}function xt(U){U?$(i.SCISSOR_TEST):vt(i.SCISSOR_TEST)}function Ut(U){U===void 0&&(U=i.TEXTURE0+N-1),st!==U&&(i.activeTexture(U),st=U)}function ht(U,St,ct){ct===void 0&&(st===null?ct=i.TEXTURE0+N-1:ct=st);let wt=K[ct];wt===void 0&&(wt={type:void 0,texture:void 0},K[ct]=wt),(wt.type!==U||wt.texture!==St)&&(st!==ct&&(i.activeTexture(ct),st=ct),i.bindTexture(U,St||W[U]),wt.type=U,wt.texture=St)}function A(){const U=K[st];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(U){ne("WebGLState:",U)}}function O(){try{i.compressedTexImage3D(...arguments)}catch(U){ne("WebGLState:",U)}}function Y(){try{i.texSubImage2D(...arguments)}catch(U){ne("WebGLState:",U)}}function et(){try{i.texSubImage3D(...arguments)}catch(U){ne("WebGLState:",U)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(U){ne("WebGLState:",U)}}function It(){try{i.compressedTexSubImage3D(...arguments)}catch(U){ne("WebGLState:",U)}}function dt(){try{i.texStorage2D(...arguments)}catch(U){ne("WebGLState:",U)}}function Rt(){try{i.texStorage3D(...arguments)}catch(U){ne("WebGLState:",U)}}function Ht(){try{i.texImage2D(...arguments)}catch(U){ne("WebGLState:",U)}}function ot(){try{i.texImage3D(...arguments)}catch(U){ne("WebGLState:",U)}}function mt(U){Ct.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),Ct.copy(U))}function Pt(U){Zt.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Zt.copy(U))}function Dt(U,St){let ct=c.get(St);ct===void 0&&(ct=new WeakMap,c.set(St,ct));let wt=ct.get(U);wt===void 0&&(wt=i.getUniformBlockIndex(St,U.name),ct.set(U,wt))}function pt(U,St){const wt=c.get(St).get(U);l.get(St)!==wt&&(i.uniformBlockBinding(St,wt,U.__bindingPointIndex),l.set(St,wt))}function Kt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},st=null,K={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,b=null,M=null,y=null,T=null,C=new Bt(0,0,0),L=0,v=!1,S=null,P=null,I=null,F=null,B=null,Ct.set(0,0,i.canvas.width,i.canvas.height),Zt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:$,disable:vt,bindFramebuffer:Ft,drawBuffers:Mt,useProgram:Yt,setBlending:J,setMaterial:rt,setFlipSided:tt,setCullFace:at,setLineWidth:R,setPolygonOffset:bt,setScissorTest:xt,activeTexture:Ut,bindTexture:ht,unbindTexture:A,compressedTexImage2D:_,compressedTexImage3D:O,texImage2D:Ht,texImage3D:ot,updateUBOMapping:Dt,uniformBlockBinding:pt,texStorage2D:dt,texStorage3D:Rt,texSubImage2D:Y,texSubImage3D:et,compressedTexSubImage2D:q,compressedTexSubImage3D:It,scissor:mt,viewport:Pt,reset:Kt}}function Rx(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ut,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,_){return f?new OffscreenCanvas(A,_):jr("canvas")}function x(A,_,O){let Y=1;const et=ht(A);if((et.width>O||et.height>O)&&(Y=O/Math.max(et.width,et.height)),Y<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const q=Math.floor(Y*et.width),It=Math.floor(Y*et.height);u===void 0&&(u=g(q,It));const dt=_?g(q,It):u;return dt.width=q,dt.height=It,dt.getContext("2d").drawImage(A,0,0,q,It),Ot("WebGLRenderer: Texture has been resized from ("+et.width+"x"+et.height+") to ("+q+"x"+It+")."),dt}else return"data"in A&&Ot("WebGLRenderer: Image in DataTexture is too big ("+et.width+"x"+et.height+")."),A;return A}function m(A){return A.generateMipmaps}function p(A){i.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(A,_,O,Y,et=!1){if(A!==null){if(i[A]!==void 0)return i[A];Ot("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let q=_;if(_===i.RED&&(O===i.FLOAT&&(q=i.R32F),O===i.HALF_FLOAT&&(q=i.R16F),O===i.UNSIGNED_BYTE&&(q=i.R8)),_===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.R8UI),O===i.UNSIGNED_SHORT&&(q=i.R16UI),O===i.UNSIGNED_INT&&(q=i.R32UI),O===i.BYTE&&(q=i.R8I),O===i.SHORT&&(q=i.R16I),O===i.INT&&(q=i.R32I)),_===i.RG&&(O===i.FLOAT&&(q=i.RG32F),O===i.HALF_FLOAT&&(q=i.RG16F),O===i.UNSIGNED_BYTE&&(q=i.RG8)),_===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.RG8UI),O===i.UNSIGNED_SHORT&&(q=i.RG16UI),O===i.UNSIGNED_INT&&(q=i.RG32UI),O===i.BYTE&&(q=i.RG8I),O===i.SHORT&&(q=i.RG16I),O===i.INT&&(q=i.RG32I)),_===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.RGB8UI),O===i.UNSIGNED_SHORT&&(q=i.RGB16UI),O===i.UNSIGNED_INT&&(q=i.RGB32UI),O===i.BYTE&&(q=i.RGB8I),O===i.SHORT&&(q=i.RGB16I),O===i.INT&&(q=i.RGB32I)),_===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),O===i.UNSIGNED_INT&&(q=i.RGBA32UI),O===i.BYTE&&(q=i.RGBA8I),O===i.SHORT&&(q=i.RGBA16I),O===i.INT&&(q=i.RGBA32I)),_===i.RGB&&(O===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(q=i.R11F_G11F_B10F)),_===i.RGBA){const It=et?Kr:se.getTransfer(Y);O===i.FLOAT&&(q=i.RGBA32F),O===i.HALF_FLOAT&&(q=i.RGBA16F),O===i.UNSIGNED_BYTE&&(q=It===ue?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function M(A,_){let O;return A?_===null||_===qn||_===Qs?O=i.DEPTH24_STENCIL8:_===Nn?O=i.DEPTH32F_STENCIL8:_===js&&(O=i.DEPTH24_STENCIL8,Ot("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===qn||_===Qs?O=i.DEPTH_COMPONENT24:_===Nn?O=i.DEPTH_COMPONENT32F:_===js&&(O=i.DEPTH_COMPONENT16),O}function y(A,_){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ve&&A.minFilter!==He?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function T(A){const _=A.target;_.removeEventListener("dispose",T),L(_),_.isVideoTexture&&h.delete(_)}function C(A){const _=A.target;_.removeEventListener("dispose",C),S(_)}function L(A){const _=n.get(A);if(_.__webglInit===void 0)return;const O=A.source,Y=d.get(O);if(Y){const et=Y[_.__cacheKey];et.usedTimes--,et.usedTimes===0&&v(A),Object.keys(Y).length===0&&d.delete(O)}n.remove(A)}function v(A){const _=n.get(A);i.deleteTexture(_.__webglTexture);const O=A.source,Y=d.get(O);delete Y[_.__cacheKey],a.memory.textures--}function S(A){const _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(_.__webglFramebuffer[Y]))for(let et=0;et<_.__webglFramebuffer[Y].length;et++)i.deleteFramebuffer(_.__webglFramebuffer[Y][et]);else i.deleteFramebuffer(_.__webglFramebuffer[Y]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[Y])}else{if(Array.isArray(_.__webglFramebuffer))for(let Y=0;Y<_.__webglFramebuffer.length;Y++)i.deleteFramebuffer(_.__webglFramebuffer[Y]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let Y=0;Y<_.__webglColorRenderbuffer.length;Y++)_.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[Y]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const O=A.textures;for(let Y=0,et=O.length;Y<et;Y++){const q=n.get(O[Y]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(O[Y])}n.remove(A)}let P=0;function I(){P=0}function F(){const A=P;return A>=s.maxTextures&&Ot("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),P+=1,A}function B(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function N(A,_){const O=n.get(A);if(A.isVideoTexture&&xt(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const Y=A.image;if(Y===null)Ot("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Ot("WebGLRenderer: Texture marked for update but image is incomplete");else{W(O,A,_);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+_)}function H(A,_){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){W(O,A,_);return}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+_)}function z(A,_){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){W(O,A,_);return}e.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+_)}function Z(A,_){const O=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&O.__version!==A.version){$(O,A,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+_)}const st={[vo]:i.REPEAT,[ni]:i.CLAMP_TO_EDGE,[Mo]:i.MIRRORED_REPEAT},K={[Ve]:i.NEAREST,[Xu]:i.NEAREST_MIPMAP_NEAREST,[ur]:i.NEAREST_MIPMAP_LINEAR,[He]:i.LINEAR,[Ma]:i.LINEAR_MIPMAP_NEAREST,[zi]:i.LINEAR_MIPMAP_LINEAR},Q={[Zu]:i.NEVER,[Qu]:i.ALWAYS,[$u]:i.LESS,[bl]:i.LEQUAL,[Ku]:i.EQUAL,[El]:i.GEQUAL,[Ju]:i.GREATER,[ju]:i.NOTEQUAL};function Lt(A,_){if(_.type===Nn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===He||_.magFilter===Ma||_.magFilter===ur||_.magFilter===zi||_.minFilter===He||_.minFilter===Ma||_.minFilter===ur||_.minFilter===zi)&&Ot("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,st[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,st[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,st[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,K[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,K[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,Q[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ve||_.minFilter!==ur&&_.minFilter!==zi||_.type===Nn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const O=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Ct(A,_){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",T));const Y=_.source;let et=d.get(Y);et===void 0&&(et={},d.set(Y,et));const q=B(_);if(q!==A.__cacheKey){et[q]===void 0&&(et[q]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),et[q].usedTimes++;const It=et[A.__cacheKey];It!==void 0&&(et[A.__cacheKey].usedTimes--,It.usedTimes===0&&v(_)),A.__cacheKey=q,A.__webglTexture=et[q].texture}return O}function Zt(A,_,O){return Math.floor(Math.floor(A/O)/_)}function Xt(A,_,O,Y){const q=A.updateRanges;if(q.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,O,Y,_.data);else{q.sort((ot,mt)=>ot.start-mt.start);let It=0;for(let ot=1;ot<q.length;ot++){const mt=q[It],Pt=q[ot],Dt=mt.start+mt.count,pt=Zt(Pt.start,_.width,4),Kt=Zt(mt.start,_.width,4);Pt.start<=Dt+1&&pt===Kt&&Zt(Pt.start+Pt.count-1,_.width,4)===pt?mt.count=Math.max(mt.count,Pt.start+Pt.count-mt.start):(++It,q[It]=Pt)}q.length=It+1;const dt=i.getParameter(i.UNPACK_ROW_LENGTH),Rt=i.getParameter(i.UNPACK_SKIP_PIXELS),Ht=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ot=0,mt=q.length;ot<mt;ot++){const Pt=q[ot],Dt=Math.floor(Pt.start/4),pt=Math.ceil(Pt.count/4),Kt=Dt%_.width,U=Math.floor(Dt/_.width),St=pt,ct=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Kt),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),e.texSubImage2D(i.TEXTURE_2D,0,Kt,U,St,ct,O,Y,_.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,dt),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Rt),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ht)}}function W(A,_,O){let Y=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Y=i.TEXTURE_3D);const et=Ct(A,_),q=_.source;e.bindTexture(Y,A.__webglTexture,i.TEXTURE0+O);const It=n.get(q);if(q.version!==It.__version||et===!0){e.activeTexture(i.TEXTURE0+O);const dt=se.getPrimaries(se.workingColorSpace),Rt=_.colorSpace===vi?null:se.getPrimaries(_.colorSpace),Ht=_.colorSpace===vi||dt===Rt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ht);let ot=x(_.image,!1,s.maxTextureSize);ot=Ut(_,ot);const mt=r.convert(_.format,_.colorSpace),Pt=r.convert(_.type);let Dt=b(_.internalFormat,mt,Pt,_.colorSpace,_.isVideoTexture);Lt(Y,_);let pt;const Kt=_.mipmaps,U=_.isVideoTexture!==!0,St=It.__version===void 0||et===!0,ct=q.dataReady,wt=y(_,ot);if(_.isDepthTexture)Dt=M(_.format===Hi,_.type),St&&(U?e.texStorage2D(i.TEXTURE_2D,1,Dt,ot.width,ot.height):e.texImage2D(i.TEXTURE_2D,0,Dt,ot.width,ot.height,0,mt,Pt,null));else if(_.isDataTexture)if(Kt.length>0){U&&St&&e.texStorage2D(i.TEXTURE_2D,wt,Dt,Kt[0].width,Kt[0].height);for(let lt=0,nt=Kt.length;lt<nt;lt++)pt=Kt[lt],U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,Pt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,Dt,pt.width,pt.height,0,mt,Pt,pt.data);_.generateMipmaps=!1}else U?(St&&e.texStorage2D(i.TEXTURE_2D,wt,Dt,ot.width,ot.height),ct&&Xt(_,ot,mt,Pt)):e.texImage2D(i.TEXTURE_2D,0,Dt,ot.width,ot.height,0,mt,Pt,ot.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&St&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,Dt,Kt[0].width,Kt[0].height,ot.depth);for(let lt=0,nt=Kt.length;lt<nt;lt++)if(pt=Kt[lt],_.format!==Un)if(mt!==null)if(U){if(ct)if(_.layerUpdates.size>0){const ft=Pc(pt.width,pt.height,_.format,_.type);for(const Wt of _.layerUpdates){const ge=pt.data.subarray(Wt*ft/pt.data.BYTES_PER_ELEMENT,(Wt+1)*ft/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,Wt,pt.width,pt.height,1,mt,ge)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,ot.depth,mt,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,lt,Dt,pt.width,pt.height,ot.depth,0,pt.data,0,0);else Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?ct&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,pt.width,pt.height,ot.depth,mt,Pt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,lt,Dt,pt.width,pt.height,ot.depth,0,mt,Pt,pt.data)}else{U&&St&&e.texStorage2D(i.TEXTURE_2D,wt,Dt,Kt[0].width,Kt[0].height);for(let lt=0,nt=Kt.length;lt<nt;lt++)pt=Kt[lt],_.format!==Un?mt!==null?U?ct&&e.compressedTexSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,lt,Dt,pt.width,pt.height,0,pt.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,pt.width,pt.height,mt,Pt,pt.data):e.texImage2D(i.TEXTURE_2D,lt,Dt,pt.width,pt.height,0,mt,Pt,pt.data)}else if(_.isDataArrayTexture)if(U){if(St&&e.texStorage3D(i.TEXTURE_2D_ARRAY,wt,Dt,ot.width,ot.height,ot.depth),ct)if(_.layerUpdates.size>0){const lt=Pc(ot.width,ot.height,_.format,_.type);for(const nt of _.layerUpdates){const ft=ot.data.subarray(nt*lt/ot.data.BYTES_PER_ELEMENT,(nt+1)*lt/ot.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,nt,ot.width,ot.height,1,mt,Pt,ft)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ot.width,ot.height,ot.depth,mt,Pt,ot.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Dt,ot.width,ot.height,ot.depth,0,mt,Pt,ot.data);else if(_.isData3DTexture)U?(St&&e.texStorage3D(i.TEXTURE_3D,wt,Dt,ot.width,ot.height,ot.depth),ct&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ot.width,ot.height,ot.depth,mt,Pt,ot.data)):e.texImage3D(i.TEXTURE_3D,0,Dt,ot.width,ot.height,ot.depth,0,mt,Pt,ot.data);else if(_.isFramebufferTexture){if(St)if(U)e.texStorage2D(i.TEXTURE_2D,wt,Dt,ot.width,ot.height);else{let lt=ot.width,nt=ot.height;for(let ft=0;ft<wt;ft++)e.texImage2D(i.TEXTURE_2D,ft,Dt,lt,nt,0,mt,Pt,null),lt>>=1,nt>>=1}}else if(Kt.length>0){if(U&&St){const lt=ht(Kt[0]);e.texStorage2D(i.TEXTURE_2D,wt,Dt,lt.width,lt.height)}for(let lt=0,nt=Kt.length;lt<nt;lt++)pt=Kt[lt],U?ct&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,mt,Pt,pt):e.texImage2D(i.TEXTURE_2D,lt,Dt,mt,Pt,pt);_.generateMipmaps=!1}else if(U){if(St){const lt=ht(ot);e.texStorage2D(i.TEXTURE_2D,wt,Dt,lt.width,lt.height)}ct&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,mt,Pt,ot)}else e.texImage2D(i.TEXTURE_2D,0,Dt,mt,Pt,ot);m(_)&&p(Y),It.__version=q.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function $(A,_,O){if(_.image.length!==6)return;const Y=Ct(A,_),et=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+O);const q=n.get(et);if(et.version!==q.__version||Y===!0){e.activeTexture(i.TEXTURE0+O);const It=se.getPrimaries(se.workingColorSpace),dt=_.colorSpace===vi?null:se.getPrimaries(_.colorSpace),Rt=_.colorSpace===vi||It===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Rt);const Ht=_.isCompressedTexture||_.image[0].isCompressedTexture,ot=_.image[0]&&_.image[0].isDataTexture,mt=[];for(let nt=0;nt<6;nt++)!Ht&&!ot?mt[nt]=x(_.image[nt],!0,s.maxCubemapSize):mt[nt]=ot?_.image[nt].image:_.image[nt],mt[nt]=Ut(_,mt[nt]);const Pt=mt[0],Dt=r.convert(_.format,_.colorSpace),pt=r.convert(_.type),Kt=b(_.internalFormat,Dt,pt,_.colorSpace),U=_.isVideoTexture!==!0,St=q.__version===void 0||Y===!0,ct=et.dataReady;let wt=y(_,Pt);Lt(i.TEXTURE_CUBE_MAP,_);let lt;if(Ht){U&&St&&e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Kt,Pt.width,Pt.height);for(let nt=0;nt<6;nt++){lt=mt[nt].mipmaps;for(let ft=0;ft<lt.length;ft++){const Wt=lt[ft];_.format!==Un?Dt!==null?U?ct&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft,0,0,Wt.width,Wt.height,Dt,Wt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft,Kt,Wt.width,Wt.height,0,Wt.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft,0,0,Wt.width,Wt.height,Dt,pt,Wt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft,Kt,Wt.width,Wt.height,0,Dt,pt,Wt.data)}}}else{if(lt=_.mipmaps,U&&St){lt.length>0&&wt++;const nt=ht(mt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,wt,Kt,nt.width,nt.height)}for(let nt=0;nt<6;nt++)if(ot){U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,mt[nt].width,mt[nt].height,Dt,pt,mt[nt].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Kt,mt[nt].width,mt[nt].height,0,Dt,pt,mt[nt].data);for(let ft=0;ft<lt.length;ft++){const ge=lt[ft].image[nt].image;U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft+1,0,0,ge.width,ge.height,Dt,pt,ge.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft+1,Kt,ge.width,ge.height,0,Dt,pt,ge.data)}}else{U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,Dt,pt,mt[nt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Kt,Dt,pt,mt[nt]);for(let ft=0;ft<lt.length;ft++){const Wt=lt[ft];U?ct&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft+1,0,0,Dt,pt,Wt.image[nt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,ft+1,Kt,Dt,pt,Wt.image[nt])}}}m(_)&&p(i.TEXTURE_CUBE_MAP),q.__version=et.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function vt(A,_,O,Y,et,q){const It=r.convert(O.format,O.colorSpace),dt=r.convert(O.type),Rt=b(O.internalFormat,It,dt,O.colorSpace),Ht=n.get(_),ot=n.get(O);if(ot.__renderTarget=_,!Ht.__hasExternalTextures){const mt=Math.max(1,_.width>>q),Pt=Math.max(1,_.height>>q);et===i.TEXTURE_3D||et===i.TEXTURE_2D_ARRAY?e.texImage3D(et,q,Rt,mt,Pt,_.depth,0,It,dt,null):e.texImage2D(et,q,Rt,mt,Pt,0,It,dt,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,et,ot.__webglTexture,0,R(_)):(et===i.TEXTURE_2D||et>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&et<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,et,ot.__webglTexture,q),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ft(A,_,O){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer){const Y=_.depthTexture,et=Y&&Y.isDepthTexture?Y.type:null,q=M(_.stencilBuffer,et),It=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(_),q,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(_),q,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,q,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,It,i.RENDERBUFFER,A)}else{const Y=_.textures;for(let et=0;et<Y.length;et++){const q=Y[et],It=r.convert(q.format,q.colorSpace),dt=r.convert(q.type),Rt=b(q.internalFormat,It,dt,q.colorSpace);bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(_),Rt,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(_),Rt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Rt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Mt(A,_,O){const Y=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const et=n.get(_.depthTexture);if(et.__renderTarget=_,(!et.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Y){if(et.__webglInit===void 0&&(et.__webglInit=!0,_.depthTexture.addEventListener("dispose",T)),et.__webglTexture===void 0){et.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,et.__webglTexture),Lt(i.TEXTURE_CUBE_MAP,_.depthTexture);const Ht=r.convert(_.depthTexture.format),ot=r.convert(_.depthTexture.type);let mt;_.depthTexture.format===ci?mt=i.DEPTH_COMPONENT24:_.depthTexture.format===Hi&&(mt=i.DEPTH24_STENCIL8);for(let Pt=0;Pt<6;Pt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Pt,0,mt,_.width,_.height,0,Ht,ot,null)}}else N(_.depthTexture,0);const q=et.__webglTexture,It=R(_),dt=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,Rt=_.depthTexture.format===Hi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===ci)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Rt,dt,q,0,It):i.framebufferTexture2D(i.FRAMEBUFFER,Rt,dt,q,0);else if(_.depthTexture.format===Hi)bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Rt,dt,q,0,It):i.framebufferTexture2D(i.FRAMEBUFFER,Rt,dt,q,0);else throw new Error("Unknown depthTexture format")}function Yt(A){const _=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){const Y=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),Y){const et=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,Y.removeEventListener("dispose",et)};Y.addEventListener("dispose",et),_.__depthDisposeCallback=et}_.__boundDepthTexture=Y}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(O)for(let Y=0;Y<6;Y++)Mt(_.__webglFramebuffer[Y],A,Y);else{const Y=A.texture.mipmaps;Y&&Y.length>0?Mt(_.__webglFramebuffer[0],A,0):Mt(_.__webglFramebuffer,A,0)}else if(O){_.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[Y]),_.__webglDepthbuffer[Y]===void 0)_.__webglDepthbuffer[Y]=i.createRenderbuffer(),Ft(_.__webglDepthbuffer[Y],A,!1);else{const et=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=_.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,et,i.RENDERBUFFER,q)}}else{const Y=A.texture.mipmaps;if(Y&&Y.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Ft(_.__webglDepthbuffer,A,!1);else{const et=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,et,i.RENDERBUFFER,q)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Qt(A,_,O){const Y=n.get(A);_!==void 0&&vt(Y.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Yt(A)}function Gt(A){const _=A.texture,O=n.get(A),Y=n.get(_);A.addEventListener("dispose",C);const et=A.textures,q=A.isWebGLCubeRenderTarget===!0,It=et.length>1;if(It||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=_.version,a.memory.textures++),q){O.__webglFramebuffer=[];for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer[dt]=[];for(let Rt=0;Rt<_.mipmaps.length;Rt++)O.__webglFramebuffer[dt][Rt]=i.createFramebuffer()}else O.__webglFramebuffer[dt]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer=[];for(let dt=0;dt<_.mipmaps.length;dt++)O.__webglFramebuffer[dt]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(It)for(let dt=0,Rt=et.length;dt<Rt;dt++){const Ht=n.get(et[dt]);Ht.__webglTexture===void 0&&(Ht.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&bt(A)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let dt=0;dt<et.length;dt++){const Rt=et[dt];O.__webglColorRenderbuffer[dt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[dt]);const Ht=r.convert(Rt.format,Rt.colorSpace),ot=r.convert(Rt.type),mt=b(Rt.internalFormat,Ht,ot,Rt.colorSpace,A.isXRRenderTarget===!0),Pt=R(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Pt,mt,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,O.__webglColorRenderbuffer[dt])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Ft(O.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Lt(i.TEXTURE_CUBE_MAP,_);for(let dt=0;dt<6;dt++)if(_.mipmaps&&_.mipmaps.length>0)for(let Rt=0;Rt<_.mipmaps.length;Rt++)vt(O.__webglFramebuffer[dt][Rt],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,Rt);else vt(O.__webglFramebuffer[dt],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0);m(_)&&p(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(It){for(let dt=0,Rt=et.length;dt<Rt;dt++){const Ht=et[dt],ot=n.get(Ht);let mt=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(mt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(mt,ot.__webglTexture),Lt(mt,Ht),vt(O.__webglFramebuffer,A,Ht,i.COLOR_ATTACHMENT0+dt,mt,0),m(Ht)&&p(mt)}e.unbindTexture()}else{let dt=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(dt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(dt,Y.__webglTexture),Lt(dt,_),_.mipmaps&&_.mipmaps.length>0)for(let Rt=0;Rt<_.mipmaps.length;Rt++)vt(O.__webglFramebuffer[Rt],A,_,i.COLOR_ATTACHMENT0,dt,Rt);else vt(O.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,dt,0);m(_)&&p(dt),e.unbindTexture()}A.depthBuffer&&Yt(A)}function J(A){const _=A.textures;for(let O=0,Y=_.length;O<Y;O++){const et=_[O];if(m(et)){const q=w(A),It=n.get(et).__webglTexture;e.bindTexture(q,It),p(q),e.unbindTexture()}}}const rt=[],tt=[];function at(A){if(A.samples>0){if(bt(A)===!1){const _=A.textures,O=A.width,Y=A.height;let et=i.COLOR_BUFFER_BIT;const q=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,It=n.get(A),dt=_.length>1;if(dt)for(let Ht=0;Ht<_.length;Ht++)e.bindFramebuffer(i.FRAMEBUFFER,It.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,It.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,It.__webglMultisampledFramebuffer);const Rt=A.texture.mipmaps;Rt&&Rt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,It.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,It.__webglFramebuffer);for(let Ht=0;Ht<_.length;Ht++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(et|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(et|=i.STENCIL_BUFFER_BIT)),dt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,It.__webglColorRenderbuffer[Ht]);const ot=n.get(_[Ht]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ot,0)}i.blitFramebuffer(0,0,O,Y,0,0,O,Y,et,i.NEAREST),l===!0&&(rt.length=0,tt.length=0,rt.push(i.COLOR_ATTACHMENT0+Ht),A.depthBuffer&&A.resolveDepthBuffer===!1&&(rt.push(q),tt.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,tt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,rt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),dt)for(let Ht=0;Ht<_.length;Ht++){e.bindFramebuffer(i.FRAMEBUFFER,It.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.RENDERBUFFER,It.__webglColorRenderbuffer[Ht]);const ot=n.get(_[Ht]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,It.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ht,i.TEXTURE_2D,ot,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,It.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const _=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function R(A){return Math.min(s.maxSamples,A.samples)}function bt(A){const _=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function xt(A){const _=a.render.frame;h.get(A)!==_&&(h.set(A,_),A.update())}function Ut(A,_){const O=A.colorSpace,Y=A.format,et=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==Ss&&O!==vi&&(se.getTransfer(O)===ue?(Y!==Un||et!==pn)&&Ot("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ne("WebGLTextures: Unsupported texture color space:",O)),_}function ht(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=I,this.setTexture2D=N,this.setTexture2DArray=H,this.setTexture3D=z,this.setTextureCube=Z,this.rebindTextures=Qt,this.setupRenderTarget=Gt,this.updateRenderTargetMipmap=J,this.updateMultisampleRenderTarget=at,this.setupDepthRenderbuffer=Yt,this.setupFrameBufferTexture=vt,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Px(i,t){function e(n,s=vi){let r;const a=se.getTransfer(s);if(n===pn)return i.UNSIGNED_BYTE;if(n===_l)return i.UNSIGNED_SHORT_4_4_4_4;if(n===vl)return i.UNSIGNED_SHORT_5_5_5_1;if(n===vh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Mh)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===xh)return i.BYTE;if(n===_h)return i.SHORT;if(n===js)return i.UNSIGNED_SHORT;if(n===xl)return i.INT;if(n===qn)return i.UNSIGNED_INT;if(n===Nn)return i.FLOAT;if(n===li)return i.HALF_FLOAT;if(n===yh)return i.ALPHA;if(n===Sh)return i.RGB;if(n===Un)return i.RGBA;if(n===ci)return i.DEPTH_COMPONENT;if(n===Hi)return i.DEPTH_STENCIL;if(n===Ml)return i.RED;if(n===yl)return i.RED_INTEGER;if(n===ys)return i.RG;if(n===Sl)return i.RG_INTEGER;if(n===wl)return i.RGBA_INTEGER;if(n===Vr||n===Wr||n===Xr||n===Yr)if(a===ue)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Vr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Xr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Yr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Vr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Xr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Yr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===yo||n===So||n===wo||n===bo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===yo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===So)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===wo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===bo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Eo||n===To||n===Co||n===Ao||n===Ro||n===Po||n===Io)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Eo||n===To)return a===ue?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Co)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ao)return r.COMPRESSED_R11_EAC;if(n===Ro)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Po)return r.COMPRESSED_RG11_EAC;if(n===Io)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Lo||n===Do||n===Fo||n===No||n===Uo||n===Oo||n===Bo||n===ko||n===zo||n===Ho||n===Go||n===Vo||n===Wo||n===Xo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Lo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Do)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Fo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===No)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Uo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Oo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Bo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ko)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===zo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ho)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Go)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Vo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Wo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Xo)return a===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Yo||n===qo||n===Zo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Yo)return a===ue?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===qo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Zo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===$o||n===Ko||n===Jo||n===jo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===$o)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ko)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Jo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===jo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Qs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const Ix=`
void main() {
...
}`;class Dx{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const n=new Uh(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new Tn({vertexShader:Ix,fragmentShader:Lx,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new it(new Cs(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Fx extends Ts{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,f=null,g=null;const x=typeof XRWebGLBinding<"u",m=new Dx,p={},w=e.getContextAttributes();let b=null,M=null;const y=[],T=[],C=new ut;let L=null;const v=new yn;v.viewport=new Ee;const S=new yn;S.viewport=new Ee;const P=[v,S],I=new Gf;let F=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(W){let $=y[W];return $===void 0&&($=new Ha,y[W]=$),$.getTargetRaySpace()},this.getControllerGrip=function(W){let $=y[W];return $===void 0&&($=new Ha,y[W]=$),$.getGripSpace()},this.getHand=function(W){let $=y[W];return $===void 0&&($=new Ha,y[W]=$),$.getHandSpace()};function N(W){const $=T.indexOf(W.inputSource);if($===-1)return;const vt=y[$];vt!==void 0&&(vt.update(W.inputSource,W.frame,c||a),vt.dispatchEvent({type:W.type,data:W.inputSource}))}function H(){s.removeEventListener("select",N),s.removeEventListener("selectstart",N),s.removeEventListener("selectend",N),s.removeEventListener("squeeze",N),s.removeEventListener("squeezestart",N),s.removeEventListener("squeezeend",N),s.removeEventListener("end",H),s.removeEventListener("inputsourceschange",z);for(let W=0;W<y.length;W++){const $=T[W];$!==null&&(T[W]=null,y[W].disconnect($))}F=null,B=null,m.reset();for(const W in p)delete p[W];t.setRenderTarget(b),f=null,d=null,u=null,s=null,M=null,Xt.stop(),n.isPresenting=!1,t.setPixelRatio(L),t.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(W){r=W,n.isPresenting===!0&&Ot("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(W){o=W,n.isPresenting===!0&&Ot("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(W){c=W},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u===null&&x&&(u=new XRWebGLBinding(s,e)),u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(W){if(s=W,s!==null){if(b=t.getRenderTarget(),s.addEventListener("select",N),s.addEventListener("selectstart",N),s.addEventListener("selectend",N),s.addEventListener("squeeze",N),s.addEventListener("squeezestart",N),s.addEventListener("squeezeend",N),s.addEventListener("end",H),s.addEventListener("inputsourceschange",z),w.xrCompatible!==!0&&await e.makeXRCompatible(),L=t.getPixelRatio(),t.getSize(C),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let vt=null,Ft=null,Mt=null;w.depth&&(Mt=w.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,vt=w.stencil?Hi:ci,Ft=w.stencil?Qs:qn);const Yt={colorFormat:e.RGBA8,depthFormat:Mt,scaleFactor:r};u=this.getBinding(),d=u.createProjectionLayer(Yt),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),M=new Yn(d.textureWidth,d.textureHeight,{format:Un,type:pn,depthTexture:new nr(d.textureWidth,d.textureHeight,Ft,void 0,void 0,void 0,void 0,void 0,void 0,vt),stencilBuffer:w.stencil,colorSpace:t.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const vt={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,vt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new Yn(f.framebufferWidth,f.framebufferHeight,{format:Un,type:pn,colorSpace:t.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Xt.setContext(s),Xt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function z(W){for(let $=0;$<W.removed.length;$++){const vt=W.removed[$],Ft=T.indexOf(vt);Ft>=0&&(T[Ft]=null,y[Ft].disconnect(vt))}for(let $=0;$<W.added.length;$++){const vt=W.added[$];let Ft=T.indexOf(vt);if(Ft===-1){for(let Yt=0;Yt<y.length;Yt++)if(Yt>=T.length){T.push(vt),Ft=Yt;break}else if(T[Yt]===null){T[Yt]=vt,Ft=Yt;break}if(Ft===-1)break}const Mt=y[Ft];Mt&&Mt.connect(vt)}}const Z=new D,st=new D;function K(W,$,vt){Z.setFromMatrixPosition($.matrixWorld),st.setFromMatrixPosition(vt.matrixWorld);const Ft=Z.distanceTo(st),Mt=$.projectionMatrix.elements,Yt=vt.projectionMatrix.elements,Qt=Mt[14]/(Mt[10]-1),Gt=Mt[14]/(Mt[10]+1),J=(Mt[9]+1)/Mt[5],rt=(Mt[9]-1)/Mt[5],tt=(Mt[8]-1)/Mt[0],at=(Yt[8]+1)/Yt[0],R=Qt*tt,bt=Qt*at,xt=Ft/(-tt+at),Ut=xt*-tt;if($.matrixWorld.decompose(W.position,W.quaternion,W.scale),W.translateX(Ut),W.translateZ(xt),W.matrixWorld.compose(W.position,W.quaternion,W.scale),W.matrixWorldInverse.copy(W.matrixWorld).invert(),Mt[10]===-1)W.projectionMatrix.copy($.projectionMatrix),W.projectionMatrixInverse.copy($.projectionMatrixInverse);else{const ht=Qt+xt,A=Gt+xt,_=R-Ut,O=bt+(Ft-Ut),Y=J*Gt/A*ht,et=rt*Gt/A*ht;W.projectionMatrix.makePerspective(_,O,Y,et,ht,A),W.projectionMatrixInverse.copy(W.projectionMatrix).invert()}}function Q(W,$){$===null?W.matrixWorld.copy(W.matrix):W.matrixWorld.multiplyMatrices($.matrixWorld,W.matrix),W.matrixWorldInverse.copy(W.matrixWorld).invert()}this.updateCamera=function(W){if(s===null)return;let $=W.near,vt=W.far;m.texture!==null&&(m.depthNear>0&&($=m.depthNear),m.depthFar>0&&(vt=m.depthFar)),I.near=S.near=v.near=$,I.far=S.far=v.far=vt,(F!==I.near||B!==I.far)&&(s.updateRenderState({depthNear:I.near,depthFar:I.far}),F=I.near,B=I.far),I.layers.mask=W.layers.mask|6,v.layers.mask=I.layers.mask&3,S.layers.mask=I.layers.mask&5;const Ft=W.parent,Mt=I.cameras;Q(I,Ft);for(let Yt=0;Yt<Mt.length;Yt++)Q(Mt[Yt],Ft);Mt.length===2?K(I,v,S):I.projectionMatrix.copy(v.projectionMatrix),Lt(W,I,Ft)};function Lt(W,$,vt){vt===null?W.matrix.copy($.matrixWorld):(W.matrix.copy(vt.matrixWorld),W.matrix.invert(),W.matrix.multiply($.matrixWorld)),W.matrix.decompose(W.position,W.quaternion,W.scale),W.updateMatrixWorld(!0),W.projectionMatrix.copy($.projectionMatrix),W.projectionMatrixInverse.copy($.projectionMatrixInverse),W.isPerspectiveCamera&&(W.fov=er*2*Math.atan(1/W.projectionMatrix.elements[5]),W.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(d===null&&f===null))return l},this.setFoveation=function(W){l=W,d!==null&&(d.fixedFoveation=W),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=W)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(I)},this.getCameraTexture=function(W){return p[W]};let Ct=null;function Zt(W,$){if(h=$.getViewerPose(c||a),g=$,h!==null){const vt=h.views;f!==null&&(t.setRenderTargetFramebuffer(M,f.framebuffer),t.setRenderTarget(M));let Ft=!1;vt.length!==I.cameras.length&&(I.cameras.length=0,Ft=!0);for(let Gt=0;Gt<vt.length;Gt++){const J=vt[Gt];let rt=null;if(f!==null)rt=f.getViewport(J);else{const at=u.getViewSubImage(d,J);rt=at.viewport,Gt===0&&(t.setRenderTargetTextures(M,at.colorTexture,at.depthStencilTexture),t.setRenderTarget(M))}let tt=P[Gt];tt===void 0&&(tt=new yn,tt.layers.enable(Gt),tt.viewport=new Ee,P[Gt]=tt),tt.matrix.fromArray(J.transform.matrix),tt.matrix.decompose(tt.position,tt.quaternion,tt.scale),tt.projectionMatrix.fromArray(J.projectionMatrix),tt.projectionMatrixInverse.copy(tt.projectionMatrix).invert(),tt.viewport.set(rt.x,rt.y,rt.width,rt.height),Gt===0&&(I.matrix.copy(tt.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Ft===!0&&I.cameras.push(tt)}const Mt=s.enabledFeatures;if(Mt&&Mt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&x){u=n.getBinding();const Gt=u.getDepthInformation(vt[0]);Gt&&Gt.isValid&&Gt.texture&&m.init(Gt,s.renderState)}if(Mt&&Mt.includes("camera-access")&&x){t.state.unbindTexture(),u=n.getBinding();for(let Gt=0;Gt<vt.length;Gt++){const J=vt[Gt].camera;if(J){let rt=p[J];rt||(rt=new Uh,p[J]=rt);const tt=u.getCameraImage(J);rt.sourceTexture=tt}}}}for(let vt=0;vt<y.length;vt++){const Ft=T[vt],Mt=y[vt];Ft!==null&&Mt!==void 0&&Mt.update(Ft,$,c||a)}Ct&&Ct(W,$),$.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:$}),g=null}const Xt=new Zh;Xt.setAnimationLoop(Zt),this.setAnimationLoop=function(W){Ct=W},this.dispose=function(){}}}const Ui=new Ue,Nx=new ee;function Ux(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Rh(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,w,b,M){p.isMeshBasicMaterial||p.isMeshLambertMaterial?r(m,p):p.isMeshToonMaterial?(r(m,p),u(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p)):p.isMeshStandardMaterial?(r(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,M)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),x(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,w,b):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===an&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===an&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const w=t.get(p),b=w.envMap,M=w.envMapRotation;b&&(m.envMap.value=b,Ui.copy(M),Ui.x*=-1,Ui.y*=-1,Ui.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Ui.y*=-1,Ui.z*=-1),m.envMapRotation.value.setFromMatrix4(Nx.makeRotationFromEuler(Ui)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,w,b){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*w,m.scale.value=b*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,w){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===an&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function x(m,p){const w=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Ox(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,b){const M=b.program;n.uniformBlockBinding(w,M)}function c(w,b){let M=s[w.id];M===void 0&&(g(w),M=h(w),s[w.id]=M,w.addEventListener("dispose",m));const y=b.program;n.updateUBOMapping(w,y);const T=t.render.frame;r[w.id]!==T&&(d(w),r[w.id]=T)}function h(w){const b=u();w.__bindingPointIndex=b;const M=i.createBuffer(),y=w.__size,T=w.usage;return i.bindBuffer(i.UNIFORM_BUFFER,M),i.bufferData(i.UNIFORM_BUFFER,y,T),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,M),M}function u(){for(let w=0;w<o;w++)if(a.indexOf(w)===-1)return a.push(w),w;return ne("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(w){const b=s[w.id],M=w.uniforms,y=w.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let T=0,C=M.length;T<C;T++){const L=Array.isArray(M[T])?M[T]:[M[T]];for(let v=0,S=L.length;v<S;v++){const P=L[v];if(f(P,T,v,y)===!0){const I=P.__offset,F=Array.isArray(P.value)?P.value:[P.value];let B=0;for(let N=0;N<F.length;N++){const H=F[N],z=x(H);typeof H=="number"||typeof H=="boolean"?(P.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,I+B,P.__data)):H.isMatrix3?(P.__data[0]=H.elements[0],P.__data[1]=H.elements[1],P.__data[2]=H.elements[2],P.__data[3]=0,P.__data[4]=H.elements[3],P.__data[5]=H.elements[4],P.__data[6]=H.elements[5],P.__data[7]=0,P.__data[8]=H.elements[6],P.__data[9]=H.elements[7],P.__data[10]=H.elements[8],P.__data[11]=0):(H.toArray(P.__data,B),B+=z.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,I,P.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(w,b,M,y){const T=w.value,C=b+"_"+M;if(y[C]===void 0)return typeof T=="number"||typeof T=="boolean"?y[C]=T:y[C]=T.clone(),!0;{const L=y[C];if(typeof T=="number"||typeof T=="boolean"){if(L!==T)return y[C]=T,!0}else if(L.equals(T)===!1)return L.copy(T),!0}return!1}function g(w){const b=w.uniforms;let M=0;const y=16;for(let C=0,L=b.length;C<L;C++){const v=Array.isArray(b[C])?b[C]:[b[C]];for(let S=0,P=v.length;S<P;S++){const I=v[S],F=Array.isArray(I.value)?I.value:[I.value];for(let B=0,N=F.length;B<N;B++){const H=F[B],z=x(H),Z=M%y,st=Z%z.boundary,K=Z+st;M+=st,K!==0&&y-K<z.storage&&(M+=y-K),I.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=M,M+=z.storage}}}const T=M%y;return T>0&&(M+=y-T),w.__size=M,w.__cache={},this}function x(w){const b={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(b.boundary=4,b.storage=4):w.isVector2?(b.boundary=8,b.storage=8):w.isVector3||w.isColor?(b.boundary=16,b.storage=12):w.isVector4?(b.boundary=16,b.storage=16):w.isMatrix3?(b.boundary=48,b.storage=48):w.isMatrix4?(b.boundary=64,b.storage=64):w.isTexture?Ot("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ot("WebGLRenderer: Unsupported uniform value type.",w),b}function m(w){const b=w.target;b.removeEventListener("dispose",m);const M=a.indexOf(b.__bindingPointIndex);a.splice(M,1),i.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function p(){for(const w in s)i.deleteBuffer(s[w]);a=[],s={},r={}}return{bind:l,update:c,dispose:p}}const Bx=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Bn=null;function kx(){return Bn===null&&(Bn=new Fh(Bx,16,16,ys,li),Bn.name="DFG_LUT",Bn.minFilter=He,Bn.magFilter=He,Bn.wrapS=ni,Bn.wrapT=ni,Bn.generateMipmaps=!1,Bn.needsUpdate=!0),Bn}class zx{constructor(t={}){const{canvas:e=td(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=pn}=t;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const x=f,m=new Set([wl,Sl,yl]),p=new Set([pn,qn,js,Qs,_l,vl]),w=new Uint32Array(4),b=new Int32Array(4);let M=null,y=null;const T=[],C=[];let L=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Wn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const v=this;let S=!1;this._outputColorSpace=_n;let P=0,I=0,F=null,B=-1,N=null;const H=new Ee,z=new Ee;let Z=null;const st=new Bt(0);let K=0,Q=e.width,Lt=e.height,Ct=1,Zt=null,Xt=null;const W=new Ee(0,0,Q,Lt),$=new Ee(0,0,Q,Lt);let vt=!1;const Ft=new Al;let Mt=!1,Yt=!1;const Qt=new ee,Gt=new D,J=new Ee,rt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let tt=!1;function at(){return F===null?Ct:1}let R=n;function bt(E,k){return e.getContext(E,k)}try{const E={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${gl}`),e.addEventListener("webglcontextlost",Wt,!1),e.addEventListener("webglcontextrestored",ge,!1),e.addEventListener("webglcontextcreationerror",ce,!1),R===null){const k="webgl2";if(R=bt(k,E),R===null)throw bt(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw ne("WebGLRenderer: "+E.message),E}let xt,Ut,ht,A,_,O,Y,et,q,It,dt,Rt,Ht,ot,mt,Pt,Dt,pt,Kt,U,St,ct,wt,lt;function nt(){xt=new k0(R),xt.init(),ct=new Px(R,xt),Ut=new P0(R,xt,t,ct),ht=new Ax(R,xt),Ut.reversedDepthBuffer&&d&&ht.buffers.depth.setReversed(!0),A=new G0(R),_=new fx,O=new Rx(R,xt,ht,_,Ut,ct,A),Y=new L0(v),et=new B0(v),q=new Yf(R),wt=new A0(R,q),It=new z0(R,q,A,wt),dt=new W0(R,It,q,A),Kt=new V0(R,Ut,O),Pt=new I0(_),Rt=new dx(v,Y,et,xt,Ut,wt,Pt),Ht=new Ux(v,_),ot=new mx,mt=new yx(xt),pt=new C0(v,Y,et,ht,dt,g,l),Dt=new Tx(v,dt,Ut),lt=new Ox(R,A,Ut,ht),U=new R0(R,xt,A),St=new H0(R,xt,A),A.programs=Rt.programs,v.capabilities=Ut,v.extensions=xt,v.properties=_,v.renderLists=ot,v.shadowMap=Dt,v.state=ht,v.info=A}nt(),x!==pn&&(L=new Y0(x,e.width,e.height,s,r));const ft=new Fx(v,R);this.xr=ft,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const E=xt.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=xt.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return Ct},this.setPixelRatio=function(E){E!==void 0&&(Ct=E,this.setSize(Q,Lt,!1))},this.getSize=function(E){return E.set(Q,Lt)},this.setSize=function(E,k,X=!0){if(ft.isPresenting){Ot("WebGLRenderer: Can't change size while VR device is presenting.");return}Q=E,Lt=k,e.width=Math.floor(E*Ct),e.height=Math.floor(k*Ct),X===!0&&(e.style.width=E+"px",e.style.height=k+"px"),L!==null&&L.setSize(e.width,e.height),this.setViewport(0,0,E,k)},this.getDrawingBufferSize=function(E){return E.set(Q*Ct,Lt*Ct).floor()},this.setDrawingBufferSize=function(E,k,X){Q=E,Lt=k,Ct=X,e.width=Math.floor(E*X),e.height=Math.floor(k*X),this.setViewport(0,0,E,k)},this.setEffects=function(E){if(x===pn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let k=0;k<E.length;k++)if(E[k].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}L.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(H)},this.getViewport=function(E){return E.copy(W)},this.setViewport=function(E,k,X,V){E.isVector4?W.set(E.x,E.y,E.z,E.w):W.set(E,k,X,V),ht.viewport(H.copy(W).multiplyScalar(Ct).round())},this.getScissor=function(E){return E.copy($)},this.setScissor=function(E,k,X,V){E.isVector4?$.set(E.x,E.y,E.z,E.w):$.set(E,k,X,V),ht.scissor(z.copy($).multiplyScalar(Ct).round())},this.getScissorTest=function(){return vt},this.setScissorTest=function(E){ht.setScissorTest(vt=E)},this.setOpaqueSort=function(E){Zt=E},this.setTransparentSort=function(E){Xt=E},this.getClearColor=function(E){return E.copy(pt.getClearColor())},this.setClearColor=function(){pt.setClearColor(...arguments)},this.getClearAlpha=function(){return pt.getClearAlpha()},this.setClearAlpha=function(){pt.setClearAlpha(...arguments)},this.clear=function(E=!0,k=!0,X=!0){let V=0;if(E){let G=!1;if(F!==null){const gt=F.texture.format;G=m.has(gt)}if(G){const gt=F.texture.type,Et=p.has(gt),yt=pt.getClearColor(),At=pt.getClearAlpha(),Nt=yt.r,Vt=yt.g,kt=yt.b;Et?(w[0]=Nt,w[1]=Vt,w[2]=kt,w[3]=At,R.clearBufferuiv(R.COLOR,0,w)):(b[0]=Nt,b[1]=Vt,b[2]=kt,b[3]=At,R.clearBufferiv(R.COLOR,0,b))}else V|=R.COLOR_BUFFER_BIT}k&&(V|=R.DEPTH_BUFFER_BIT),X&&(V|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Wt,!1),e.removeEventListener("webglcontextrestored",ge,!1),e.removeEventListener("webglcontextcreationerror",ce,!1),pt.dispose(),ot.dispose(),mt.dispose(),_.dispose(),Y.dispose(),et.dispose(),dt.dispose(),wt.dispose(),lt.dispose(),Rt.dispose(),ft.dispose(),ft.removeEventListener("sessionstart",zl),ft.removeEventListener("sessionend",Hl),Ti.stop()};function Wt(E){E.preventDefault(),Qr("WebGLRenderer: Context Lost."),S=!0}function ge(){Qr("WebGLRenderer: Context Restored."),S=!1;const E=A.autoReset,k=Dt.enabled,X=Dt.autoUpdate,V=Dt.needsUpdate,G=Dt.type;nt(),A.autoReset=E,Dt.enabled=k,Dt.autoUpdate=X,Dt.needsUpdate=V,Dt.type=G}function ce(E){ne("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function On(E){const k=E.target;k.removeEventListener("dispose",On),$n(k)}function $n(E){pu(E),_.remove(E)}function pu(E){const k=_.get(E).programs;k!==void 0&&(k.forEach(function(X){Rt.releaseProgram(X)}),E.isShaderMaterial&&Rt.releaseShaderCache(E))}this.renderBufferDirect=function(E,k,X,V,G,gt){k===null&&(k=rt);const Et=G.isMesh&&G.matrixWorld.determinant()<0,yt=gu(E,k,X,V,G);ht.setMaterial(V,Et);let At=X.index,Nt=1;if(V.wireframe===!0){if(At=It.getWireframeAttribute(X),At===void 0)return;Nt=2}const Vt=X.drawRange,kt=X.attributes.position;let Jt=Vt.start*Nt,fe=(Vt.start+Vt.count)*Nt;gt!==null&&(Jt=Math.max(Jt,gt.start*Nt),fe=Math.min(fe,(gt.start+gt.count)*Nt)),At!==null?(Jt=Math.max(Jt,0),fe=Math.min(fe,At.count)):kt!=null&&(Jt=Math.max(Jt,0),fe=Math.min(fe,kt.count));const ve=fe-Jt;if(ve<0||ve===1/0)return;wt.setup(G,V,yt,X,At);let Me,pe=U;if(At!==null&&(Me=q.get(At),pe=St,pe.setIndex(Me)),G.isMesh)V.wireframe===!0?(ht.setLineWidth(V.wireframeLinewidth*at()),pe.setMode(R.LINES)):pe.setMode(R.TRIANGLES);else if(G.isLine){let zt=V.linewidth;zt===void 0&&(zt=1),ht.setLineWidth(zt*at()),G.isLineSegments?pe.setMode(R.LINES):G.isLineLoop?pe.setMode(R.LINE_LOOP):pe.setMode(R.LINE_STRIP)}else G.isPoints?pe.setMode(R.POINTS):G.isSprite&&pe.setMode(R.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)tr("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),pe.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(xt.get("WEBGL_multi_draw"))pe.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const zt=G._multiDrawStarts,he=G._multiDrawCounts,re=G._multiDrawCount,ln=At?q.get(At).bytesPerElement:1,Yi=_.get(V).currentProgram.getUniforms();for(let cn=0;cn<re;cn++)Yi.setValue(R,"_gl_DrawID",cn),pe.render(zt[cn]/ln,he[cn])}else if(G.isInstancedMesh)pe.renderInstances(Jt,ve,G.count);else if(X.isInstancedBufferGeometry){const zt=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,he=Math.min(X.instanceCount,zt);pe.renderInstances(Jt,ve,he)}else pe.render(Jt,ve)};function kl(E,k,X){E.transparent===!0&&E.side===Fe&&E.forceSinglePass===!1?(E.side=an,E.needsUpdate=!0,hr(E,k,X),E.side=bi,E.needsUpdate=!0,hr(E,k,X),E.side=Fe):hr(E,k,X)}this.compile=function(E,k,X=null){X===null&&(X=E),y=mt.get(X),y.init(k),C.push(y),X.traverseVisible(function(G){G.isLight&&G.layers.test(k.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),E!==X&&E.traverseVisible(function(G){G.isLight&&G.layers.test(k.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),y.setupLights();const V=new Set;return E.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const gt=G.material;if(gt)if(Array.isArray(gt))for(let Et=0;Et<gt.length;Et++){const yt=gt[Et];kl(yt,X,G),V.add(yt)}else kl(gt,X,G),V.add(gt)}),y=C.pop(),V},this.compileAsync=function(E,k,X=null){const V=this.compile(E,k,X);return new Promise(G=>{function gt(){if(V.forEach(function(Et){_.get(Et).currentProgram.isReady()&&V.delete(Et)}),V.size===0){G(E);return}setTimeout(gt,10)}xt.get("KHR_parallel_shader_compile")!==null?gt():setTimeout(gt,10)})};let xa=null;function mu(E){xa&&xa(E)}function zl(){Ti.stop()}function Hl(){Ti.start()}const Ti=new Zh;Ti.setAnimationLoop(mu),typeof self<"u"&&Ti.setContext(self),this.setAnimationLoop=function(E){xa=E,ft.setAnimationLoop(E),E===null?Ti.stop():Ti.start()},ft.addEventListener("sessionstart",zl),ft.addEventListener("sessionend",Hl),this.render=function(E,k){if(k!==void 0&&k.isCamera!==!0){ne("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;const X=ft.enabled===!0&&ft.isPresenting===!0,V=L!==null&&(F===null||X)&&L.begin(v,F);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),ft.enabled===!0&&ft.isPresenting===!0&&(L===null||L.isCompositing()===!1)&&(ft.cameraAutoUpdate===!0&&ft.updateCamera(k),k=ft.getCamera()),E.isScene===!0&&E.onBeforeRender(v,E,k,F),y=mt.get(E,C.length),y.init(k),C.push(y),Qt.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),Ft.setFromProjectionMatrix(Qt,Hn,k.reversedDepth),Yt=this.localClippingEnabled,Mt=Pt.init(this.clippingPlanes,Yt),M=ot.get(E,T.length),M.init(),T.push(M),ft.enabled===!0&&ft.isPresenting===!0){const Et=v.xr.getDepthSensingMesh();Et!==null&&_a(Et,k,-1/0,v.sortObjects)}_a(E,k,0,v.sortObjects),M.finish(),v.sortObjects===!0&&M.sort(Zt,Xt),tt=ft.enabled===!1||ft.isPresenting===!1||ft.hasDepthSensing()===!1,tt&&pt.addToRenderList(M,E),this.info.render.frame++,Mt===!0&&Pt.beginShadows();const G=y.state.shadowsArray;if(Dt.render(G,E,k),Mt===!0&&Pt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(V&&L.hasRenderPass())===!1){const Et=M.opaque,yt=M.transmissive;if(y.setupLights(),k.isArrayCamera){const At=k.cameras;if(yt.length>0)for(let Nt=0,Vt=At.length;Nt<Vt;Nt++){const kt=At[Nt];Vl(Et,yt,E,kt)}tt&&pt.render(E);for(let Nt=0,Vt=At.length;Nt<Vt;Nt++){const kt=At[Nt];Gl(M,E,kt,kt.viewport)}}else yt.length>0&&Vl(Et,yt,E,k),tt&&pt.render(E),Gl(M,E,k)}F!==null&&I===0&&(O.updateMultisampleRenderTarget(F),O.updateRenderTargetMipmap(F)),V&&L.end(v),E.isScene===!0&&E.onAfterRender(v,E,k),wt.resetDefaultState(),B=-1,N=null,C.pop(),C.length>0?(y=C[C.length-1],Mt===!0&&Pt.setGlobalState(v.clippingPlanes,y.state.camera)):y=null,T.pop(),T.length>0?M=T[T.length-1]:M=null};function _a(E,k,X,V){if(E.visible===!1)return;if(E.layers.test(k.layers)){if(E.isGroup)X=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(k);else if(E.isLight)y.pushLight(E),E.castShadow&&y.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Ft.intersectsSprite(E)){V&&J.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Qt);const Et=dt.update(E),yt=E.material;yt.visible&&M.push(E,Et,yt,X,J.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Ft.intersectsObject(E))){const Et=dt.update(E),yt=E.material;if(V&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),J.copy(E.boundingSphere.center)):(Et.boundingSphere===null&&Et.computeBoundingSphere(),J.copy(Et.boundingSphere.center)),J.applyMatrix4(E.matrixWorld).applyMatrix4(Qt)),Array.isArray(yt)){const At=Et.groups;for(let Nt=0,Vt=At.length;Nt<Vt;Nt++){const kt=At[Nt],Jt=yt[kt.materialIndex];Jt&&Jt.visible&&M.push(E,Et,Jt,X,J.z,kt)}}else yt.visible&&M.push(E,Et,yt,X,J.z,null)}}const gt=E.children;for(let Et=0,yt=gt.length;Et<yt;Et++)_a(gt[Et],k,X,V)}function Gl(E,k,X,V){const{opaque:G,transmissive:gt,transparent:Et}=E;y.setupLightsView(X),Mt===!0&&Pt.setGlobalState(v.clippingPlanes,X),V&&ht.viewport(H.copy(V)),G.length>0&&cr(G,k,X),gt.length>0&&cr(gt,k,X),Et.length>0&&cr(Et,k,X),ht.buffers.depth.setTest(!0),ht.buffers.depth.setMask(!0),ht.buffers.color.setMask(!0),ht.setPolygonOffset(!1)}function Vl(E,k,X,V){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[V.id]===void 0){const Jt=xt.has("EXT_color_buffer_half_float")||xt.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[V.id]=new Yn(1,1,{generateMipmaps:!0,type:Jt?li:pn,minFilter:zi,samples:Ut.samples,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:se.workingColorSpace})}const gt=y.state.transmissionRenderTarget[V.id],Et=V.viewport||H;gt.setSize(Et.z*v.transmissionResolutionScale,Et.w*v.transmissionResolutionScale);const yt=v.getRenderTarget(),At=v.getActiveCubeFace(),Nt=v.getActiveMipmapLevel();v.setRenderTarget(gt),v.getClearColor(st),K=v.getClearAlpha(),K<1&&v.setClearColor(16777215,.5),v.clear(),tt&&pt.render(X);const Vt=v.toneMapping;v.toneMapping=Wn;const kt=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),y.setupLightsView(V),Mt===!0&&Pt.setGlobalState(v.clippingPlanes,V),cr(E,X,V),O.updateMultisampleRenderTarget(gt),O.updateRenderTargetMipmap(gt),xt.has("WEBGL_multisampled_render_to_texture")===!1){let Jt=!1;for(let fe=0,ve=k.length;fe<ve;fe++){const Me=k[fe],{object:pe,geometry:zt,material:he,group:re}=Me;if(he.side===Fe&&pe.layers.test(V.layers)){const ln=he.side;he.side=an,he.needsUpdate=!0,Wl(pe,X,V,zt,he,re),he.side=ln,he.needsUpdate=!0,Jt=!0}}Jt===!0&&(O.updateMultisampleRenderTarget(gt),O.updateRenderTargetMipmap(gt))}v.setRenderTarget(yt,At,Nt),v.setClearColor(st,K),kt!==void 0&&(V.viewport=kt),v.toneMapping=Vt}function cr(E,k,X){const V=k.isScene===!0?k.overrideMaterial:null;for(let G=0,gt=E.length;G<gt;G++){const Et=E[G],{object:yt,geometry:At,group:Nt}=Et;let Vt=Et.material;Vt.allowOverride===!0&&V!==null&&(Vt=V),yt.layers.test(X.layers)&&Wl(yt,k,X,At,Vt,Nt)}}function Wl(E,k,X,V,G,gt){E.onBeforeRender(v,k,X,V,G,gt),E.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),G.onBeforeRender(v,k,X,V,E,gt),G.transparent===!0&&G.side===Fe&&G.forceSinglePass===!1?(G.side=an,G.needsUpdate=!0,v.renderBufferDirect(X,k,V,G,E,gt),G.side=bi,G.needsUpdate=!0,v.renderBufferDirect(X,k,V,G,E,gt),G.side=Fe):v.renderBufferDirect(X,k,V,G,E,gt),E.onAfterRender(v,k,X,V,G,gt)}function hr(E,k,X){k.isScene!==!0&&(k=rt);const V=_.get(E),G=y.state.lights,gt=y.state.shadowsArray,Et=G.state.version,yt=Rt.getParameters(E,G.state,gt,k,X),At=Rt.getProgramCacheKey(yt);let Nt=V.programs;V.environment=E.isMeshStandardMaterial?k.environment:null,V.fog=k.fog,V.envMap=(E.isMeshStandardMaterial?et:Y).get(E.envMap||V.environment),V.envMapRotation=V.environment!==null&&E.envMap===null?k.environmentRotation:E.envMapRotation,Nt===void 0&&(E.addEventListener("dispose",On),Nt=new Map,V.programs=Nt);let Vt=Nt.get(At);if(Vt!==void 0){if(V.currentProgram===Vt&&V.lightsStateVersion===Et)return Yl(E,yt),Vt}else yt.uniforms=Rt.getUniforms(E),E.onBeforeCompile(yt,v),Vt=Rt.acquireProgram(yt,At),Nt.set(At,Vt),V.uniforms=yt.uniforms;const kt=V.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(kt.clippingPlanes=Pt.uniform),Yl(E,yt),V.needsLights=_u(E),V.lightsStateVersion=Et,V.needsLights&&(kt.ambientLightColor.value=G.state.ambient,kt.lightProbe.value=G.state.probe,kt.directionalLights.value=G.state.directional,kt.directionalLightShadows.value=G.state.directionalShadow,kt.spotLights.value=G.state.spot,kt.spotLightShadows.value=G.state.spotShadow,kt.rectAreaLights.value=G.state.rectArea,kt.ltc_1.value=G.state.rectAreaLTC1,kt.ltc_2.value=G.state.rectAreaLTC2,kt.pointLights.value=G.state.point,kt.pointLightShadows.value=G.state.pointShadow,kt.hemisphereLights.value=G.state.hemi,kt.directionalShadowMap.value=G.state.directionalShadowMap,kt.directionalShadowMatrix.value=G.state.directionalShadowMatrix,kt.spotShadowMap.value=G.state.spotShadowMap,kt.spotLightMatrix.value=G.state.spotLightMatrix,kt.spotLightMap.value=G.state.spotLightMap,kt.pointShadowMap.value=G.state.pointShadowMap,kt.pointShadowMatrix.value=G.state.pointShadowMatrix),V.currentProgram=Vt,V.uniformsList=null,Vt}function Xl(E){if(E.uniformsList===null){const k=E.currentProgram.getUniforms();E.uniformsList=qr.seqWithValue(k.seq,E.uniforms)}return E.uniformsList}function Yl(E,k){const X=_.get(E);X.outputColorSpace=k.outputColorSpace,X.batching=k.batching,X.batchingColor=k.batchingColor,X.instancing=k.instancing,X.instancingColor=k.instancingColor,X.instancingMorph=k.instancingMorph,X.skinning=k.skinning,X.morphTargets=k.morphTargets,X.morphNormals=k.morphNormals,X.morphColors=k.morphColors,X.morphTargetsCount=k.morphTargetsCount,X.numClippingPlanes=k.numClippingPlanes,X.numIntersection=k.numClipIntersection,X.vertexAlphas=k.vertexAlphas,X.vertexTangents=k.vertexTangents,X.toneMapping=k.toneMapping}function gu(E,k,X,V,G){k.isScene!==!0&&(k=rt),O.resetTextureUnits();const gt=k.fog,Et=V.isMeshStandardMaterial?k.environment:null,yt=F===null?v.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Ss,At=(V.isMeshStandardMaterial?et:Y).get(V.envMap||Et),Nt=V.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,Vt=!!X.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),kt=!!X.morphAttributes.position,Jt=!!X.morphAttributes.normal,fe=!!X.morphAttributes.color;let ve=Wn;V.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(ve=v.toneMapping);const Me=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,pe=Me!==void 0?Me.length:0,zt=_.get(V),he=y.state.lights;if(Mt===!0&&(Yt===!0||E!==N)){const $e=E===N&&V.id===B;Pt.setState(V,E,$e)}let re=!1;V.version===zt.__version?(zt.needsLights&&zt.lightsStateVersion!==he.state.version||zt.outputColorSpace!==yt||G.isBatchedMesh&&zt.batching===!1||!G.isBatchedMesh&&zt.batching===!0||G.isBatchedMesh&&zt.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&zt.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&zt.instancing===!1||!G.isInstancedMesh&&zt.instancing===!0||G.isSkinnedMesh&&zt.skinning===!1||!G.isSkinnedMesh&&zt.skinning===!0||G.isInstancedMesh&&zt.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&zt.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&zt.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&zt.instancingMorph===!1&&G.morphTexture!==null||zt.envMap!==At||V.fog===!0&&zt.fog!==gt||zt.numClippingPlanes!==void 0&&(zt.numClippingPlanes!==Pt.numPlanes||zt.numIntersection!==Pt.numIntersection)||zt.vertexAlphas!==Nt||zt.vertexTangents!==Vt||zt.morphTargets!==kt||zt.morphNormals!==Jt||zt.morphColors!==fe||zt.toneMapping!==ve||zt.morphTargetsCount!==pe)&&(re=!0):(re=!0,zt.__version=V.version);let ln=zt.currentProgram;re===!0&&(ln=hr(V,k,G));let Yi=!1,cn=!1,Rs=!1;const xe=ln.getUniforms(),nn=zt.uniforms;if(ht.useProgram(ln.program)&&(Yi=!0,cn=!0,Rs=!0),V.id!==B&&(B=V.id,cn=!0),Yi||N!==E){ht.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),xe.setValue(R,"projectionMatrix",E.projectionMatrix),xe.setValue(R,"viewMatrix",E.matrixWorldInverse);const sn=xe.map.cameraPosition;sn!==void 0&&sn.setValue(R,Gt.setFromMatrixPosition(E.matrixWorld)),Ut.logarithmicDepthBuffer&&xe.setValue(R,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&xe.setValue(R,"isOrthographic",E.isOrthographicCamera===!0),N!==E&&(N=E,cn=!0,Rs=!0)}if(zt.needsLights&&(he.state.directionalShadowMap.length>0&&xe.setValue(R,"directionalShadowMap",he.state.directionalShadowMap,O),he.state.spotShadowMap.length>0&&xe.setValue(R,"spotShadowMap",he.state.spotShadowMap,O),he.state.pointShadowMap.length>0&&xe.setValue(R,"pointShadowMap",he.state.pointShadowMap,O)),G.isSkinnedMesh){xe.setOptional(R,G,"bindMatrix"),xe.setOptional(R,G,"bindMatrixInverse");const $e=G.skeleton;$e&&($e.boneTexture===null&&$e.computeBoneTexture(),xe.setValue(R,"boneTexture",$e.boneTexture,O))}G.isBatchedMesh&&(xe.setOptional(R,G,"batchingTexture"),xe.setValue(R,"batchingTexture",G._matricesTexture,O),xe.setOptional(R,G,"batchingIdTexture"),xe.setValue(R,"batchingIdTexture",G._indirectTexture,O),xe.setOptional(R,G,"batchingColorTexture"),G._colorsTexture!==null&&xe.setValue(R,"batchingColorTexture",G._colorsTexture,O));const mn=X.morphAttributes;if((mn.position!==void 0||mn.normal!==void 0||mn.color!==void 0)&&Kt.update(G,X,ln),(cn||zt.receiveShadow!==G.receiveShadow)&&(zt.receiveShadow=G.receiveShadow,xe.setValue(R,"receiveShadow",G.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(nn.envMap.value=At,nn.flipEnvMap.value=At.isCubeTexture&&At.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&k.environment!==null&&(nn.envMapIntensity.value=k.environmentIntensity),nn.dfgLUT!==void 0&&(nn.dfgLUT.value=kx()),cn&&(xe.setValue(R,"toneMappingExposure",v.toneMappingExposure),zt.needsLights&&xu(nn,Rs),gt&&V.fog===!0&&Ht.refreshFogUniforms(nn,gt),Ht.refreshMaterialUniforms(nn,V,Ct,Lt,y.state.transmissionRenderTarget[E.id]),qr.upload(R,Xl(zt),nn,O)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(qr.upload(R,Xl(zt),nn,O),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&xe.setValue(R,"center",G.center),xe.setValue(R,"modelViewMatrix",G.modelViewMatrix),xe.setValue(R,"normalMatrix",G.normalMatrix),xe.setValue(R,"modelMatrix",G.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const $e=V.uniformsGroups;for(let sn=0,va=$e.length;sn<va;sn++){const Ci=$e[sn];lt.update(Ci,ln),lt.bind(Ci,ln)}}return ln}function xu(E,k){E.ambientLightColor.needsUpdate=k,E.lightProbe.needsUpdate=k,E.directionalLights.needsUpdate=k,E.directionalLightShadows.needsUpdate=k,E.pointLights.needsUpdate=k,E.pointLightShadows.needsUpdate=k,E.spotLights.needsUpdate=k,E.spotLightShadows.needsUpdate=k,E.rectAreaLights.needsUpdate=k,E.hemisphereLights.needsUpdate=k}function _u(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(E,k,X){const V=_.get(E);V.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),_.get(E.texture).__webglTexture=k,_.get(E.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:X,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,k){const X=_.get(E);X.__webglFramebuffer=k,X.__useDefaultFramebuffer=k===void 0};const vu=R.createFramebuffer();this.setRenderTarget=function(E,k=0,X=0){F=E,P=k,I=X;let V=null,G=!1,gt=!1;if(E){const yt=_.get(E);if(yt.__useDefaultFramebuffer!==void 0){ht.bindFramebuffer(R.FRAMEBUFFER,yt.__webglFramebuffer),H.copy(E.viewport),z.copy(E.scissor),Z=E.scissorTest,ht.viewport(H),ht.scissor(z),ht.setScissorTest(Z),B=-1;return}else if(yt.__webglFramebuffer===void 0)O.setupRenderTarget(E);else if(yt.__hasExternalTextures)O.rebindTextures(E,_.get(E.texture).__webglTexture,_.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const Vt=E.depthTexture;if(yt.__boundDepthTexture!==Vt){if(Vt!==null&&_.has(Vt)&&(E.width!==Vt.image.width||E.height!==Vt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");O.setupDepthRenderbuffer(E)}}const At=E.texture;(At.isData3DTexture||At.isDataArrayTexture||At.isCompressedArrayTexture)&&(gt=!0);const Nt=_.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Nt[k])?V=Nt[k][X]:V=Nt[k],G=!0):E.samples>0&&O.useMultisampledRTT(E)===!1?V=_.get(E).__webglMultisampledFramebuffer:Array.isArray(Nt)?V=Nt[X]:V=Nt,H.copy(E.viewport),z.copy(E.scissor),Z=E.scissorTest}else H.copy(W).multiplyScalar(Ct).floor(),z.copy($).multiplyScalar(Ct).floor(),Z=vt;if(X!==0&&(V=vu),ht.bindFramebuffer(R.FRAMEBUFFER,V)&&ht.drawBuffers(E,V),ht.viewport(H),ht.scissor(z),ht.setScissorTest(Z),G){const yt=_.get(E.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+k,yt.__webglTexture,X)}else if(gt){const yt=k;for(let At=0;At<E.textures.length;At++){const Nt=_.get(E.textures[At]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+At,Nt.__webglTexture,X,yt)}}else if(E!==null&&X!==0){const yt=_.get(E.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,yt.__webglTexture,X)}B=-1},this.readRenderTargetPixels=function(E,k,X,V,G,gt,Et,yt=0){if(!(E&&E.isWebGLRenderTarget)){ne("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let At=_.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Et!==void 0&&(At=At[Et]),At){ht.bindFramebuffer(R.FRAMEBUFFER,At);try{const Nt=E.textures[yt],Vt=Nt.format,kt=Nt.type;if(!Ut.textureFormatReadable(Vt)){ne("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ut.textureTypeReadable(kt)){ne("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=E.width-V&&X>=0&&X<=E.height-G&&(E.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+yt),R.readPixels(k,X,V,G,ct.convert(Vt),ct.convert(kt),gt))}finally{const Nt=F!==null?_.get(F).__webglFramebuffer:null;ht.bindFramebuffer(R.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(E,k,X,V,G,gt,Et,yt=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let At=_.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Et!==void 0&&(At=At[Et]),At)if(k>=0&&k<=E.width-V&&X>=0&&X<=E.height-G){ht.bindFramebuffer(R.FRAMEBUFFER,At);const Nt=E.textures[yt],Vt=Nt.format,kt=Nt.type;if(!Ut.textureFormatReadable(Vt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ut.textureTypeReadable(kt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Jt=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,Jt),R.bufferData(R.PIXEL_PACK_BUFFER,gt.byteLength,R.STREAM_READ),E.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+yt),R.readPixels(k,X,V,G,ct.convert(Vt),ct.convert(kt),0);const fe=F!==null?_.get(F).__webglFramebuffer:null;ht.bindFramebuffer(R.FRAMEBUFFER,fe);const ve=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await ed(R,ve,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,Jt),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,gt),R.deleteBuffer(Jt),R.deleteSync(ve),gt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,k=null,X=0){const V=Math.pow(2,-X),G=Math.floor(E.image.width*V),gt=Math.floor(E.image.height*V),Et=k!==null?k.x:0,yt=k!==null?k.y:0;O.setTexture2D(E,0),R.copyTexSubImage2D(R.TEXTURE_2D,X,0,0,Et,yt,G,gt),ht.unbindTexture()};const Mu=R.createFramebuffer(),yu=R.createFramebuffer();this.copyTextureToTexture=function(E,k,X=null,V=null,G=0,gt=null){gt===null&&(G!==0?(tr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),gt=G,G=0):gt=0);let Et,yt,At,Nt,Vt,kt,Jt,fe,ve;const Me=E.isCompressedTexture?E.mipmaps[gt]:E.image;if(X!==null)Et=X.max.x-X.min.x,yt=X.max.y-X.min.y,At=X.isBox3?X.max.z-X.min.z:1,Nt=X.min.x,Vt=X.min.y,kt=X.isBox3?X.min.z:0;else{const mn=Math.pow(2,-G);Et=Math.floor(Me.width*mn),yt=Math.floor(Me.height*mn),E.isDataArrayTexture?At=Me.depth:E.isData3DTexture?At=Math.floor(Me.depth*mn):At=1,Nt=0,Vt=0,kt=0}V!==null?(Jt=V.x,fe=V.y,ve=V.z):(Jt=0,fe=0,ve=0);const pe=ct.convert(k.format),zt=ct.convert(k.type);let he;k.isData3DTexture?(O.setTexture3D(k,0),he=R.TEXTURE_3D):k.isDataArrayTexture||k.isCompressedArrayTexture?(O.setTexture2DArray(k,0),he=R.TEXTURE_2D_ARRAY):(O.setTexture2D(k,0),he=R.TEXTURE_2D),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,k.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,k.unpackAlignment);const re=R.getParameter(R.UNPACK_ROW_LENGTH),ln=R.getParameter(R.UNPACK_IMAGE_HEIGHT),Yi=R.getParameter(R.UNPACK_SKIP_PIXELS),cn=R.getParameter(R.UNPACK_SKIP_ROWS),Rs=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,Me.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Me.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Nt),R.pixelStorei(R.UNPACK_SKIP_ROWS,Vt),R.pixelStorei(R.UNPACK_SKIP_IMAGES,kt);const xe=E.isDataArrayTexture||E.isData3DTexture,nn=k.isDataArrayTexture||k.isData3DTexture;if(E.isDepthTexture){const mn=_.get(E),$e=_.get(k),sn=_.get(mn.__renderTarget),va=_.get($e.__renderTarget);ht.bindFramebuffer(R.READ_FRAMEBUFFER,sn.__webglFramebuffer),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,va.__webglFramebuffer);for(let Ci=0;Ci<At;Ci++)xe&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,_.get(E).__webglTexture,G,kt+Ci),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,_.get(k).__webglTexture,gt,ve+Ci)),R.blitFramebuffer(Nt,Vt,Et,yt,Jt,fe,Et,yt,R.DEPTH_BUFFER_BIT,R.NEAREST);ht.bindFramebuffer(R.READ_FRAMEBUFFER,null),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(G!==0||E.isRenderTargetTexture||_.has(E)){const mn=_.get(E),$e=_.get(k);ht.bindFramebuffer(R.READ_FRAMEBUFFER,Mu),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,yu);for(let sn=0;sn<At;sn++)xe?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,mn.__webglTexture,G,kt+sn):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,mn.__webglTexture,G),nn?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,$e.__webglTexture,gt,ve+sn):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,$e.__webglTexture,gt),G!==0?R.blitFramebuffer(Nt,Vt,Et,yt,Jt,fe,Et,yt,R.COLOR_BUFFER_BIT,R.NEAREST):nn?R.copyTexSubImage3D(he,gt,Jt,fe,ve+sn,Nt,Vt,Et,yt):R.copyTexSubImage2D(he,gt,Jt,fe,Nt,Vt,Et,yt);ht.bindFramebuffer(R.READ_FRAMEBUFFER,null),ht.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else nn?E.isDataTexture||E.isData3DTexture?R.texSubImage3D(he,gt,Jt,fe,ve,Et,yt,At,pe,zt,Me.data):k.isCompressedArrayTexture?R.compressedTexSubImage3D(he,gt,Jt,fe,ve,Et,yt,At,pe,Me.data):R.texSubImage3D(he,gt,Jt,fe,ve,Et,yt,At,pe,zt,Me):E.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,gt,Jt,fe,Et,yt,pe,zt,Me.data):E.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,gt,Jt,fe,Me.width,Me.height,pe,Me.data):R.texSubImage2D(R.TEXTURE_2D,gt,Jt,fe,Et,yt,pe,zt,Me);R.pixelStorei(R.UNPACK_ROW_LENGTH,re),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,ln),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Yi),R.pixelStorei(R.UNPACK_SKIP_ROWS,cn),R.pixelStorei(R.UNPACK_SKIP_IMAGES,Rs),gt===0&&k.generateMipmaps&&R.generateMipmap(he),ht.unbindTexture()},this.initRenderTarget=function(E){_.get(E).__webglFramebuffer===void 0&&O.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?O.setTextureCube(E,0):E.isData3DTexture?O.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?O.setTexture2DArray(E,0):O.setTexture2D(E,0),ht.unbindTexture()},this.resetState=function(){P=0,I=0,F=null,ht.reset(),wt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Hn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=se._getDrawingBufferColorSpace(t),e.unpackColorSpace=se._getUnpackColorSpace()}}let Ie,Ln,Dn;function Hx(){Cesium.Ion.defaultAccessToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIzMzA1M2Q0MC01YzY1LTRkNDMtYWYzMS05MDdmZmI2MzAwYjYiLCJpZCI6NDA5NTYwLCJpYXQiOjE3NzQ1NDA1MjR9.szCoX8ALGsZ-jqCF6lvDtejplRGt2AJmQjZ2G7_51G0";let i;try{i=Cesium.Terrain.fromWorldTerrain()}catch{console.warn("Cesium World Terrain unavailable, using ellipsoid"),i=void 0}Ie=new Cesium.Viewer("cesiumContainer",{terrain:i,timeline:!1,animation:!1,baseLayerPicker:!1,geocoder:!1,homeButton:!1,infoBox:!1,sceneModePicker:!1,selectionIndicator:!1,navigationHelpButton:!1,fullscreenButton:!1,shouldAnimate:!1}),Ln=new Cesium.Viewer("minimapCesium",{terrain:null,timeline:!1,animation:!1,baseLayerPicker:!1,geocoder:!1,homeButton:!1,infoBox:!1,sceneModePicker:!1,selectionIndicator:!1,navigationHelpButton:!1,fullscreenButton:!1,shouldAnimate:!1,skyBox:!1,skyAtmosphere:!1,contextOptions:{webgl:{preserveDrawingBuffer:!0}}}),Dn=new Cesium.Viewer("pauseMinimapCesium",{terrain:null,timeline:!1,animation:!1,baseLayerPicker:!1,geocoder:!1,homeButton:!1,infoBox:!1,sceneModePicker:!1,selectionIndicator:!1,navigationHelpButton:!1,fullscreenButton:!1,shouldAnimate:!1,skyBox:!1,skyAtmosphere:!1,contextOptions:{webgl:{preserveDrawingBuffer:!0}}}),[Ie,Ln,Dn].forEach(t=>{t.scene.requestRenderMode=!1,t.scene.maximumRenderTimeChange=0,t.scene.globe.maximumScreenSpaceError=2,t.resolutionScale=.75,t.scene.screenSpaceCameraController.enableRotate=!1,t.scene.screenSpaceCameraController.enableTranslate=!1,t.scene.screenSpaceCameraController.enableZoom=!1,t.scene.screenSpaceCameraController.enableTilt=!1,t.scene.screenSpaceCameraController.enableLook=!1,t.scene.screenSpaceCameraController.maximumZoomDistance=25e6,t.scene.globe.tileCacheSize=2048,t.scene.globe.preloadAncestors=!0,t.scene.globe.preloadSiblings=!0,t.scene.globe.loadingDescendantLimit=20,t.scene.globe.skipLevelOfDetail=!0,t.scene.globe.baseScreenSpaceError=1024,t.scene.globe.skipScreenSpaceErrorFactor=16,t.scene.globe.skipLevels=1,t._cesiumWidget._creditContainer.style.display="none"}),Ie.scene.globe.baseColor=Cesium.Color.fromCssColorString("#1a3a1a");try{Ie.scene.globe.tileFailed&&Ie.scene.globe.tileFailed.addEventListener(()=>{})}catch{}return[Ln,Dn].forEach(t=>{t.scene.globe.enableLighting=!1,t.scene.globe.showGroundAtmosphere=!1,t.scene.fog.enabled=!1,t.scene.highDynamicRange=!1,t.scene.postProcessStages.fxaa.enabled=!1,t.resolutionScale=1,t.scene.globe.maximumScreenSpaceError=2,t.scene.globe.baseColor=Cesium.Color.BLACK,t.scene.skyAtmosphere&&(t.scene.skyAtmosphere.show=!1)}),Ie.scene.globe.enableLighting=!0,Ie.scene.highDynamicRange=!1,Ie.scene.postProcessStages.fxaa.enabled=!0,Ie.scene.skyAtmosphere=new Cesium.SkyAtmosphere,Ie.scene.fog.enabled=!0,Ie.scene.fog.density=1e-4,ga(!1),Ie}function Fl(i){!Ie||!Ln||!Dn||[Ie,Ln,Dn].forEach(t=>{t.scene.requestRenderMode=!i,t.scene.maximumRenderTimeChange=i?0:1/0})}function ga(i){if(!Ie)return;const t=Ie.scene.screenSpaceCameraController;t.enableRotate=i,t.enableTranslate=i,t.enableZoom=i,t.enableTilt=i,t.enableLook=i}function Gx(i,t,e,n,s,r){Ie&&(Ie.camera.setView({destination:Cesium.Cartesian3.fromDegrees(i,t,e),orientation:{heading:Cesium.Math.toRadians(n),pitch:Cesium.Math.toRadians(s),roll:Cesium.Math.toRadians(r)}}),Ie.scene.requestRender())}function Vx(i,t,e,n){Ln&&(Ln.canvas.width===0||Ln.canvas.height===0||(Ln.camera.setView({destination:Cesium.Cartesian3.fromDegrees(i,t,e),orientation:{heading:Cesium.Math.toRadians(n),pitch:Cesium.Math.toRadians(-90),roll:0}}),Ln.scene.requestRender()))}function Wx(i,t,e,n){Dn&&(Dn.canvas.width===0||Dn.canvas.height===0||(Dn.camera.setView({destination:Cesium.Cartesian3.fromDegrees(i,t,e),orientation:{heading:Cesium.Math.toRadians(n),pitch:Cesium.Math.toRadians(-90),roll:0}}),Dn.scene.requestRender()))}function we(){return Ie}function Xx(){return Ln}function Yx(){return Dn}class Qh{constructor(){this.speed=15,this.maxSpeed=50,this.minSpeed=4,this.maxDiveSpeed=120,this.turboSpeed=400,this.mass=5,this.wingArea=.65,this.wingspan=2.1,this.aspectRatio=this.wingspan*this.wingspan/this.wingArea,this.clMax=1.6,this.cd0=.02,this.cdWingSpread=.008,this.k=1/(Math.PI*this.aspectRatio*.85),this.isFlapping=!1,this.flapStrength=0,this.flapCooldown=0,this.flapCycleDuration=.35,this.flapThrustImpulse=25,this.flapLiftImpulse=15,this.flapDecay=3,this.flapInput=!1,this.flapPrevInput=!1,this.gravity=9.8,this.airDensity=1.225,this.isGliding=!0,this.wingSpread=1,this.verticalSpeed=0,this.glideRatio=20,this.thermalLift=0,this.thermalStrength=0,this.thermalTimer=0,this.inThermal=!1,this.pitch=0,this.roll=0,this.heading=0,this.pitchRate=2,this.rollRate=3.2,this.yawRate=1,this.isBoosting=!1,this.boostTimeRemaining=0,this.boostDuration=4,this.boostMultiplier=2.5,this.boostRotations=0,this.boostPressed=!1,this.isTurbo=!1,this.turboPressed=!1,this.turboWindup=0,this.throttle=0,this.quaternion=new qe}boost(){this.boostTimeRemaining<=0&&(this.isBoosting=!0,this.boostTimeRemaining=this.boostDuration)}reset(t,e,n,s,r,a){this.heading=s||0,this.pitch=r||0,this.roll=a||0,this.speed=15,this.verticalSpeed=0,this.thermalLift=0,this.thermalStrength=0,this.isGliding=!0,this.isFlapping=!1,this.flapStrength=0,this.flapCooldown=0,this.wingSpread=1,this.isTurbo=!1,this.turboWindup=0;const o=new Ue(Se.degToRad(this.pitch),Se.degToRad(this.heading),Se.degToRad(this.roll),"YXZ");this.quaternion.setFromEuler(o)}getAirDensity(t){const e=t*.3048;return this.airDensity*Math.exp(-e/8500)}getLiftCoefficient(t){return t<-5?-.2:t<12?this.clMax*(t/12):t<18?this.clMax*(1-(t-12)/12):.1}updateThermals(t,e){this.thermalTimer+=t;const n=Math.max(0,1-(e-2e3)/15e3),s=this.thermalTimer,r=Math.sin(s*.3)*.4+Math.sin(s*.7+1.5)*.3+Math.sin(s*1.2+3)*.3;this.thermalStrength=Math.max(0,r)*n,this.inThermal=this.thermalStrength>.15;const a=Math.abs(this.roll)>15&&Math.abs(this.roll)<45?1.5:1;this.thermalLift=this.thermalStrength*3*a*this.wingSpread}update(t,e){this.boostTimeRemaining>0&&(this.boostTimeRemaining-=e,this.boostTimeRemaining<=0&&(this.isBoosting=!1,this.boostTimeRemaining=0)),t.boost?(!this.boostPressed&&!this.isBoosting&&!this.isTurbo&&this.boost(),this.boostPressed=!0):this.boostPressed=!1,t.turbo?(this.turboPressed||(this.isTurbo=!this.isTurbo,this.isTurbo&&(this.isBoosting=!1,this.boostTimeRemaining=0)),this.turboPressed=!0):this.turboPressed=!1,this.turboWindup=this.isTurbo?Math.min(1,this.turboWindup+e*.7):Math.max(0,this.turboWindup-e*1.5),this.flapInput=t.flap||!1,this.flapInput&&!this.isBoosting&&!this.isTurbo?(this.isFlapping=!0,this.isGliding=!1,this.flapCooldown-=e,this.flapCooldown<=0&&(this.flapStrength=1,this.flapCooldown=this.flapCycleDuration)):this.flapInput||(this.isFlapping=!1,!this.isBoosting&&!this.isTurbo&&(this.isGliding=!0)),this.flapStrength=Math.max(0,this.flapStrength-this.flapDecay*e),this.isTurbo||this.turboWindup>.1?this.wingSpread+=(.15-this.wingSpread)*e*6:this.isBoosting?(this.wingSpread+=(.2-this.wingSpread)*e*5,this.isGliding=!1):this.isGliding?this.wingSpread+=(1-this.wingSpread)*e*3:this.wingSpread=.65+this.flapStrength*.25,this.throttle=this.isFlapping?.3+this.flapStrength*.7:0;const n=this.getAirDensity(0),s=this.speed,r=.5*n*s*s,a=Math.max(-10,Math.min(20,-this.pitch*.3)),o=this.getLiftCoefficient(a)*this.wingSpread,l=r*this.wingArea*o,c=this.k*o*o,h=this.cd0+c+this.wingSpread*this.cdWingSpread;let u=r*this.wingArea*h;this.isBoosting&&(u*=.25),(this.isTurbo||this.turboWindup>.1)&&(u*=.05);let d=0;this.isFlapping&&(d=this.flapThrustImpulse*this.flapStrength);const f=Se.degToRad(this.pitch),g=this.mass*this.gravity*Math.sin(f),m=(d-u+g)/this.mass;this.speed+=m*e;let p=this.isBoosting?this.maxDiveSpeed:this.maxSpeed;if(this.pitch<-20&&!this.isBoosting&&(p+=(this.maxDiveSpeed-this.maxSpeed)*Math.min(1,Math.abs(this.pitch)/60)),(this.isTurbo||this.turboWindup>.01)&&(p=this.turboSpeed),this.speed=Math.max(this.minSpeed,Math.min(p,this.speed)),this.isTurbo||this.turboWindup>.01){const B=this.turboWindup*this.turboWindup*(3-2*this.turboWindup);this.speed+=(this.turboSpeed*B-this.speed)*e*2.5}this.isBoosting&&(this.speed+=(this.maxDiveSpeed*.8-this.speed)*e*3),this.updateThermals(e,0);const w=this.mass*this.gravity,b=this.isFlapping?this.flapLiftImpulse*this.flapStrength:0,M=(l+b-w+this.thermalLift*this.mass)/this.mass;this.verticalSpeed+=(M*.15-this.verticalSpeed)*e*2,this.speed<=this.minSpeed*1.3&&!this.isBoosting&&!this.isTurbo&&(this.pitch=Se.lerp(this.pitch,Math.min(this.pitch,-8),e*.8));const y=Math.min(1.2,this.speed/this.maxSpeed),T=y>.3?.5+y*.5:y/.3*.5,C=t.pitch*this.pitchRate*e*T,L=t.roll*this.rollRate*e*T,v=t.yaw*this.yawRate*e*T,S=new qe().setFromAxisAngle(new D(1,0,0),C),P=new qe().setFromAxisAngle(new D(0,0,1),L),I=new qe().setFromAxisAngle(new D(0,1,0),v);this.quaternion.multiply(I).multiply(S).multiply(P).normalize();const F=new Ue().setFromQuaternion(this.quaternion,"YXZ");return this.heading=Se.radToDeg(F.y),this.pitch=Se.radToDeg(F.x),this.roll=Se.radToDeg(F.z),{speed:this.speed,pitch:this.pitch,roll:this.roll,heading:this.heading,isBoosting:this.isBoosting,boostTimeRemaining:this.boostTimeRemaining,boostDuration:this.boostDuration,boostRotations:this.boostRotations,isGliding:this.isGliding,isFlapping:this.isFlapping,flapStrength:this.flapStrength,wingSpread:this.wingSpread,thermalStrength:this.thermalStrength,inThermal:this.inThermal,verticalSpeed:this.verticalSpeed,flapPhase:this.flapCooldown,liftForce:l,isTurbo:this.isTurbo,turboWindup:this.turboWindup}}}class qx{constructor(){this.keys={},this.prevKeys={},window.addEventListener("keydown",t=>this.keys[t.key.toLowerCase()]=!0),window.addEventListener("keyup",t=>this.keys[t.key.toLowerCase()]=!1),this.mouseDragging=!1,this.mouseDeltaX=0,this.mouseDeltaY=0,this.lastMouseX=0,this.lastMouseY=0,window.addEventListener("mousedown",t=>{t.button===0&&(this.mouseDragging=!0,this.lastMouseX=t.clientX,this.lastMouseY=t.clientY)}),window.addEventListener("mousemove",t=>{this.mouseDragging&&(this.mouseDeltaX+=t.clientX-this.lastMouseX,this.mouseDeltaY+=t.clientY-this.lastMouseY,this.lastMouseX=t.clientX,this.lastMouseY=t.clientY)}),window.addEventListener("mouseup",t=>{t.button===0&&(this.mouseDragging=!1)}),this.input={throttle:0,pitch:0,roll:0,yaw:0,boost:!1,turbo:!1,flap:!1,cameraYaw:0,cameraPitch:0,isDragging:!1,fire:!1,fireFlare:!1,weaponIndex:-1,toggleWeapon:!1},this.sensitivity=.2,this.isMobile=this.detectMobile(),this.tiltEnabled=!1,this.tiltPitch=0,this.tiltRoll=0,this.tiltCalibration={pitch:0,roll:0},this.tiltSensitivity=1,this.touchThrottle=0,this.touchBoosting=!1,this.touchTurbo=!1,this.touchFlapping=!1,this.touchFiring=!1,this.touchFlare=!1,this.touchWeaponToggle=!1,this.touchPrevWeaponToggle=!1,this.touchCameraDragging=!1,this.touchCameraDeltaX=0,this.touchCameraDeltaY=0,this.lastTouchX=0,this.lastTouchY=0,this.cameraFingerID=null,this.isMobile&&this.initMobileControls()}detectMobile(){return/Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"ontouchstart"in window||navigator.maxTouchPoints>0}async initMobileControls(){this.createTouchUI(),await this.requestOrientationPermission(),window.addEventListener("deviceorientation",s=>{if(!this.tiltEnabled)return;const r=s.beta||0,a=s.gamma||0;this.tiltPitch=r-this.tiltCalibration.pitch,this.tiltRoll=a-this.tiltCalibration.roll},!0);const t=document.getElementById("cesiumContainer"),n=document.getElementById("threeContainer")||t||document.body;n.addEventListener("touchstart",s=>this.handleViewTouchStart(s),{passive:!1}),n.addEventListener("touchmove",s=>this.handleViewTouchMove(s),{passive:!1}),n.addEventListener("touchend",s=>this.handleViewTouchEnd(s),{passive:!1})}async requestOrientationPermission(){if(typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function")try{await DeviceOrientationEvent.requestPermission()==="granted"&&(this.tiltEnabled=!0)}catch(t){console.warn("Device orientation permission denied:",t),this.tiltEnabled=!1}else this.tiltEnabled=!0}calibrateTilt(){this.tiltCalibration.pitch=this.tiltPitch+this.tiltCalibration.pitch,this.tiltCalibration.roll=this.tiltRoll+this.tiltCalibration.roll}createTouchUI(){const t=document.createElement("div");t.id="mobile-controls",t.style.cssText=`
